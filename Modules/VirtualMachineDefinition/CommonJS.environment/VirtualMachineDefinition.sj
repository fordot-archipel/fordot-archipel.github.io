@STATIC;1.0;p;19;TNDriveController.jt;22432;@STATIC;1.0;I;17;AppKit/CPButton.jI;19;AppKit/CPMenuItem.jI;22;AppKit/CPPopUpButton.jI;20;AppKit/CPTableView.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.jI;23;Foundation/Foundation.jI;35;StropheCappuccino/TNStropheStanza.jI;15;TNKit/TNAlert.ji;17;Model/TNLibvirt.jt;22159;objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPMenuItem.j", NO);objj_executeFile("AppKit/CPPopUpButton.j", NO);objj_executeFile("AppKit/CPTableView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNStropheStanza.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);objj_executeFile("Model/TNLibvirt.j", YES);var TNArchipelTypeVirtualMachineDisk = "archipel:vm:disk",
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonOK"), new objj_ivar("checkBoxReadOnly"), new objj_ivar("checkBoxShareable"), new objj_ivar("checkBoxTransient"), new objj_ivar("mainPopover"), new objj_ivar("buttonDevice"), new objj_ivar("buttonDriverCache"), new objj_ivar("buttonSourcePath"), new objj_ivar("buttonTargetBus"), new objj_ivar("buttonTargetDevice"), new objj_ivar("buttonType"), new objj_ivar("fieldDevicePath"), new objj_ivar("_delegate"), new objj_ivar("_table"), new objj_ivar("_drive"), new objj_ivar("_otherDrives"), new objj_ivar("_entity")]);objj_registerClassPair(the_class);
...
,["void"]), new objj_method(sel_getUid("save:"), function $TNDriveController__save_(self, _cmd, aSender)
{
    ...
    case TNLibvirtDeviceDiskTypeNetwork:
        try        {
            var host = objj_msgSend(objj_msgSend(TNLibvirtDeviceDiskSourceHost, "alloc"), "init"),
                ...
                hostProtocolName = (objj_msgSend(self.fieldDevicePath, "stringValue").split("/"))[1];
    ...
    case TNLibvirtDeviceDiskTypeFile:
        if (!objj_msgSend(self.buttonSourcePath, "selectedItem"))
            break;
    ...
    if (!objj_msgSend(objj_msgSend(self._drive, "source"), "sourceObject") || objj_msgSend(objj_msgSend(self._drive, "source"), "sourceObject") == "" || objj_msgSend(objj_msgSend(self._drive, "source"), "sourceObject") == "/dev/null")
    {
        objj_msgSend(TNAlert, "showAlertWithMessage:informative:", CPLocalizedString("Invalid source selected", "Invalid source selected"), CPLocalizedString("You must select a valid source for your drive", "You must select a valid source for your drive"));
        return;
    }
...
,["id","id"]), new objj_method(sel_getUid("getDisksInfo"), function $TNDriveController__getDisksInfo(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineDiskGet});
...
p;38;TNVirtualMachineDefinitionController.jt;134909;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;20;AppKit/CPButtonBar.jI;16;AppKit/CPColor.jI;16;AppKit/CPImage.jI;22;AppKit/CPPopUpButton.jI;21;AppKit/CPScrollView.jI;22;AppKit/CPSearchField.jI;20;AppKit/CPTableView.jI;18;AppKit/CPTabView.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.jI;17;AppKit/CPWindow.jI;28;LPKit/LPMultiLineTextField.jI;15;TNKit/TNAlert.jI;29;TNKit/TNTableViewDataSource.jI;26;TNKit/TNTextFieldStepper.jI;19;TNKit/TNSwipeView.ji;22;../../Model/TNModule.ji;17;Model/TNLibvirt.ji;29;TNCharacterDeviceController.ji;27;TNCharacterDeviceDataView.ji;19;TNDriveController.ji;23;TNDriveDeviceDataView.ji;27;TNGraphicDeviceController.ji;25;TNGraphicDeviceDataView.ji;25;TNInputDeviceController.ji;23;TNInputDeviceDataView.ji;23;TNInterfaceController.ji;27;TNInterfaceDeviceDataView.jt;134087;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPButtonBar.j", NO);objj_executeFile("AppKit/CPColor.j", NO);objj_executeFile("AppKit/CPImage.j", NO);objj_executeFile("AppKit/CPPopUpButton.j", NO);objj_executeFile("AppKit/CPScrollView.j", NO);objj_executeFile("AppKit/CPSearchField.j", NO);objj_executeFile("AppKit/CPTableView.j", NO);objj_executeFile("AppKit/CPTabView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPWindow.j", NO);objj_executeFile("LPKit/LPMultiLineTextField.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);objj_executeFile("TNKit/TNTableViewDataSource.j", NO);objj_executeFile("TNKit/TNTextFieldStepper.j", NO);objj_executeFile("TNKit/TNSwipeView.j", NO);objj_executeFile("../../Model/TNModule.j", YES);objj_executeFile("Model/TNLibvirt.j", YES);objj_executeFile("TNCharacterDeviceController.j", YES);objj_executeFile("TNCharacterDeviceDataView.j", YES);objj_executeFile("TNDriveController.j", YES);objj_executeFile("TNDriveDeviceDataView.j", YES);objj_executeFile("TNGraphicDeviceController.j", YES);objj_executeFile("TNGraphicDeviceDataView.j", YES);objj_executeFile("TNInputDeviceController.j", YES);objj_executeFile("TNInputDeviceDataView.j", YES);objj_executeFile("TNInterfaceController.j", YES);objj_executeFile("TNInterfaceDeviceDataView.j", YES);_generateMacAddr = function()
{
...
,["void","BOOL"]), new objj_method(sel_getUid("awakeFromCib"), function $TNVirtualMachineDefinitionController__awakeFromCib(self, _cmd)
{
    ...
    objj_msgSend(self.buttonUndefine, "setImage:", CPImageInBundle("undefine.png", CGSizeMake(16, 16), bundle));
    objj_msgSend(self.buttonUndefine, "setValue:forThemeAttribute:", inset, "content-inset");
    objj_msgSend(self.buttonXMLEditor, "setImage:", CPImageInBundle("IconsButtons/editxml.png", CGSizeMake(16, 16), mainBundle));
    ...
    var tabViewItemStandard = objj_msgSend(objj_msgSend(CPTabViewItem, "alloc"), "initWithIdentifier:", "standard"),
    ...
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForDriveAdd, CPBundleLocalizedString("Add a new drive", "Add a new drive"), self, sel_getUid("addDrive:"), CPImageInBundle("IconsButtons/plus.png", nil, mainBundle));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForDriveRemove, CPBundleLocalizedString("Remove selected drive(s)", "Remove selected drive(s)"), self, sel_getUid("deleteDrive:"), CPImageInBundle("IconsButtons/minus.png", nil, mainBundle));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForDriveEdit, CPBundleLocalizedString("Edit selected drive", "Edit selected drive"), self, sel_getUid("editDrive:"), CPImageInBundle("IconsButtons/edit.png", nil, mainBundle));
    objj_msgSend(self.buttonBarControlDrives, "setButtons:", [objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDriveAdd), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDriveRemove), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDriveEdit)]);
    ...
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForNicAdd, CPBundleLocalizedString("Add a new network interface", "Add a new network interface"), self, sel_getUid("addInterface:"), CPImageInBundle("IconsButtons/plus.png", nil, mainBundle));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForNicRemove, CPBundleLocalizedString("Remove selected network interface(s)", "Remove selected network interface(s)"), self, sel_getUid("deleteInterface:"), CPImageInBundle("IconsButtons/minus.png", nil, mainBundle));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForNicEdit, CPBundleLocalizedString("Edit selected network interface", "Edit selected network interface"), self, sel_getUid("editInterface:"), CPImageInBundle("IconsButtons/edit.png", nil, mainBundle));
    objj_msgSend(self.buttonBarControlNics, "setButtons:", [objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForNicAdd), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForNicRemove), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForNicEdit)]);
    ...
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForInputDeviceAdd, CPBundleLocalizedString("Add a new input device", "Add a new input device"), self, sel_getUid("addInputDevice:"), CPImageInBundle("IconsButtons/plus.png", nil, mainBundle));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForInputDeviceRemove, CPBundleLocalizedString("Remove selected input device(s)", "Remove selected input device(s)"), self, sel_getUid("deleteInputDevice:"), CPImageInBundle("IconsButtons/minus.png", nil, mainBundle));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForInputDeviceEdit, CPBundleLocalizedString("Edit selected input device", "Edit selected input device"), self, sel_getUid("editInputDevice:"), CPImageInBundle("IconsButtons/edit.png", nil, mainBundle));
    objj_msgSend(self.buttonBarInputDevices, "setButtons:", [objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForInputDeviceAdd), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForInputDeviceRemove), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDriveEdit)]);
    ...
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForGraphicDeviceAdd, CPBundleLocalizedString("Add a new Graphic device", "Add a new Graphic device"), self, sel_getUid("addGraphicDevice:"), CPImageInBundle("IconsButtons/plus.png", nil, mainBundle));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForGraphicDeviceRemove, CPBundleLocalizedString("Remove selected Graphic device(s)", "Remove selected Graphic device(s)"), self, sel_getUid("deleteGraphicDevice:"), CPImageInBundle("IconsButtons/minus.png", nil, mainBundle));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForGraphicDeviceEdit, CPBundleLocalizedString("Edit selected Graphic device", "Edit selected Graphic device"), self, sel_getUid("editGraphicDevice:"), CPImageInBundle("IconsButtons/edit.png", nil, mainBundle));
    objj_msgSend(self.buttonBarGraphicDevices, "setButtons:", [objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForGraphicDeviceAdd), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForGraphicDeviceRemove), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForGraphicDeviceEdit)]);
    ...
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForCharacterDeviceAdd, CPBundleLocalizedString("Add a new Character device", "Add a new Character device"), self, sel_getUid("addCharacterDevice:"), CPImageInBundle("IconsButtons/plus.png", nil, mainBundle));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForCharacterDeviceRemove, CPBundleLocalizedString("Remove selected Character device(s)", "Remove selected Character device(s)"), self, sel_getUid("deleteCharacterDevice:"), CPImageInBundle("IconsButtons/minus.png", nil, mainBundle));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForCharacterDeviceEdit, CPBundleLocalizedString("Edit selected Character device", "Edit selected Character device"), self, sel_getUid("editCharacterDevice:"), CPImageInBundle("IconsButtons/edit.png", nil, mainBundle));
    objj_msgSend(self.buttonBarCharacterDevices, "setButtons:", [objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForCharacterDeviceAdd), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForCharacterDeviceRemove), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForCharacterDeviceEdit)]);
...
,["void","id"]), new objj_method(sel_getUid("setEnableAllControls:"), function $TNVirtualMachineDefinitionController__setEnableAllControls_(self, _cmd, shouldEnableGUI)
{
    ...
    {
        objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDriveEdit), "setEnabled:", shouldEnableGUI);
        objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForGraphicDeviceEdit), "setEnabled:", shouldEnableGUI);
        objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDriveEdit), "setEnabled:", shouldEnableGUI);
        objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForNicEdit), "setEnabled:", shouldEnableGUI);
        objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForCharacterDeviceEdit), "setEnabled:", shouldEnableGUI);
        objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDriveRemove), "setEnabled:", shouldEnableGUI);
        objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForGraphicDeviceRemove), "setEnabled:", shouldEnableGUI);
        objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForInputDeviceRemove), "setEnabled:", shouldEnableGUI);
        objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForNicRemove), "setEnabled:", shouldEnableGUI);
        objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForCharacterDeviceRemove), "setEnabled:", shouldEnableGUI);
        objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDriveAdd), "setEnabled:", shouldEnableGUI);
        objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForGraphicDeviceAdd), "setEnabled:", shouldEnableGUI);
        objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForInputDeviceAdd), "setEnabled:", shouldEnableGUI);
        objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForNicAdd), "setEnabled:", shouldEnableGUI);
        objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForCharacterDeviceAdd), "setEnabled:", shouldEnableGUI);
    }
}
...
,["TNXMLNode","CPString"]), new objj_method(sel_getUid("_selectGuestWithType:architecture:"), function $TNVirtualMachineDefinitionController___selectGuestWithType_architecture_(self, _cmd, aType, anArch)
{
    ...
    for (var i = 0; i < objj_msgSend(guests, "count"); i++)
    {
        ...
        if (objj_msgSend(objj_msgSend(guest, "firstChildWithName:", "os_type"), "text") == aType && objj_msgSend(objj_msgSend(guest, "firstChildWithName:", "arch"), "valueForAttribute:", "name") == anArch)
...
,["void"]), new objj_method(sel_getUid("_updateControlsStateForTable:"), function $TNVirtualMachineDefinitionController___updateControlsStateForTable_(self, _cmd, aTableView)
{
    ...
    case self.tableDrives:
        ...
        currentAddButton = objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDriveAdd);
        currentDeleteButton = objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDriveRemove);
        currentEditButton = objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDriveEdit);
        break;
    case self.tableInterfaces:
        currentController = self.interfaceController;
        currentAddButton = objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForNicAdd);
        currentDeleteButton = objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForNicRemove);
        currentEditButton = objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForNicEdit);
        break;
    case self.tableCharacterDevices:
        currentController = self.characterDeviceController;
        currentAddButton = objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForCharacterDeviceAdd);
        currentDeleteButton = objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForCharacterDeviceRemove);
        currentEditButton = objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForCharacterDeviceEdit);
        break;
    case self.tableGraphicsDevices:
        currentController = self.graphicDeviceController;
        currentAddButton = objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForGraphicDeviceAdd);
        currentDeleteButton = objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForGraphicDeviceRemove);
        currentEditButton = objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForGraphicDeviceEdit);
        break;
    case self.tableInputDevices:
        currentController = self.inputDeviceController;
        currentAddButton = objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForInputDeviceAdd);
        currentDeleteButton = objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForInputDeviceRemove);
        currentEditButton = objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDriveEdit);
        break;
    }
...
,["void"]), new objj_method(sel_getUid("getCapabilities"), function $TNVirtualMachineDefinitionController__getCapabilities(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineDefinitionCapabilities});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("getXMLDesc"), function $TNVirtualMachineDefinitionController__getXMLDesc(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineControlXMLDesc});
    self._libvirtDomain = nil;
...
,["void","TNTabView","CPTabViewItem"]), new objj_method(sel_getUid("tableView:menuForTableColumn:row:"), function $TNVirtualMachineDefinitionController__tableView_menuForTableColumn_row_(self, _cmd, aTableView, aColumn, aRow)
{
    ...
    case self.tableDrives:
        if (objj_msgSend(aTableView, "numberOfSelectedRows") == 0)
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForDriveAdd));
        else if (objj_msgSend(aTableView, "numberOfSelectedRows") == 1)
        {
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForDriveEdit));
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForDriveRemove));
        }
        else
        {
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForDriveRemove));
    ...
    case self.tableInterfaces:
        if (objj_msgSend(aTableView, "numberOfSelectedRows") == 0)
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForNicAdd));
        else if (objj_msgSend(aTableView, "numberOfSelectedRows") == 1)
        {
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForNicEdit));
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForNicRemove));
        }
        else
        {
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForNicRemove));
    ...
    case self.tableGraphicsDevices:
        if (objj_msgSend(aTableView, "numberOfSelectedRows") == 0)
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForGraphicDeviceAdd));
        else if (objj_msgSend(aTableView, "numberOfSelectedRows") == 1)
        {
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForGraphicDeviceEdit));
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForGraphicDeviceRemove));
        }
        else
        {
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForGraphicDeviceRemove));
    ...
    case self.tableInputDevices:
        if (objj_msgSend(aTableView, "numberOfSelectedRows") == 0)
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForInputDeviceAdd));
        else if (objj_msgSend(aTableView, "numberOfSelectedRows") == 1)
        {
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForInputDeviceEdit));
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForInputDeviceRemove));
        }
        else
        {
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForGraphicDeviceRemove));
    ...
    case self.tableCharacterDevices:
        if (objj_msgSend(aTableView, "numberOfSelectedRows") == 0)
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForCharacterDeviceAdd));
        else if (objj_msgSend(aTableView, "numberOfSelectedRows") == 1)
        {
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForCharacterDeviceEdit));
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForCharacterDeviceRemove));
        }
        else
        {
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForGraphicDeviceRemove));
...
,["CPMenu","CPTableView","CPTableColumn","int"]), new objj_method(sel_getUid("tableViewDeleteKeyPressed:"), function $TNVirtualMachineDefinitionController__tableViewDeleteKeyPressed_(self, _cmd, aTableView)
{
    if (objj_msgSend(aTableView, "numberOfSelectedRows") == 0)
        return;
    switch(aTableView) {
    case self.tableDrives:
        objj_msgSend(self, "deleteDrive:", aTableView);
        break;
    case self.tableInterfaces:
        objj_msgSend(self, "deleteInterface:", aTableView);
        break;
    case self.tableGraphicsDevices:
        objj_msgSend(self, "deleteGraphicDevice:", aTableView);
        break;
    case self.tableInputDevices:
        objj_msgSend(self, "deleteInputDevice:", aTableView);
        break;
    case self.tableCharacterDevices:
        objj_msgSend(self, "deleteCharacterDevice:", aTableView);
        break;
default:
        return;
    }
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("addGraphicDevice:"), function $TNVirtualMachineDefinitionController__addGraphicDevice_(self, _cmd, aSender)
{
    ...
    objj_msgSend(self.graphicDeviceController, "openWindow:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForGraphicDeviceAdd));
}
,["id","id"]), new objj_method(sel_getUid("editGraphicDevice:"), function $TNVirtualMachineDefinitionController__editGraphicDevice_(self, _cmd, aSender)
{
    ...
    objj_msgSend(self.graphicDeviceController, "setGraphicDevice:", graphicDevice);
    objj_msgSend(self.graphicDeviceController, "openWindow:", objj_msgSend(aSender, "isKindOfClass:", CPMenuItem) ? self.tableGraphicsDevices : aSender);
}
...
,["id","id"]), new objj_method(sel_getUid("addInputDevice:"), function $TNVirtualMachineDefinitionController__addInputDevice_(self, _cmd, aSender)
{
    ...
    objj_msgSend(self.inputDeviceController, "openWindow:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForInputDeviceAdd));
}
,["id","id"]), new objj_method(sel_getUid("editInputDevice:"), function $TNVirtualMachineDefinitionController__editInputDevice_(self, _cmd, aSender)
{
    ...
    objj_msgSend(self.inputDeviceController, "setInputDevice:", inputDevice);
    objj_msgSend(self.inputDeviceController, "openWindow:", objj_msgSend(aSender, "isKindOfClass:", CPMenuItem) ? self.tableInputDevices : aSender);
}
...
,["id","id"]), new objj_method(sel_getUid("addDrive:"), function $TNVirtualMachineDefinitionController__addDrive_(self, _cmd, aSender)
{
    ...
    objj_msgSend(self.driveController, "openWindow:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDriveAdd));
}
,["id","id"]), new objj_method(sel_getUid("editDrive:"), function $TNVirtualMachineDefinitionController__editDrive_(self, _cmd, aSender)
{
    ...
    if (objj_msgSend(self._libvirtDomain, "devices"))
        ...
        objj_msgSend(self.driveController, "setOtherDrives:", nil);
    objj_msgSend(self.driveController, "openWindow:", objj_msgSend(aSender, "isKindOfClass:", CPMenuItem) ? self.tableDrives : aSender);
}
...
,["id","id"]), new objj_method(sel_getUid("addInterface:"), function $TNVirtualMachineDefinitionController__addInterface_(self, _cmd, aSender)
{
    ...
    objj_msgSend(self.interfaceController, "openWindow:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForNicAdd));
}
,["id","id"]), new objj_method(sel_getUid("editInterface:"), function $TNVirtualMachineDefinitionController__editInterface_(self, _cmd, aSender)
{
    ...
    if (objj_msgSend(self._libvirtDomain, "metadata"))
        objj_msgSend(self.interfaceController, "setMetadata:", objj_msgSend(self._libvirtDomain, "metadata"));
    objj_msgSend(self.interfaceController, "openWindow:", objj_msgSend(aSender, "isKindOfClass:", CPMenuItem) ? self.tableInterfaces : aSender);
}
...
,["id","id"]), new objj_method(sel_getUid("addCharacterDevice:"), function $TNVirtualMachineDefinitionController__addCharacterDevice_(self, _cmd, aSender)
{
    ...
    objj_msgSend(self.characterDeviceController, "openWindow:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForCharacterDeviceAdd));
}
,["id","id"]), new objj_method(sel_getUid("editCharacterDevice:"), function $TNVirtualMachineDefinitionController__editCharacterDevice_(self, _cmd, aSender)
{
    ...
    objj_msgSend(self.characterDeviceController, "setCharacterDevice:", characterDevice);
    objj_msgSend(self.characterDeviceController, "openWindow:", objj_msgSend(aSender, "isKindOfClass:", CPMenuItem) ? self.tableCharacterDevices : aSender);
}
,["id","id"]), new objj_method(sel_getUid("deleteCharacterDevice:"), function $TNVirtualMachineDefinitionController__deleteCharacterDevice_(self, _cmd, aSender)
{
    if (objj_msgSend(self.tableCharacterDevices, "numberOfSelectedRows") <= 0)
        return;
    var selectedIndexes = objj_msgSend(self.tableCharacterDevices, "selectedRowIndexes");
    objj_msgSend(self._characterDevicesDatasource, "removeObjectsAtIndexes:", selectedIndexes);
    objj_msgSend(self.tableCharacterDevices, "reloadData");
    objj_msgSend(self.tableCharacterDevices, "deselectAll");
    self._definitionEdited = YES;
}
...
var the_class = objj_getClass("TNVirtualMachineDefinitionController")
if(!the_class) throw new SyntaxError("*** Could not find definition for class \"TNVirtualMachineDefinitionController\"");
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("didChangeGuest:"), function $TNVirtualMachineDefinitionController__didChangeGuest_(self, _cmd, aSender)
{
...
p;27;TNGraphicDeviceController.jt;6407;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;22;AppKit/CPPopUpButton.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.jI;20;AppKit/CPTableView.ji;30;Model/TNLibvirtDeviceGraphic.jt;6206;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPPopUpButton.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPTableView.j", NO);objj_executeFile("Model/TNLibvirtDeviceGraphic.j", YES);{var the_class = objj_allocateClassPair(CPObject, "TNGraphicDeviceController"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonOK"), new objj_ivar("mainPopover"), new objj_ivar("buttonKeymap"), new objj_ivar("buttonType"), new objj_ivar("fieldPassword"), new objj_ivar("fieldListenAddress"), new objj_ivar("fieldListenPort"), new objj_ivar("_table"), new objj_ivar("_delegate"), new objj_ivar("_graphicDevice")]);objj_registerClassPair(the_class);
...
p;29;TNCharacterDeviceController.jt;11943;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;22;AppKit/CPPopUpButton.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.jI;20;AppKit/CPTableView.ji;32;Model/TNLibvirtDeviceCharacter.jt;11739;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPPopUpButton.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPTableView.j", NO);objj_executeFile("Model/TNLibvirtDeviceCharacter.j", YES);{var the_class = objj_allocateClassPair(CPObject, "TNCharacterDeviceController"),
...
p;25;TNGraphicDeviceDataView.jt;4649;@STATIC;1.0;I;23;Foundation/Foundation.ji;29;../../Views/TNBasicDataView.ji;30;Model/TNLibvirtDeviceGraphic.jt;4533;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("../../Views/TNBasicDataView.j", YES);objj_executeFile("Model/TNLibvirtDeviceGraphic.j", YES);var TNGraphicDeviceDataViewIconVNC,
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("imageIcon"), new objj_ivar("fieldKeymap"), new objj_ivar("fieldListen"), new objj_ivar("fieldPassword"), new objj_ivar("labelKeymap"), new objj_ivar("labelListen"), new objj_ivar("labelPassword"), new objj_ivar("_currentGraphicDevice")]);objj_registerClassPair(the_class);
...
{
    var bundle = objj_msgSend(CPBundle, "bundleForClass:", TNGraphicDeviceDataView);
...
,["void"])]);
}p;27;TNInterfaceDeviceDataView.jt;9153;@STATIC;1.0;I;23;Foundation/Foundation.ji;29;../../Views/TNBasicDataView.ji;32;Model/TNLibvirtDeviceInterface.ji;41;Model/TNLibvirtDeviceInterfaceFilterRef.ji;38;Model/TNLibvirtDeviceInterfaceSource.ji;38;Model/TNLibvirtDeviceInterfaceTarget.jt;8903;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("../../Views/TNBasicDataView.j", YES);objj_executeFile("Model/TNLibvirtDeviceInterface.j", YES);objj_executeFile("Model/TNLibvirtDeviceInterfaceFilterRef.j", YES);objj_executeFile("Model/TNLibvirtDeviceInterfaceSource.j", YES);objj_executeFile("Model/TNLibvirtDeviceInterfaceTarget.j", YES);var TNInterfaceDeviceDataViewIconNetwork,
...
,["void"])]);
}p;23;TNInputDeviceDataView.jt;3173;@STATIC;1.0;I;23;Foundation/Foundation.ji;29;../../Views/TNBasicDataView.ji;28;Model/TNLibvirtDeviceInput.jt;3059;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("../../Views/TNBasicDataView.j", YES);objj_executeFile("Model/TNLibvirtDeviceInput.j", YES);var TNInputDeviceDataViewIconTablet,
    TNInputDeviceDataViewIconMouse;
{var the_class = objj_allocateClassPair(TNBasicDataView, "TNInputDeviceDataView"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("fieldType"), new objj_ivar("fieldBus"), new objj_ivar("labelType"), new objj_ivar("labelBus"), new objj_ivar("imageIcon"), new objj_ivar("_currentInputDevice")]);objj_registerClassPair(the_class);
...
{
    var bundle = objj_msgSend(CPBundle, "bundleForClass:", TNInputDeviceDataView);
...
,["void"])]);
}p;23;TNDriveDeviceDataView.jt;11522;@STATIC;1.0;I;23;Foundation/Foundation.ji;29;../../Views/TNBasicDataView.ji;27;Model/TNLibvirtDeviceDisk.ji;33;Model/TNLibvirtDeviceDiskDriver.ji;33;Model/TNLibvirtDeviceDiskSource.ji;33;Model/TNLibvirtDeviceDiskTarget.jt;11294;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("../../Views/TNBasicDataView.j", YES);objj_executeFile("Model/TNLibvirtDeviceDisk.j", YES);objj_executeFile("Model/TNLibvirtDeviceDiskDriver.j", YES);objj_executeFile("Model/TNLibvirtDeviceDiskSource.j", YES);objj_executeFile("Model/TNLibvirtDeviceDiskTarget.j", YES);var TNDriveDeviceDataViewIconQCOW2,
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("imageIcon"), new objj_ivar("fieldCache"), new objj_ivar("fieldDevice"), new objj_ivar("fieldFormat"), new objj_ivar("fieldPath"), new objj_ivar("fieldReadOnly"), new objj_ivar("fieldShareable"), new objj_ivar("fieldTarget"), new objj_ivar("fieldTransient"), new objj_ivar("fieldType"), new objj_ivar("labelCache"), new objj_ivar("labelDevice"), new objj_ivar("labelFormat"), new objj_ivar("labelReadOnly"), new objj_ivar("labelShareable"), new objj_ivar("labelTarget"), new objj_ivar("labelTransient"), new objj_ivar("labelType"), new objj_ivar("_currentDisk")]);objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("setObjectValue:"), function $TNDriveDeviceDataView__setObjectValue_(self, _cmd, aDisk)
{
    ...
    case TNLibvirtDeviceDiskDeviceDisk:
        ...
        case TNLibvirtDeviceDiskTypeNetwork:
            ...
            break;
        case TNLibvirtDeviceDiskTypeFile:
            var _disk_format = objj_msgSend(self._currentDisk, "source") && objj_msgSend(objj_msgSend(self._currentDisk, "source"), "sourceObject") && objj_msgSend(objj_msgSend(self._currentDisk, "source"), "sourceObject") != "" && !objj_msgSend(objj_msgSend(objj_msgSend(self._currentDisk, "source"), "sourceObject"), "isKindOfClass:", CPArray) && objj_msgSend(objj_msgSend(self._currentDisk, "driver"), "name") != TNLibvirtDeviceDiskDriverNameQemu ? objj_msgSend(objj_msgSend(objj_msgSend(self._currentDisk, "source"), "sourceObject").split("."), "lastObject") : objj_msgSend(objj_msgSend(self._currentDisk, "driver"), "type");
            switch(_disk_format) {
            case "qcow2":
...
{
    var bundle = objj_msgSend(CPBundle, "bundleForClass:", TNDriveDeviceDataView);
...
,["void"])]);
}p;23;TNInterfaceController.jt;30291;@STATIC;1.0;I;17;AppKit/CPButton.jI;20;AppKit/CPButtonBar.jI;22;AppKit/CPPopUpButton.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.jI;23;Foundation/Foundation.jI;29;TNKit/TNTableViewDataSource.jI;36;StropheCappuccino/TNStropheContact.jI;35;StropheCappuccino/TNStropheStanza.ji;32;Model/TNLibvirtDeviceInterface.jt;29972;objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPButtonBar.j", NO);objj_executeFile("AppKit/CPPopUpButton.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("TNKit/TNTableViewDataSource.j", NO);objj_executeFile("StropheCappuccino/TNStropheContact.j", NO);objj_executeFile("StropheCappuccino/TNStropheStanza.j", NO);objj_executeFile("Model/TNLibvirtDeviceInterface.j", YES);var TNArchipelTypeHypervisorNetwork = "archipel:hypervisor:network",
...
{
    objj_msgSend(self._datasourceNWFilterParameters, "addObject:", objj_msgSend(objj_msgSend(CPDictionary, "alloc"), "initWithObjectsAndKeys:", "parameter", "name", "value", "value"));
    objj_msgSend(self.tableViewNetworkFilterParameters, "reloadData");
}
...
,["id","id"]), new objj_method(sel_getUid("getHypervisorNetworks"), function $TNInterfaceController__getHypervisorNetworks(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorNetworkGetNames});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("getHypervisorNuageNetworks"), function $TNInterfaceController__getHypervisorNuageNetworks(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorNuageNetworkGetNames});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("getBridges"), function $TNInterfaceController__getBridges(self, _cmd)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "get");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorNetwork});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorNetworkBridges});
...
,["BOOL","id"]), new objj_method(sel_getUid("getNics"), function $TNInterfaceController__getNics(self, _cmd)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "get");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorNetwork});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorNetworkNICs});
...
,["BOOL","id"]), new objj_method(sel_getUid("getHypervisorNWFilters"), function $TNInterfaceController__getHypervisorNWFilters(self, _cmd)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "get");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorNetwork});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorNetworkGetNWFilters});
...
p;27;TNCharacterDeviceDataView.jt;9954;@STATIC;1.0;I;23;Foundation/Foundation.ji;29;../../Views/TNBasicDataView.ji;32;Model/TNLibvirtDeviceCharacter.jt;9836;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("../../Views/TNBasicDataView.j", YES);objj_executeFile("Model/TNLibvirtDeviceCharacter.j", YES);var TNCharacterDeviceDataViewIconCONSOLE,
...
,["void"])]);
}p;25;TNInputDeviceController.jt;4392;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;22;AppKit/CPPopUpButton.jI;20;AppKit/CPTableView.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.ji;28;Model/TNLibvirtDeviceInput.jt;4193;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPPopUpButton.j", NO);objj_executeFile("AppKit/CPTableView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("Model/TNLibvirtDeviceInput.j", YES);{var the_class = objj_allocateClassPair(CPObject, "TNInputDeviceController"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonOK"), new objj_ivar("mainPopover"), new objj_ivar("buttonBus"), new objj_ivar("buttonType"), new objj_ivar("_table"), new objj_ivar("_delegate"), new objj_ivar("_inputDevice")]);objj_registerClassPair(the_class);
...
p;21;Model/TNLibvirtBase.jt;999;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.jt;919;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);{var the_class = objj_allocateClassPair(CPObject, "TNLibvirtBase"),
...
,["CPString"])]);
}p;43;Model/TNLibvirtDeviceInterfaceVirtualPort.jt;3267;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.ji;47;TNLibvirtDeviceInterfaceVirtualPortParameters.jt;3114;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);objj_executeFile("TNLibvirtDeviceInterfaceVirtualPortParameters.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceInterfaceVirtualPort"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_type"), new objj_ivar("_parameters")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;33;Model/TNLibvirtDeviceDiskTarget.jt;3946;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;3845;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);TNLibvirtDeviceDiskTargetDevices = [];
...
TNLibvirtDeviceDiskTargetBuses = [TNLibvirtDeviceDiskTargetBusIDE, TNLibvirtDeviceDiskTargetBusSATA, TNLibvirtDeviceDiskTargetBusSCSI, TNLibvirtDeviceDiskTargetBusVIRTIO, TNLibvirtDeviceDiskTargetBusUSB, TNLibvirtDeviceDiskTargetBusXEN];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceDiskTarget"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_bus"), new objj_ivar("_device")]);objj_registerClassPair(the_class);
...
class_addMethods(meta_class, [new objj_method(sel_getUid("initialize"), function $TNLibvirtDeviceDiskTarget__initialize(self, _cmd)
{
    ...
    TNLibvirtDeviceDiskTargetDevices = [].concat(TNLibvirtDeviceDiskTargetDevicesIDE, TNLibvirtDeviceDiskTargetDevicesSCSI, TNLibvirtDeviceDiskTargetDevicesXEN, TNLibvirtDeviceDiskTargetDevicesVIRTIO);
}
,["void"])]);
}p;33;Model/TNLibvirtDeviceVideoModel.jt;3547;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;3446;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);TNLibvirtDeviceVideoModelVGA = "vga";
...
TNLibvirtDeviceVideoModels = [TNLibvirtDeviceVideoModelVGA, TNLibvirtDeviceVideoModelCIRRUS, TNLibvirtDeviceVideoModelVMVGA, TNLibvirtDeviceVideoModelXEN, TNLibvirtDeviceVideoModelVBOX, TNLibvirtDeviceVideoModelQXL];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceVideoModel"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_heads"), new objj_ivar("_type"), new objj_ivar("_vram")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;33;Model/TNLibvirtDeviceFilesystem.jt;6517;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;33;TNLibvirtDeviceFilesystemSource.ji;33;TNLibvirtDeviceFilesystemTarget.ji;33;TNLibvirtDeviceFilesystemDriver.ji;15;TNLibvirtBase.jt;6302;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtDeviceFilesystemSource.j", YES);objj_executeFile("TNLibvirtDeviceFilesystemTarget.j", YES);objj_executeFile("TNLibvirtDeviceFilesystemDriver.j", YES);objj_executeFile("TNLibvirtBase.j", YES);TNLibvirtDeviceFilesystemTypeTemplate = "template";
TNLibvirtDeviceFilesystemTypeMount = "mount";
TNLibvirtDeviceFilesystemTypeFile = "file";
TNLibvirtDeviceFilesystemTypeBlock = "block";
TNLibvirtDeviceFilesystemTypes = [TNLibvirtDeviceFilesystemTypeTemplate, TNLibvirtDeviceFilesystemTypeMount, TNLibvirtDeviceFilesystemTypeFile, TNLibvirtDeviceFilesystemTypeBlock];
...
TNLibvirtDeviceFilesystemAccessModes = [TNLibvirtDeviceFilesystemAccessModePassthrough, TNLibvirtDeviceFilesystemAccessModeMapped, TNLibvirtDeviceFilesystemAccessModeSquash];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceFilesystem"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_type"), new objj_ivar("_accessmode"), new objj_ivar("_source"), new objj_ivar("_target"), new objj_ivar("_driver"), new objj_ivar("_readonly")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;27;Model/TNLibvirtDeviceDisk.jt;7272;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.ji;27;TNLibvirtDeviceDiskSource.ji;27;TNLibvirtDeviceDiskTarget.ji;27;TNLibvirtDeviceDiskDriver.ji;27;TNLibvirtDeviceDiskSource.jt;7043;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);objj_executeFile("TNLibvirtDeviceDiskSource.j", YES);objj_executeFile("TNLibvirtDeviceDiskTarget.j", YES);objj_executeFile("TNLibvirtDeviceDiskDriver.j", YES);objj_executeFile("TNLibvirtDeviceDiskSource.j", YES);TNLibvirtDeviceDiskTypeFile = "file";
TNLibvirtDeviceDiskTypeBlock = "block";
TNLibvirtDeviceDiskTypeNetwork = "network";
TNLibvirtDeviceDiskTypeDir = "dir";
TNLibvirtDeviceDiskTypes = [TNLibvirtDeviceDiskTypeFile, TNLibvirtDeviceDiskTypeBlock, TNLibvirtDeviceDiskTypeNetwork, TNLibvirtDeviceDiskTypeDir];
TNLibvirtDeviceDiskDeviceCDROM = "cdrom";
TNLibvirtDeviceDiskDeviceDisk = "disk";
TNLibvirtDeviceDiskDeviceFloppy = "floppy";
TNLibvirtDeviceDiskDevices = [TNLibvirtDeviceDiskDeviceDisk, TNLibvirtDeviceDiskDeviceCDROM, TNLibvirtDeviceDiskDeviceFloppy];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceDisk"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_readonly"), new objj_ivar("_shareable"), new objj_ivar("_transient"), new objj_ivar("_device"), new objj_ivar("_type"), new objj_ivar("_source"), new objj_ivar("_target"), new objj_ivar("_driver")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;53;Model/TNLibvirtDeviceInterfaceVirtualPortParameters.jt;2448;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;2347;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceInterfaceVirtualPortParameters"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_profileID"), new objj_ivar("_interfaceID")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;43;Model/TNLibvirtDeviceHostDevSourceProduct.jt;1689;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;1588;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceHostDevSourceProduct"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_id")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;34;Model/TNLibvirtDeviceHostDevBoot.jt;1655;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;1554;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceHostDevBoot"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_order")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;33;Model/TNLibvirtDomainClockTimer.jt;7189;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.ji;34;TNLibvirtDomainClockTimerCatchup.jt;7049;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);objj_executeFile("TNLibvirtDomainClockTimerCatchup.j", YES);TNLibvirtDomainClockTimerNameHPET = "hpet";
...
TNLibvirtDomainClockTimerNames = [TNLibvirtDomainClockTimerNameHPET, TNLibvirtDomainClockTimerNamePIT, TNLibvirtDomainClockTimerNamePlatform, TNLibvirtDomainClockTimerNameRTC, TNLibvirtDomainClockTimerNameTSC];
TNLibvirtDomainClockTimerTrackBoot = "boot";
TNLibvirtDomainClockTimerTrackGuest = "guest";
TNLibvirtDomainClockTimerTrackWall = "wall";
TNLibvirtDomainClockTimerTracks = [TNLibvirtDomainClockTimerTrackBoot, TNLibvirtDomainClockTimerTrackGuest, TNLibvirtDomainClockTimerTrackWall];
...
TNLibvirtDomainClockTimerTickPolicies = [TNLibvirtDomainClockTimerTickPolicyDelay, TNLibvirtDomainClockTimerTickPolicyCatchup, TNLibvirtDomainClockTimerTickPolicyMerge, TNLibvirtDomainClockTimerTickPolicyDiscard];
...
TNLibvirtDomainClockTimerModes = [TNLibvirtDomainClockTimerModeAuto, TNLibvirtDomainClockTimerModeNative, TNLibvirtDomainClockTimerModeEmulate, TNLibvirtDomainClockTimerModeParavirt, TNLibvirtDomainClockTimerModeSMPSafe];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDomainClockTimer"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_present"), new objj_ivar("_frequency"), new objj_ivar("_mode"), new objj_ivar("_name"), new objj_ivar("_tickpolicy"), new objj_ivar("_track"), new objj_ivar("_catchup")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;37;Model/TNLibvirtDeviceDiskSourceHost.jt;2158;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;2057;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceDiskSourceHost"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_name"), new objj_ivar("_port")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;41;Model/TNLibvirtDeviceInterfaceBandwidth.jt;3243;@STATIC;1.0;i;15;TNLibvirtBase.ji;42;TNLibvirtDeviceInterfaceBandwidthInbound.ji;43;TNLibvirtDeviceInterfaceBandwidthOutbound.jt;3109;objj_executeFile("TNLibvirtBase.j", YES);objj_executeFile("TNLibvirtDeviceInterfaceBandwidthInbound.j", YES);objj_executeFile("TNLibvirtDeviceInterfaceBandwidthOutbound.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceInterfaceBandwidth"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_inbound"), new objj_ivar("_outbound")]);objj_registerClassPair(the_class);
...
}p;33;Model/TNLibvirtDeviceDiskDriver.jt;4457;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;4356;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);TNLibvirtDeviceDiskDriverNameTap = "tap";
...
TNLibvirtDeviceDiskDriverName = [TNLibvirtDeviceDiskDriverNameTap, TNLibvirtDeviceDiskDriverNameTap2, TNLibvirtDeviceDiskDriverNamePhy, TNLibvirtDeviceDiskDriverNameFile, TNLibvirtDeviceDiskDriverNameQemu];
...
TNLibvirtDeviceDiskDriverType = [TNLibvirtDeviceDiskDriverTypeAio, TNLibvirtDeviceDiskDriverTypeRaw, TNLibvirtDeviceDiskDriverTypeCow, TNLibvirtDeviceDiskDriverTypeQcow, TNLibvirtDeviceDiskDriverTypeQcow2, TNLibvirtDeviceDiskDriverTypeVmdk];
...
TNLibvirtDeviceDiskDriverCaches = [TNLibvirtDeviceDiskDriverCacheDefault, TNLibvirtDeviceDiskDriverCacheNone, TNLibvirtDeviceDiskDriverCacheWritethrough, TNLibvirtDeviceDiskDriverCacheWriteback];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceDiskDriver"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_cache"), new objj_ivar("_IO"), new objj_ivar("_name"), new objj_ivar("_type")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;38;Model/TNLibvirtDeviceCharacterTarget.jt;3471;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;3370;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);TNLibvirtDeviceConsoleTargetTypeNone = "none";
TNLibvirtDeviceConsoleTargetTypeVIRTIO = "virtio";
TNLibvirtDeviceConsoleTargetTypes = [TNLibvirtDeviceConsoleTargetTypeNone, TNLibvirtDeviceConsoleTargetTypeVIRTIO];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceCharacterTarget"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_type"), new objj_ivar("_address"), new objj_ivar("_port"), new objj_ivar("_name")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;46;Model/TNLibvirtDomainQEMUCommandLineArgument.jt;2073;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;1972;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDomainQEMUCommandLineArgument"),
...
,["TNXMLNode"])]);
}p;32;Model/TNLibvirtDeviceInterface.jt;10994;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.ji;35;TNLibvirtDeviceInterfaceBandwidth.ji;35;TNLibvirtDeviceInterfaceFilterRef.ji;32;TNLibvirtDeviceInterfaceSource.ji;32;TNLibvirtDeviceInterfaceTarget.ji;37;TNLibvirtDeviceInterfaceVirtualPort.jt;10696;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);objj_executeFile("TNLibvirtDeviceInterfaceBandwidth.j", YES);objj_executeFile("TNLibvirtDeviceInterfaceFilterRef.j", YES);objj_executeFile("TNLibvirtDeviceInterfaceSource.j", YES);objj_executeFile("TNLibvirtDeviceInterfaceTarget.j", YES);objj_executeFile("TNLibvirtDeviceInterfaceVirtualPort.j", YES);TNLibvirtDeviceInterfaceModelNE2KISA = "ne2k_isa";
...
TNLibvirtDeviceInterfaceTypes = [TNLibvirtDeviceInterfaceTypeNetwork, TNLibvirtDeviceInterfaceTypeBridge, TNLibvirtDeviceInterfaceTypeUser, TNLibvirtDeviceInterfaceTypeDirect, TNLibvirtDeviceInterfaceTypeNuage];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceInterface"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_MAC"), new objj_ivar("_model"), new objj_ivar("_script"), new objj_ivar("_type"), new objj_ivar("_nuageNetworkName"), new objj_ivar("_nuageNetworkInterfaceIP"), new objj_ivar("_bandwidth"), new objj_ivar("_filterref"), new objj_ivar("_source"), new objj_ivar("_target"), new objj_ivar("_virtualPort")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;36;Model/TNLibvirtDeviceHostDevSource.jt;3865;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.ji;36;TNLibvirtDeviceHostDevSourceVendor.ji;37;TNLibvirtDeviceHostDevSourceProduct.ji;37;TNLibvirtDeviceHostDevSourceAddress.jt;3639;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);objj_executeFile("TNLibvirtDeviceHostDevSourceVendor.j", YES);objj_executeFile("TNLibvirtDeviceHostDevSourceProduct.j", YES);objj_executeFile("TNLibvirtDeviceHostDevSourceAddress.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceHostDevSource"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_address"), new objj_ivar("_product"), new objj_ivar("_vendor")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;33;Model/TNLibvirtDomainMemoryTune.jt;4039;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;3938;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDomainMemoryTune"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_hardLimit"), new objj_ivar("_minGuarantee"), new objj_ivar("_softLimit"), new objj_ivar("_swapHardLimit")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;28;Model/TNLibvirtDeviceVideo.jt;2777;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.ji;27;TNLibvirtDeviceVideoModel.ji;29;TNLibvirtDeviceVideoAddress.jt;2610;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);objj_executeFile("TNLibvirtDeviceVideoModel.j", YES);objj_executeFile("TNLibvirtDeviceVideoAddress.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceVideo"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_address"), new objj_ivar("_model")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;40;Model/TNLibvirtDomainClockTimerCatchup.jt;2598;@STATIC;1.0;i;15;TNLibvirtBase.jt;2559;objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDomainClockTimerCatchup"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_threshold"), new objj_ivar("_slew"), new objj_ivar("_limit")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;28;Model/TNLibvirtDeviceInput.jt;2937;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;2836;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);TNLibvirtDeviceInputBusUSB = "usb";
TNLibvirtDeviceInputBusPS2 = "ps2";
TNLibvirtDeviceInputBusXEN = "xen";
TNLibvirtDeviceInputBuses = [TNLibvirtDeviceInputBusUSB, TNLibvirtDeviceInputBusPS2, TNLibvirtDeviceInputBusXEN];
TNLibvirtDeviceInputTypesTypeMouse = "mouse";
TNLibvirtDeviceInputTypesTypeTablet = "tablet";
TNLibvirtDeviceInputTypes = [TNLibvirtDeviceInputTypesTypeTablet, TNLibvirtDeviceInputTypesTypeMouse];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceInput"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_bus"), new objj_ivar("_type")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;17;Model/TNLibvirt.jt;4596;@STATIC;1.0;i;15;TNLibvirtBase.ji;26;TNLibvirtDeviceCharacter.ji;34;TNLibvirtDeviceCharacterProtocol.ji;32;TNLibvirtDeviceCharacterSource.ji;32;TNLibvirtDeviceCharacterTarget.ji;27;TNLibvirtDeviceController.ji;34;TNLibvirtDeviceControllerAddress.ji;21;TNLibvirtDeviceDisk.ji;27;TNLibvirtDeviceDiskDriver.ji;27;TNLibvirtDeviceDiskSource.ji;31;TNLibvirtDeviceDiskSourceHost.ji;27;TNLibvirtDeviceDiskTarget.ji;27;TNLibvirtDeviceFilesystem.ji;33;TNLibvirtDeviceFilesystemDriver.ji;33;TNLibvirtDeviceFilesystemSource.ji;33;TNLibvirtDeviceFilesystemTarget.ji;24;TNLibvirtDeviceGraphic.ji;24;TNLibvirtDeviceHostDev.ji;28;TNLibvirtDeviceHostDevBoot.ji;27;TNLibvirtDeviceHostDevRom.ji;30;TNLibvirtDeviceHostDevSource.ji;37;TNLibvirtDeviceHostDevSourceAddress.ji;37;TNLibvirtDeviceHostDevSourceProduct.ji;36;TNLibvirtDeviceHostDevSourceVendor.ji;22;TNLibvirtDeviceInput.ji;26;TNLibvirtDeviceInterface.ji;35;TNLibvirtDeviceInterfaceBandwidth.ji;42;TNLibvirtDeviceInterfaceBandwidthInbound.ji;43;TNLibvirtDeviceInterfaceBandwidthOutbound.ji;35;TNLibvirtDeviceInterfaceFilterRef.ji;32;TNLibvirtDeviceInterfaceSource.ji;32;TNLibvirtDeviceInterfaceTarget.ji;37;TNLibvirtDeviceInterfaceVirtualPort.ji;47;TNLibvirtDeviceInterfaceVirtualPortParameters.ji;18;TNLibvirtDevices.ji;22;TNLibvirtDeviceVideo.ji;29;TNLibvirtDeviceVideoAddress.ji;27;TNLibvirtDeviceVideoModel.ji;17;TNLibvirtDomain.ji;28;TNLibvirtDomainBlockIOTune.ji;22;TNLibvirtDomainClock.ji;27;TNLibvirtDomainClockTimer.ji;34;TNLibvirtDomainClockTimerCatchup.ji;25;TNLibvirtDomainFeatures.ji;30;TNLibvirtDomainMemoryBacking.ji;27;TNLibvirtDomainMemoryTune.ji;25;TNLibvirtDomainMetadata.ji;19;TNLibvirtDomainOS.ji;23;TNLibvirtDomainOSType.ji;32;TNLibvirtDomainQEMUCommandLine.ji;40;TNLibvirtDomainQEMUCommandLineArgument.jt;2824;objj_executeFile("TNLibvirtBase.j", YES);objj_executeFile("TNLibvirtDeviceCharacter.j", YES);objj_executeFile("TNLibvirtDeviceCharacterProtocol.j", YES);objj_executeFile("TNLibvirtDeviceCharacterSource.j", YES);objj_executeFile("TNLibvirtDeviceCharacterTarget.j", YES);objj_executeFile("TNLibvirtDeviceController.j", YES);objj_executeFile("TNLibvirtDeviceControllerAddress.j", YES);objj_executeFile("TNLibvirtDeviceDisk.j", YES);objj_executeFile("TNLibvirtDeviceDiskDriver.j", YES);objj_executeFile("TNLibvirtDeviceDiskSource.j", YES);objj_executeFile("TNLibvirtDeviceDiskSourceHost.j", YES);objj_executeFile("TNLibvirtDeviceDiskTarget.j", YES);objj_executeFile("TNLibvirtDeviceFilesystem.j", YES);objj_executeFile("TNLibvirtDeviceFilesystemDriver.j", YES);objj_executeFile("TNLibvirtDeviceFilesystemSource.j", YES);objj_executeFile("TNLibvirtDeviceFilesystemTarget.j", YES);objj_executeFile("TNLibvirtDeviceGraphic.j", YES);objj_executeFile("TNLibvirtDeviceHostDev.j", YES);objj_executeFile("TNLibvirtDeviceHostDevBoot.j", YES);objj_executeFile("TNLibvirtDeviceHostDevRom.j", YES);objj_executeFile("TNLibvirtDeviceHostDevSource.j", YES);objj_executeFile("TNLibvirtDeviceHostDevSourceAddress.j", YES);objj_executeFile("TNLibvirtDeviceHostDevSourceProduct.j", YES);objj_executeFile("TNLibvirtDeviceHostDevSourceVendor.j", YES);objj_executeFile("TNLibvirtDeviceInput.j", YES);objj_executeFile("TNLibvirtDeviceInterface.j", YES);objj_executeFile("TNLibvirtDeviceInterfaceBandwidth.j", YES);objj_executeFile("TNLibvirtDeviceInterfaceBandwidthInbound.j", YES);objj_executeFile("TNLibvirtDeviceInterfaceBandwidthOutbound.j", YES);objj_executeFile("TNLibvirtDeviceInterfaceFilterRef.j", YES);objj_executeFile("TNLibvirtDeviceInterfaceSource.j", YES);objj_executeFile("TNLibvirtDeviceInterfaceTarget.j", YES);objj_executeFile("TNLibvirtDeviceInterfaceVirtualPort.j", YES);objj_executeFile("TNLibvirtDeviceInterfaceVirtualPortParameters.j", YES);objj_executeFile("TNLibvirtDevices.j", YES);objj_executeFile("TNLibvirtDeviceVideo.j", YES);objj_executeFile("TNLibvirtDeviceVideoAddress.j", YES);objj_executeFile("TNLibvirtDeviceVideoModel.j", YES);objj_executeFile("TNLibvirtDomain.j", YES);objj_executeFile("TNLibvirtDomainBlockIOTune.j", YES);objj_executeFile("TNLibvirtDomainClock.j", YES);objj_executeFile("TNLibvirtDomainClockTimer.j", YES);objj_executeFile("TNLibvirtDomainClockTimerCatchup.j", YES);objj_executeFile("TNLibvirtDomainFeatures.j", YES);objj_executeFile("TNLibvirtDomainMemoryBacking.j", YES);objj_executeFile("TNLibvirtDomainMemoryTune.j", YES);objj_executeFile("TNLibvirtDomainMetadata.j", YES);objj_executeFile("TNLibvirtDomainOS.j", YES);objj_executeFile("TNLibvirtDomainOSType.j", YES);objj_executeFile("TNLibvirtDomainQEMUCommandLine.j", YES);objj_executeFile("TNLibvirtDomainQEMUCommandLineArgument.j", YES);p;28;Model/TNLibvirtDomainClock.jt;3347;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.ji;27;TNLibvirtDomainClockTimer.jt;3214;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);objj_executeFile("TNLibvirtDomainClockTimer.j", YES);TNLibvirtDomainClockClockUTC = "utc";
...
TNLibvirtDomainClockClocks = [TNLibvirtDomainClockClockUTC, TNLibvirtDomainClockClockLocalTime, TNLibvirtDomainClockClockVariable];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDomainClock"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_offset"), new objj_ivar("_timers")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;30;Model/TNLibvirtDeviceHostDev.jt;5468;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.ji;30;TNLibvirtDeviceHostDevSource.ji;28;TNLibvirtDeviceHostDevBoot.ji;27;TNLibvirtDeviceHostDevRom.jt;5267;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);objj_executeFile("TNLibvirtDeviceHostDevSource.j", YES);objj_executeFile("TNLibvirtDeviceHostDevBoot.j", YES);objj_executeFile("TNLibvirtDeviceHostDevRom.j", YES);TNLibvirtDeviceHostDevModeSubsystem = "subsystem";
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_managed"), new objj_ivar("_mode"), new objj_ivar("_type"), new objj_ivar("_boot"), new objj_ivar("_rom"), new objj_ivar("_source")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;38;Model/TNLibvirtDomainQEMUCommandLine.jt;2684;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.ji;40;TNLibvirtDomainQEMUCommandLineArgument.jt;2538;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);objj_executeFile("TNLibvirtDomainQEMUCommandLineArgument.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDomainQEMUCommandLine"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_arguments")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;40;Model/TNLibvirtDeviceControllerAddress.jt;4354;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;4253;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceControllerAddress"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_type"), new objj_ivar("_domain"), new objj_ivar("_bus"), new objj_ivar("_slot"), new objj_ivar("_function"), new objj_ivar("_multifunction")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;33;Model/TNLibvirtDeviceHostDevRom.jt;1801;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;1700;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);TNLibvirtDeviceHostDevRomBarON = "on";
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_bar")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;29;Model/TNLibvirtDomainOSType.jt;3273;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;3172;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);TNLibvirtDomainOSTypeTypeLinux = "linux";
TNLibvirtDomainOSTypeTypeHVM = "hvm";
objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDomainOSType"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_architecture"), new objj_ivar("_machine"), new objj_ivar("_type")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;36;Model/TNLibvirtDomainMemoryBacking.jt;1782;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;1681;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDomainMemoryBacking"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_hugePages")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;34;Model/TNLibvirtDomainBlockIOTune.jt;1827;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;1726;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDomainBlockIOTune"),
...
,["TNXMLNode"])]);
}p;24;Model/TNLibvirtDevices.jt;12603;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.ji;26;TNLibvirtDeviceCharacter.ji;21;TNLibvirtDeviceDisk.ji;27;TNLibvirtDeviceFilesystem.ji;24;TNLibvirtDeviceGraphic.ji;24;TNLibvirtDeviceHostDev.ji;22;TNLibvirtDeviceInput.ji;26;TNLibvirtDeviceInterface.ji;27;TNLibvirtDeviceController.ji;22;TNLibvirtDeviceVideo.jt;12237;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);objj_executeFile("TNLibvirtDeviceCharacter.j", YES);objj_executeFile("TNLibvirtDeviceDisk.j", YES);objj_executeFile("TNLibvirtDeviceFilesystem.j", YES);objj_executeFile("TNLibvirtDeviceGraphic.j", YES);objj_executeFile("TNLibvirtDeviceHostDev.j", YES);objj_executeFile("TNLibvirtDeviceInput.j", YES);objj_executeFile("TNLibvirtDeviceInterface.j", YES);objj_executeFile("TNLibvirtDeviceController.j", YES);objj_executeFile("TNLibvirtDeviceVideo.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDevices"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_characters"), new objj_ivar("_disks"), new objj_ivar("_filesystems"), new objj_ivar("_graphics"), new objj_ivar("_hostdevs"), new objj_ivar("_inputs"), new objj_ivar("_interfaces"), new objj_ivar("_controllers"), new objj_ivar("_emulator"), new objj_ivar("_video")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;31;Model/TNLibvirtDomainMetadata.jt;1113;@STATIC;1.0;i;15;TNLibvirtBase.jt;1074;objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDomainMetadata"),
...
,["TNXMLNode"])]);
}p;39;Model/TNLibvirtDeviceFilesystemDriver.jt;2456;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;2355;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);TNLibvirtDeviceFilesystemDriverTypePath = "path";
TNLibvirtDeviceFilesystemDriverTypeHandle = "handle";
TNLibvirtDeviceFilesystemDriverTypes = [TNLibvirtDeviceFilesystemDriverTypePath, TNLibvirtDeviceFilesystemDriverTypeHandle];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceFilesystemDriver"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_type"), new objj_ivar("_wrpolicy")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;23;Model/TNLibvirtDomain.jt;17739;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.ji;18;TNLibvirtDevices.ji;28;TNLibvirtDomainBlockIOTune.ji;25;TNLibvirtDomainFeatures.ji;22;TNLibvirtDomainClock.ji;30;TNLibvirtDomainMemoryBacking.ji;27;TNLibvirtDomainMemoryTune.ji;19;TNLibvirtDomainOS.ji;32;TNLibvirtDomainQEMUCommandLine.ji;25;TNLibvirtDomainMetadata.jt;17366;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);objj_executeFile("TNLibvirtDevices.j", YES);objj_executeFile("TNLibvirtDomainBlockIOTune.j", YES);objj_executeFile("TNLibvirtDomainFeatures.j", YES);objj_executeFile("TNLibvirtDomainClock.j", YES);objj_executeFile("TNLibvirtDomainMemoryBacking.j", YES);objj_executeFile("TNLibvirtDomainMemoryTune.j", YES);objj_executeFile("TNLibvirtDomainOS.j", YES);objj_executeFile("TNLibvirtDomainQEMUCommandLine.j", YES);objj_executeFile("TNLibvirtDomainMetadata.j", YES);TNLibvirtDomainTypeKVM = "kvm";
...
}p;31;Model/TNLibvirtDomainFeatures.jt;3346;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;3245;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);TNLibvirtDomainFeaturesPAE = "pae";
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_ACPI"), new objj_ivar("_APIC"), new objj_ivar("_HAP"), new objj_ivar("_PAE")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;32;Model/TNLibvirtDeviceCharacter.jt;7294;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.ji;34;TNLibvirtDeviceCharacterProtocol.ji;32;TNLibvirtDeviceCharacterSource.ji;32;TNLibvirtDeviceCharacterTarget.jt;7080;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);objj_executeFile("TNLibvirtDeviceCharacterProtocol.j", YES);objj_executeFile("TNLibvirtDeviceCharacterSource.j", YES);objj_executeFile("TNLibvirtDeviceCharacterTarget.j", YES);TNLibvirtDeviceCharacterKindConsole = "console";
...
TNLibvirtDeviceCharacterKinds = [TNLibvirtDeviceCharacterKindSerial, TNLibvirtDeviceCharacterKindChannel, TNLibvirtDeviceCharacterKindParallel];
...
TNLibvirtDeviceCharacterTypes = [TNLibvirtDeviceCharacterTypeDEV, TNLibvirtDeviceCharacterTypeFILE, TNLibvirtDeviceCharacterTypeNULL, TNLibvirtDeviceCharacterTypePIPE, TNLibvirtDeviceCharacterTypePTY, TNLibvirtDeviceCharacterTypeSPICEVMC, TNLibvirtDeviceCharacterTypeSTDIO, TNLibvirtDeviceCharacterTypeTCP, TNLibvirtDeviceCharacterTypeUDP, TNLibvirtDeviceCharacterTypeUNIX, TNLibvirtDeviceCharacterTypeVC];
TNLibvirtDeviceCharacterTypesForConsole = [TNLibvirtDeviceCharacterTypePTY, TNLibvirtDeviceCharacterTypeSTDIO, TNLibvirtDeviceCharacterTypeTCP, TNLibvirtDeviceCharacterTypeUDP];
TNLibvirtDeviceCharacterTypesForSerial = [TNLibvirtDeviceCharacterTypePTY, TNLibvirtDeviceCharacterTypeFILE, TNLibvirtDeviceCharacterTypeVC, TNLibvirtDeviceCharacterTypeNULL, TNLibvirtDeviceCharacterTypeDEV, TNLibvirtDeviceCharacterTypePIPE, TNLibvirtDeviceCharacterTypeTCP, TNLibvirtDeviceCharacterTypeUDP, TNLibvirtDeviceCharacterTypeUNIX];
TNLibvirtDeviceCharacterTypesForParallel = [TNLibvirtDeviceCharacterTypePTY];
TNLibvirtDeviceCharacterTypesForChannel = [TNLibvirtDeviceCharacterTypePTY, TNLibvirtDeviceCharacterTypeUNIX, TNLibvirtDeviceCharacterTypeSPICEVMC];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceCharacter"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_kind"), new objj_ivar("_type"), new objj_ivar("_source"), new objj_ivar("_target"), new objj_ivar("_protocol")]);objj_registerClassPair(the_class);
...
,["TNLibvirtDeviceCharacter","CPString"]), new objj_method(sel_getUid("initWithXMLNode:"), function $TNLibvirtDeviceCharacter__initWithXMLNode_(self, _cmd, aNode)
{
    ...
    {
        if (objj_msgSend(aNode, "name") != TNLibvirtDeviceCharacterKindConsole && objj_msgSend(aNode, "name") != TNLibvirtDeviceCharacterKindSerial && objj_msgSend(aNode, "name") != TNLibvirtDeviceCharacterKindChannel && objj_msgSend(aNode, "name") != TNLibvirtDeviceCharacterKindParallel)
...
,["TNXMLNode"])]);
}p;33;Model/TNLibvirtDeviceController.jt;6918;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;34;TNLibvirtDeviceControllerAddress.jt;6798;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtDeviceControllerAddress.j", YES);TNLibvirtDeviceControllerTypeIDE = "ide";
...
TNLibvirtDeviceControllerTypes = [TNLibvirtDeviceControllerTypeIDE, TNLibvirtDeviceControllerTypeFDC, TNLibvirtDeviceControllerTypeSCSI, TNLibvirtDeviceControllerTypeSATA, TNLibvirtDeviceControllerTypeUSB, TNLibvirtDeviceControllerTypeCCID, TNLibvirtDeviceControllerTypeVIRTIOSERIAL];
...
TNLibvirtDeviceControllerModels = [TNLibvirtDeviceControllerModelAUTO, TNLibvirtDeviceControllerModelBUSLOGIC, TNLibvirtDeviceControllerModelIBMVSCSI, TNLibvirtDeviceControllerModelLSILOGIC, TNLibvirtDeviceControllerModelLSIAS1068, TNLibvirtDeviceControllerModelVIRTIOSCSI, TNLibvirtDeviceControllerModelVMPVSCSI, TNLibvirtDeviceControllerModelPIIX3UHCI, TNLibvirtDeviceControllerModelPIIX34UHCI, TNLibvirtDeviceControllerModelEHCI, TNLibvirtDeviceControllerModelICH9EHCI1, TNLibvirtDeviceControllerModelICH9UHCI1, TNLibvirtDeviceControllerModelICH9UHCI2, TNLibvirtDeviceControllerModelICH9UHCI3, TNLibvirtDeviceControllerModelVT82C686BUHCI, TNLibvirtDeviceControllerModelPCIOHCI, TNLibvirtDeviceControllerModelNECXHCI, TNLibvirtDeviceControllerModelNONE];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceController"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_type"), new objj_ivar("_index"), new objj_ivar("_model"), new objj_ivar("_port"), new objj_ivar("_vector"), new objj_ivar("_address")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;49;Model/TNLibvirtDeviceInterfaceBandwidthOutbound.jt;3387;@STATIC;1.0;i;15;TNLibvirtBase.jt;3348;objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceInterfaceBandwidthOutbound"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_average"), new objj_ivar("_burst"), new objj_ivar("_peak")]);objj_registerClassPair(the_class);
...
}p;43;Model/TNLibvirtDeviceHostDevSourceAddress.jt;2759;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;2658;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceHostDevSourceAddress"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_bus"), new objj_ivar("_slot"), new objj_ivar("_function")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;38;Model/TNLibvirtDeviceInterfaceSource.jt;4982;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;4881;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);TNLibvirtDeviceInterfaceSourceModeVEPA = "vepa";
...
TNLibvirtDeviceInterfaceSourceModes = [TNLibvirtDeviceInterfaceSourceModeVEPA, TNLibvirtDeviceInterfaceSourceModeBridge, TNLibvirtDeviceInterfaceSourceModePrivate, TNLibvirtDeviceInterfaceSourceModePassthrough];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceInterfaceSource"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_address"), new objj_ivar("_bridge"), new objj_ivar("_device"), new objj_ivar("_mode"), new objj_ivar("_network"), new objj_ivar("_port")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;38;Model/TNLibvirtDeviceCharacterSource.jt;3575;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;3474;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);TNLibvirtDeviceCharacterSourceModeNone = "none";
TNLibvirtDeviceCharacterSourceModeBind = "bind";
TNLibvirtDeviceCharacterSourceModeConnect = "connect";
TNLibvirtDeviceCharacterSourceModes = [TNLibvirtDeviceCharacterSourceModeNone, TNLibvirtDeviceCharacterSourceModeBind, TNLibvirtDeviceCharacterSourceModeConnect];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceCharacterSource"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_path"), new objj_ivar("_mode"), new objj_ivar("_host"), new objj_ivar("_service")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;35;Model/TNLibvirtDeviceVideoAddress.jt;3656;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;3555;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceVideoAddress"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_bus"), new objj_ivar("_domain"), new objj_ivar("_function"), new objj_ivar("_slot"), new objj_ivar("_type")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;40;Model/TNLibvirtDeviceCharacterProtocol.jt;2281;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;2180;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);TNLibvirtDeviceCharacterProtocolTypeVIRTIO = "virtio";
...
TNLibvirtDeviceCharacterProtocolTypes = [TNLibvirtDeviceCharacterProtocolTypeVIRTIO, TNLibvirtDeviceCharacterProtocolTypeRAW, TNLibvirtDeviceCharacterProtocolTypeTELNET, TNLibvirtDeviceCharacterProtocolTypeTLS];
...
,["TNXMLNode"])]);
}p;42;Model/TNLibvirtDeviceHostDevSourceVendor.jt;1680;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;1579;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceHostDevSourceVendor"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_id")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;48;Model/TNLibvirtDeviceInterfaceBandwidthInbound.jt;3364;@STATIC;1.0;i;15;TNLibvirtBase.jt;3325;objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceInterfaceBandwidthInbound"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_average"), new objj_ivar("_burst"), new objj_ivar("_peak")]);objj_registerClassPair(the_class);
...
}p;39;Model/TNLibvirtDeviceFilesystemSource.jt;2165;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;2064;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceFilesystemSource"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_name"), new objj_ivar("_dir")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;30;Model/TNLibvirtDeviceGraphic.jt;7490;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;7389;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);TNLibvirtDeviceGraphicTypeVNC = "vnc";
...
TNLibvirtDeviceGraphicVNCKeymaps = [TNLibvirtDeviceGraphicVNCKeymapEN_US, TNLibvirtDeviceGraphicVNCKeymapEN_GB, TNLibvirtDeviceGraphicVNCKeymapFR, TNLibvirtDeviceGraphicVNCKeymapFR_CH, TNLibvirtDeviceGraphicVNCKeymapDE, TNLibvirtDeviceGraphicVNCKeymapES, TNLibvirtDeviceGraphicVNCKeymapNO, TNLibvirtDeviceGraphicVNCKeymapHU, TNLibvirtDeviceGraphicVNCKeymapIT, TNLibvirtDeviceGraphicVNCKeymapNL_BE, TNLibvirtDeviceGraphicVNCKeymapPT];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceGraphic"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_autoPort"), new objj_ivar("_fullScreen"), new objj_ivar("_multiUser"), new objj_ivar("_display"), new objj_ivar("_keymap"), new objj_ivar("_listen"), new objj_ivar("_password"), new objj_ivar("_port"), new objj_ivar("_type")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;39;Model/TNLibvirtDeviceFilesystemTarget.jt;1670;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;1569;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceFilesystemTarget"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_dir")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;33;Model/TNLibvirtDeviceDiskSource.jt;5118;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.ji;31;TNLibvirtDeviceDiskSourceHost.jt;4981;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);objj_executeFile("TNLibvirtDeviceDiskSourceHost.j", YES);TNLibvirtDeviceDiskSourceProtocolSheepdog = "sheepdog";
TNLibvirtDeviceDiskSourceProtocolNBD = "nbd";
TNLibvirtDeviceDiskSourceProtocolRBD = "rbd";
TNLibvirtDeviceDiskSourceProtocols = [TNLibvirtDeviceDiskSourceProtocolSheepdog, TNLibvirtDeviceDiskSourceProtocolNBD, TNLibvirtDeviceDiskSourceProtocolRBD];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceDiskSource"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_hosts"), new objj_ivar("_device"), new objj_ivar("_file"), new objj_ivar("_name"), new objj_ivar("_protocol")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;38;Model/TNLibvirtDeviceInterfaceTarget.jt;1663;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;1562;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceInterfaceTarget"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_dev")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;25;Model/TNLibvirtDomainOS.jt;6428;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.ji;23;TNLibvirtDomainOSType.jt;6299;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);objj_executeFile("TNLibvirtDomainOSType.j", YES);TNLibvirtDomainOSBootHardDrive = "hd";
TNLibvirtDomainOSBootCDROM = "cdrom";
TNLibvirtDomainOSBootNetwork = "network";
TNLibvirtDomainOSBootFileDescriptor = "fd";
TNLibvirtDomainOSBoots = [TNLibvirtDomainOSBootHardDrive, TNLibvirtDomainOSBootCDROM, TNLibvirtDomainOSBootNetwork, TNLibvirtDomainOSBootFileDescriptor];
{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDomainOS"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_bootMenuEnabled"), new objj_ivar("_boot"), new objj_ivar("_commandLine"), new objj_ivar("_initrd"), new objj_ivar("_kernel"), new objj_ivar("_loader"), new objj_ivar("_type")]);objj_registerClassPair(the_class);
...
,["TNXMLNode"])]);
}p;41;Model/TNLibvirtDeviceInterfaceFilterRef.jt;3497;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.ji;15;TNLibvirtBase.jt;3396;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("TNLibvirtBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtBase, "TNLibvirtDeviceInterfaceFilterRef"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_filter"), new objj_ivar("_parameters")]);objj_registerClassPair(the_class);
...
,["void"]), new objj_method(sel_getUid("initWithXMLNode:"), function $TNLibvirtDeviceInterfaceFilterRef__initWithXMLNode_(self, _cmd, aNode)
{
    if (self = objj_msgSendSuper({ receiver:self, super_class:objj_getClass("TNLibvirtDeviceInterfaceFilterRef").super_class }, "initWithXMLNode:", aNode))
    {
        ...
        for (var i = 0; i < objj_msgSend(paramNodes, "count"); i++)
        {
            ...
            objj_msgSend(self._parameters, "addObject:", objj_msgSend(objj_msgSend(CPDictionary, "alloc"), "initWithObjectsAndKeys:", name, "name", value, "value"));
        }
    }
    return self;
}
,["id","TNXMLNode"]), new objj_method(sel_getUid("XMLNode"), function $TNLibvirtDeviceInterfaceFilterRef__XMLNode(self, _cmd)
{
    ...
    for (var i = 0; i < objj_msgSend(self._parameters, "count"); i++)
    {
        objj_msgSend(node, "addChildWithName:andAttributes:", "parameter", {"name": objj_msgSend(objj_msgSend(self._parameters, "objectAtIndex:", i), "valueForKey:", "name"), "value": objj_msgSend(objj_msgSend(self._parameters, "objectAtIndex:", i), "valueForKey:", "value")});
        objj_msgSend(node, "up");
    }
    return node;
}
