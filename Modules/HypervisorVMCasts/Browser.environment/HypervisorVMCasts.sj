@STATIC;1.0;p;20;TNVMCastDatasource.jt;12584;@STATIC;1.0;I;23;Foundation/Foundation.jt;12536;objj_executeFile("Foundation/Foundation.j", NO);TNArchipelApplianceInstalled = 1;
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_content"), new objj_ivar("_comment"), new objj_ivar("_name"), new objj_ivar("_UUID"), new objj_ivar("_URL")]);objj_registerClassPair(the_class);
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_comment"), new objj_ivar("_name"), new objj_ivar("_pubDate"), new objj_ivar("_size"), new objj_ivar("_UUID"), new objj_ivar("_URL"), new objj_ivar("_status")]);objj_registerClassPair(the_class);
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_filterInstalled"), new objj_ivar("_contents"), new objj_ivar("_filter")]);objj_registerClassPair(the_class);
...
,["CPArray","CPArray"]), new objj_method(sel_getUid("filterOnlyMatching:"), function $TNVMCastDatasource__filterOnlyMatching_(self, _cmd, anArray)
{
    if (self._filter && self._filter != "")
    {
        ...
        for (var i = 0; i < objj_msgSend(anArray, "count"); i++)
        {
            ...
            if (objj_msgSend(objj_msgSend(object, "name"), "uppercaseString").indexOf(objj_msgSend(self._filter, "uppercaseString")) != -1 || objj_msgSend(objj_msgSend(object, "comment"), "uppercaseString").indexOf(objj_msgSend(self._filter, "uppercaseString")) != -1)
...
}p;17;TNDownoadObject.jt;2472;@STATIC;1.0;I;23;Foundation/Foundation.jt;2425;objj_executeFile("Foundation/Foundation.j", NO);{var the_class = objj_allocateClassPair(CPObject, "TNDownload"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_identifier"), new objj_ivar("_name"), new objj_ivar("_percentage"), new objj_ivar("_totalSize")]);objj_registerClassPair(the_class);
...
p;23;TNCellApplianceStatus.jt;5079;@STATIC;1.0;I;23;Foundation/Foundation.jI;16;AppKit/CPImage.jI;20;AppKit/CPImageView.jI;20;AppKit/CPTextField.ji;20;TNVMCastDatasource.jt;4936;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPImage.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("TNVMCastDatasource.j", YES);var TNCellApplianceStatusIconInstalled,
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_imageStatus"), new objj_ivar("_fieldStatus")]);objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("init"), function $TNCellApplianceStatus__init(self, _cmd)
{
    ...
    {
        self._imageStatus = objj_msgSend(objj_msgSend(CPImageView, "alloc"), "initWithFrame:", CGRectMake(0, 8, 10, 10));
        self._fieldStatus = objj_msgSend(objj_msgSend(CPTextField, "alloc"), "initWithFrame:", CGRectMake(15, 5, 200, 100));
...
{
    TNCellApplianceStatusIconInstalled = CPImageInBundle("IconsStatus/green.png", CGSizeMake(10.0, 10.0), objj_msgSend(CPBundle, "mainBundle"));
    TNCellApplianceStatusIconNotInstalled = CPImageInBundle("IconsStatus/gray.png", CGSizeMake(10.0, 10.0), objj_msgSend(CPBundle, "mainBundle"));
    TNCellApplianceStatusIconError = CPImageInBundle("IconsStatus/red.png", CGSizeMake(10.0, 10.0), objj_msgSend(CPBundle, "mainBundle"));
    TNCellApplianceStatusIconInstalling = CPImageInBundle("spinner.gif", CGSizeMake(10.0, 10.0), objj_msgSend(CPBundle, "mainBundle"));
}
,["void"])]);
}p;32;TNVMCastRegistrationController.jt;5896;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/CPView.jI;17;AppKit/CPButton.jI;20;AppKit/CPTextField.jI;33;GrowlCappuccino/GrowlCappuccino.jI;35;StropheCappuccino/TNStropheStanza.jI;15;TNKit/TNAlert.jt;5684;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("GrowlCappuccino/GrowlCappuccino.j", NO);objj_executeFile("StropheCappuccino/TNStropheStanza.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);var TNArchipelTypeHypervisorVMCasting = "archipel:hypervisor:vmcasting",
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonNewVMCast"), new objj_ivar("mainPopover"), new objj_ivar("fieldNewURL"), new objj_ivar("_delegate")]);objj_registerClassPair(the_class);
...
,["id","id"]), new objj_method(sel_getUid("addNewVMCast"), function $TNVMCastRegistrationController__addNewVMCast(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorVMCastingRegister, "url": url});
...
,["void"]), new objj_method(sel_getUid("performRemoveVMCast:"), function $TNVMCastRegistrationController__performRemoveVMCast_(self, _cmd, someUserInfo)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorVMCasting});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorVMCastingUnregister, "uuid": uuid});
...
p;27;TNDownloadQueueController.jt;5124;@STATIC;1.0;I;23;Foundation/Foundation.jI;20;AppKit/CPTableView.jI;17;AppKit/CPWindow.jI;35;StropheCappuccino/TNStropheStanza.jI;29;TNKit/TNTableViewDataSource.ji;22;TNCellPercentageView.ji;17;TNDownoadObject.jt;4907;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPTableView.j", NO);objj_executeFile("AppKit/CPWindow.j", NO);objj_executeFile("StropheCappuccino/TNStropheStanza.j", NO);objj_executeFile("TNKit/TNTableViewDataSource.j", NO);objj_executeFile("TNCellPercentageView.j", YES);objj_executeFile("TNDownoadObject.j", YES);var TNArchipelTypeHypervisorVMCasting = "archipel:hypervisor:vmcasting",
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("mainPopover"), new objj_ivar("mainTableView"), new objj_ivar("labelTarget"), new objj_ivar("_delegate"), new objj_ivar("_timer"), new objj_ivar("_dlDatasource")]);objj_registerClassPair(the_class);
...
,["id","id"]), new objj_method(sel_getUid("getDownloadQueue:"), function $TNDownloadQueueController__getDownloadQueue_(self, _cmd, aTimer)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorVMCasting});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorVMCastingDownloadQueue});
...
p;22;TNCellPercentageView.jt;2026;@STATIC;1.0;I;23;Foundation/Foundation.jI;28;AppKit/CPProgressIndicator.jt;1946;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPProgressIndicator.j", NO);{var the_class = objj_allocateClassPair(CPView, "TNCellPercentageView"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_progressBar")]);objj_registerClassPair(the_class);
...
,["void","CPCoder"])]);
}p;31;TNHypervisorVMCastsController.jt;32386;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;20;AppKit/CPButtonBar.jI;19;AppKit/CPCheckBox.jI;22;AppKit/CPOutlineView.jI;28;AppKit/CPProgressIndicator.jI;22;AppKit/CPSearchField.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.jI;17;AppKit/CPWindow.jI;15;TNKit/TNAlert.ji;22;../../Model/TNModule.ji;23;TNCellApplianceStatus.ji;17;TNDownoadObject.ji;20;TNVMCastDatasource.ji;32;TNVMCastRegistrationController.ji;27;TNDownloadQueueController.jt;31922;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPButtonBar.j", NO);objj_executeFile("AppKit/CPCheckBox.j", NO);objj_executeFile("AppKit/CPOutlineView.j", NO);objj_executeFile("AppKit/CPProgressIndicator.j", NO);objj_executeFile("AppKit/CPSearchField.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPWindow.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);objj_executeFile("../../Model/TNModule.j", YES);objj_executeFile("TNCellApplianceStatus.j", YES);objj_executeFile("TNDownoadObject.j", YES);objj_executeFile("TNVMCastDatasource.j", YES);objj_executeFile("TNVMCastRegistrationController.j", YES);objj_executeFile("TNDownloadQueueController.j", YES);var TNArchipelVMCastsOpenedVMCasts = "TNArchipelVMCastsOpenedVMCasts_",
...
,["void","CPOutlineView"]), new objj_method(sel_getUid("awakeFromCib"), function $TNHypervisorVMCastsController__awakeFromCib(self, _cmd)
{
    ...
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForRegisterVmCast, CPBundleLocalizedString("Register to a new VMCast feed", "Register to a new VMCast feed"), self, sel_getUid("openNewVMCastURLWindow:"), CPImageInBundle("IconsButtons/plus.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForRemoveItem, CPBundleLocalizedString("Remove/Unregister", "Remove/Unregister"), self, sel_getUid("remove:"), CPImageInBundle("IconsButtons/minus.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForDownloadApplicance, CPBundleLocalizedString("Download selected appliance", "Download selected appliance"), self, sel_getUid("download:"), CPImageInBundle("IconsButtons/download.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForShowDownloadQueue, CPBundleLocalizedString("Open download queue", "Open download queue"), self, sel_getUid("showDownloadQueue:"), CPImageInBundle("IconsButtons/view.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveItem), "setEnabled:", NO);
    objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDownloadApplicance), "setEnabled:", NO);
    objj_msgSend(self.buttonBarControl, "setButtons:", [objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRegisterVmCast), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveItem), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDownloadApplicance), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForShowDownloadQueue)]);
...
{
    objj_msgSend(self, "setControl:enabledAccordingToPermission:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForShowDownloadQueue), "vmcasting_downloadqueue");
    objj_msgSend(self, "setControl:enabledAccordingToPermission:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRegisterVmCast), "vmcasting_register");
    ...
    if (objj_msgSend(currentVMCast, "isKindOfClass:", TNVMCast) && objj_msgSend(self, "currentEntityHasPermission:", "vmcasting_unregister"))
        objj_msgSend(self, "setControl:enabledAccordingToPermission:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveItem), "vmcasting_unregister");
        ...
        objj_msgSend(self, "setControl:enabledAccordingToPermission:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveItem), "vmcasting_deleteappliance");
    else
        objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveItem), "setEnabled:", NO);
}
...
,["id","id"]), new objj_method(sel_getUid("openNewVMCastURLWindow:"), function $TNHypervisorVMCastsController__openNewVMCastURLWindow_(self, _cmd, aSender)
{
    ...
    if (!objj_msgSend(self, "isVisible"))
        return;
    objj_msgSend(self.VMCastRegistrationController, "openWindow:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRegisterVmCast));
}
...
,["id","id"]), new objj_method(sel_getUid("showDownloadQueue:"), function $TNHypervisorVMCastsController__showDownloadQueue_(self, _cmd, aSender)
{
    ...
    if (!objj_msgSend(self, "isVisible"))
        return;
    objj_msgSend(self.downloadQueueController, "showWindow:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForShowDownloadQueue));
}
,["id","id"]), new objj_method(sel_getUid("getVMCasts"), function $TNHypervisorVMCastsController__getVMCasts(self, _cmd)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "get");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorVMCasting});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorVMCastingGet});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("updateDownloadProgress:"), function $TNHypervisorVMCastsController__updateDownloadProgress_(self, _cmd, aTimer)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "get");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorVMCasting});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorVMCastingDownloadProgress});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("remove"), function $TNHypervisorVMCastsController__remove(self, _cmd)
{
    ...
    {
        if (objj_msgSend(currentVMCast, "status") == TNArchipelApplianceInstalled)
            objj_msgSend(self, "removeAppliance");
    }
...
,["void"]), new objj_method(sel_getUid("performRemoveAppliance:"), function $TNHypervisorVMCastsController__performRemoveAppliance_(self, _cmd, someUserInfo)
{
    var selectedIndex = objj_msgSend(objj_msgSend(self._mainOutlineView, "selectedRowIndexes"), "firstIndex"),
        ...
        stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "set");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorVMCasting});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorVMCastingDeleteAppliance, "uuid": uuid});
...
,["void"]), new objj_method(sel_getUid("performDownload:"), function $TNHypervisorVMCastsController__performDownload_(self, _cmd, someUserInfo)
{
    var selectedIndex = objj_msgSend(objj_msgSend(self._mainOutlineView, "selectedRowIndexes"), "firstIndex"),
        ...
        stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "set");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorVMCasting});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorVMCastingDownload, "uuid": uuid});
...
{
    objj_msgSend(self.downloadQueueController, "closeWindow:", nil);
    objj_msgSend(self.downloadQueueController, "showWindow:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRegisterVmCast));
    return NO;
}
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("outlineViewSelectionDidChange:"), function $TNHypervisorVMCastsController__outlineViewSelectionDidChange_(self, _cmd, aNotification)
{
    ...
    if (objj_msgSend(self._mainOutlineView, "numberOfSelectedRows") > 0)
    {
        ...
        if (objj_msgSend(object, "isKindOfClass:", TNVMCast))
        {
            ...
            objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDownloadApplicance), "vmcasting_downloadappliance", conditionNotInstalled);
            objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveItem), "vmcasting_deleteappliance", conditionInstalled);
        }
...
,["void","CPNotification"]), new objj_method(sel_getUid("outlineView:menuForTableColumn:item:"), function $TNHypervisorVMCastsController__outlineView_menuForTableColumn_item_(self, _cmd, anOutlineView, aTableColumn, anItem)
{
    if (anOutlineView != self._mainOutlineView && objj_msgSend(anOutlineView, "numberOfSelectedRows") > 1)
        return;
    objj_msgSend(self._contextualMenu, "removeAllItems");
    if (objj_msgSend(anOutlineView, "numberOfSelectedRows") == 0)
    {
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForRegisterVmCast));
        return self._contextualMenu;
    }
    var itemRow = objj_msgSend(self._mainOutlineView, "rowForItem:", anItem);
    if (objj_msgSend(self._mainOutlineView, "selectedRow") != itemRow)
        objj_msgSend(self._mainOutlineView, "selectRowIndexes:byExtendingSelection:", objj_msgSend(CPIndexSet, "indexSetWithIndex:", itemRow), NO);
    var selectedIndexes = objj_msgSend(self._mainOutlineView, "selectedRowIndexes"),
        object = objj_msgSend(self._mainOutlineView, "itemAtRow:", objj_msgSend(selectedIndexes, "firstIndex"));
    if (objj_msgSend(object, "isKindOfClass:", TNVMCast) && (objj_msgSend(object, "status") == TNArchipelApplianceNotInstalled || objj_msgSend(object, "status") == TNArchipelApplianceInstallationError))
    {
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForDownloadApplicance));
    }
    else
    {
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForRemoveItem));
    }
    return self._contextualMenu;
}
,["CPMenu","CPOutlineView","CPTableColumn","int"]), new objj_method(sel_getUid("outlineViewDeleteKeyPressed:"), function $TNHypervisorVMCastsController__outlineViewDeleteKeyPressed_(self, _cmd, anOutlineView)
{
    if (anOutlineView != self._mainOutlineView)
        return;
    objj_msgSend(self, "remove:", anOutlineView);
}
,["void","CPOutlineView"])]);
}CPBundleLocalizedString = function(key, comment)
{
