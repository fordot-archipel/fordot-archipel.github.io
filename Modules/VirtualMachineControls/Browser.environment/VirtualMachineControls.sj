@STATIC;1.0;p;36;TNVirtualMachineControlsController.jt;64178;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;20;AppKit/CPButtonBar.jI;16;AppKit/CPImage.jI;20;AppKit/CPImageView.jI;22;AppKit/CPSearchField.jI;27;AppKit/CPSegmentedControl.jI;17;AppKit/CPSlider.jI;20;AppKit/CPTableView.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.jI;15;TNKit/TNAlert.jI;29;TNKit/TNTableViewDataSource.jI;26;TNKit/TNTextFieldStepper.jI;37;StropheCappuccino/TNStropheIMClient.ji;22;../../Views/TNSwitch.ji;22;../../Model/TNModule.ji;25;TNExtendedContactObject.jt;63675;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPButtonBar.j", NO);objj_executeFile("AppKit/CPImage.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("AppKit/CPSearchField.j", NO);objj_executeFile("AppKit/CPSegmentedControl.j", NO);objj_executeFile("AppKit/CPSlider.j", NO);objj_executeFile("AppKit/CPTableView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);objj_executeFile("TNKit/TNTableViewDataSource.j", NO);objj_executeFile("TNKit/TNTextFieldStepper.j", NO);objj_executeFile("StropheCappuccino/TNStropheIMClient.j", NO);objj_executeFile("../../Views/TNSwitch.j", YES);objj_executeFile("../../Model/TNModule.j", YES);objj_executeFile("TNExtendedContactObject.j", YES);var TNArchipelPushNotificationDefinition = "archipel:push:virtualmachine:definition",
...
class_addMethods(the_class, [new objj_method(sel_getUid("awakeFromCib"), function $TNVirtualMachineControlsController__awakeFromCib(self, _cmd)
{
    ...
    self._imagePlay = CPImageInBundle("IconsButtons/play.png", CGSizeMake(16, 16), mainBundle);
    self._imageStop = CPImageInBundle("IconsButtons/stop.png", CGSizeMake(16, 16), mainBundle);
    self._imageDestroy = CPImageInBundle("IconsButtons/destroy.png", CGSizeMake(16, 16), mainBundle);
    self._imagePause = CPImageInBundle("IconsButtons/pause.png", CGSizeMake(16, 16), mainBundle);
    self._imageReboot = CPImageInBundle("IconsButtons/reboot.png", CGSizeMake(16, 16), mainBundle);
    ...
    objj_msgSend(self._migrateButton, "setImage:", CPImageInBundle("IconsButtons/migrate.png", CGSizeMake(16, 16), mainBundle));
    ...
    self._imageScreenShutDown = CPImageInBundle("shutdown.png", CGSizeMake(216, 162), bundle);
...
,["id","id"]), new objj_method(sel_getUid("getVirtualMachineInfo"), function $TNVirtualMachineControlsController__getVirtualMachineInfo(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineControlInfo});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("getThumbnailScreenshot"), function $TNVirtualMachineControlsController__getThumbnailScreenshot(self, _cmd)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "get");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeVirtualMachineControl});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineControlScreenshot, "size": "thumbnail"});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("getFullScreenshot"), function $TNVirtualMachineControlsController__getFullScreenshot(self, _cmd)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "get");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeVirtualMachineControl});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineControlScreenshot, "size": "full"});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("pause"), function $TNVirtualMachineControlsController__pause(self, _cmd)
{
    ...
    if (objj_msgSend(self._entity, "XMPPShow") == TNStropheContactStatusAway)
    {
        ...
        objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeVirtualMachineControl});
        objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"xmlns": TNArchipelTypeVirtualMachineControl, "action": TNArchipelTypeVirtualMachineControlResume});
    }
    else if (objj_msgSend(self._entity, "XMPPShow") == TNStropheContactStatusOnline)
    {
        selector = sel_getUid("_didPause:");
        objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeVirtualMachineControl});
        objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"xmlns": TNArchipelTypeVirtualMachineControl, "action": TNArchipelTypeVirtualMachineControlSuspend});
    }
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("stop"), function $TNVirtualMachineControlsController__stop(self, _cmd)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "set");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeVirtualMachineControl});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineControlShutDown});
...
,["void"]), new objj_method(sel_getUid("performDestroy:"), function $TNVirtualMachineControlsController__performDestroy_(self, _cmd, someUserInfo)
{
    ...
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "set");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeVirtualMachineControl});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineControlDestroy});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("reboot"), function $TNVirtualMachineControlsController__reboot(self, _cmd)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "set");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeVirtualMachineControl});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineControlReboot});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("setAutostart"), function $TNVirtualMachineControlsController__setAutostart(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeVirtualMachineControl});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineControlAutostart, "value": autostart});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("getOOMKiller"), function $TNVirtualMachineControlsController__getOOMKiller(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineOOMGetAdjust});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("setPreventOOMKiller"), function $TNVirtualMachineControlsController__setPreventOOMKiller(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeVirtualMachineOOM});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineOOMSetAdjust, "adjust": prevent});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("setMemory"), function $TNVirtualMachineControlsController__setMemory(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeVirtualMachineControl});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineControlMemory, "value": memory});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("setVCPUs"), function $TNVirtualMachineControlsController__setVCPUs(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeVirtualMachineControl});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineControlVCPUs, "value": cpus});
...
,["void"]), new objj_method(sel_getUid("performMigrate:"), function $TNVirtualMachineControlsController__performMigrate_(self, _cmd, someUserInfo)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeVirtualMachineControl});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineControlMigrate, "hypervisorjid": objj_msgSend(destinationHypervisor, "fullJID")});
...
,["void"]), new objj_method(sel_getUid("performFree:"), function $TNVirtualMachineControlsController__performFree_(self, _cmd, someUserInfo)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "set");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeVirtualMachineControl});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineControlFree});
...
,["void"]), new objj_method(sel_getUid("performPark:"), function $TNVirtualMachineControlsController__performPark_(self, _cmd, someUserInfo)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineVMParkingPark, "force": "True"});
...
p;25;TNExtendedContactObject.jt;2241;@STATIC;1.0;I;23;Foundation/Foundation.jI;16;AppKit/CPImage.jt;2173;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPImage.j", NO);var TNExtendedContactImageSelected;
{var the_class = objj_allocateClassPair(CPObject, "TNExtendedContact"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_name"), new objj_ivar("_fullJID"), new objj_ivar("_selected")]);objj_registerClassPair(the_class);
...
{
    TNExtendedContactImageSelected = CPImageInBundle("IconsButtons/check.png", CGSizeMake(12, 12), objj_msgSend(CPBundle, "mainBundle"));
}
,["void"])]);
}e;