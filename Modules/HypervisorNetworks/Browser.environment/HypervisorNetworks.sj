...
,["void","CGRect"]), new objj_method(sel_getUid("setObjectValue:"), function $TNNetworkDataView__setObjectValue_(self, _cmd, aNetwork)
{
    ...
    objj_msgSend(self.fieldBridgeForwardMode, "setStringValue:", objj_msgSend(aNetwork, "forward") ? objj_msgSend(objj_msgSend(aNetwork, "forward"), "mode") : "isolated");
...
{
    TNNetworkDataViewStatusImageActive = CPImageInBundle("IconsStatus/green.png", CGSizeMake(8.0, 8.0), objj_msgSend(CPBundle, "mainBundle"));
    TNNetworkDataViewStatusImageUnactive = CPImageInBundle("IconsStatus/red.png", CGSizeMake(8.0, 8.0), objj_msgSend(CPBundle, "mainBundle"));
}
,["void"])]);
}p;32;TNHypervisorNetworksController.jt;34474;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;20;AppKit/CPButtonBar.jI;25;AppKit/CPCollectionView.jI;22;AppKit/CPSearchField.jI;20;AppKit/CPTableView.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.jI;28;LPKit/LPMultiLineTextField.jI;15;TNKit/TNAlert.jI;29;TNKit/TNTableViewDataSource.ji;22;../../Model/TNModule.ji;20;Model/TNLibvirtNet.ji;19;TNNetworkDataView.ji;28;TNNetworkEditionController.jt;34056;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPButtonBar.j", NO);objj_executeFile("AppKit/CPCollectionView.j", NO);objj_executeFile("AppKit/CPSearchField.j", NO);objj_executeFile("AppKit/CPTableView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("LPKit/LPMultiLineTextField.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);objj_executeFile("TNKit/TNTableViewDataSource.j", NO);objj_executeFile("../../Model/TNModule.j", YES);objj_executeFile("Model/TNLibvirtNet.j", YES);objj_executeFile("TNNetworkDataView.j", YES);objj_executeFile("TNNetworkEditionController.j", YES);var TNArchipelPushNotificationNetworks = "archipel:push:network",
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonDefineXMLString"), new objj_ivar("buttonBarControl"), new objj_ivar("fieldFilterNetworks"), new objj_ivar("tableViewNetworks"), new objj_ivar("viewTableContainer"), new objj_ivar("fieldXMLString"), new objj_ivar("networkDataViewPrototype"), new objj_ivar("networkController"), new objj_ivar("popoverXMLString"), new objj_ivar("_networkHolder"), new objj_ivar("_datasourceNetworks"), new objj_ivar("_networksRAW")]);objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("awakeFromCib"), function $TNHypervisorNetworksController__awakeFromCib(self, _cmd)
{
    ...
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForAddNework, CPBundleLocalizedString("Create a new network", "Create a new network"), self, sel_getUid("addNetwork:"), CPImageInBundle("IconsButtons/plus.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForRemoveNetwork, CPBundleLocalizedString("Remove", "Remove"), self, sel_getUid("delNetwork:"), CPImageInBundle("IconsButtons/minus.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForEditNetwork, CPBundleLocalizedString("Edit network settings", "Edit network settings"), self, sel_getUid("editNetwork:"), CPImageInBundle("IconsButtons/edit.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForActivateNetwork, CPBundleLocalizedString("Enable", "Enable"), self, sel_getUid("activateNetwork:"), CPImageInBundle("IconsButtons/check.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForDeactivateNetwork, CPBundleLocalizedString("Disable", "Disable"), self, sel_getUid("deactivateNetwork:"), CPImageInBundle("IconsButtons/cancel.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForEditXML, CPBundleLocalizedString("Open manual XML editor", "Open manual XML editor"), self, sel_getUid("openXMLEditor:"), CPImageInBundle("IconsButtons/editxml.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveNetwork), "setEnabled:", NO);
    objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForActivateNetwork), "setEnabled:", NO);
    objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDeactivateNetwork), "setEnabled:", NO);
    objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForEditNetwork), "setEnabled:", NO);
    objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForEditXML), "setEnabled:", NO);
    objj_msgSend(self.buttonBarControl, "setButtons:", [objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForAddNework), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveNetwork), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForEditNetwork), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForActivateNetwork), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDeactivateNetwork), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForEditXML)]);
...
,["void"]), new objj_method(sel_getUid("setUIAccordingToPermissions"), function $TNHypervisorNetworksController__setUIAccordingToPermissions(self, _cmd)
{
    ...
    objj_msgSend(self, "setControl:enabledAccordingToPermission:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForAddNework), "network_define");
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForDeactivateNetwork), "network_destroy", conditionTableSelectedRow && conditionNetworkActive);
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForEditXML), "network_define", conditionTableSelectedOnlyOnRow && conditionNetworkActive);
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveNetwork), "network_undefine", conditionTableSelectedRow && !conditionNetworkActive);
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForEditNetwork), "network_define", conditionTableSelectedOnlyOnRow && !conditionNetworkActive);
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForActivateNetwork), "network_create", conditionTableSelectedRow && !conditionNetworkActive);
...
,["CPString"]), new objj_method(sel_getUid("addNetwork:"), function $TNHypervisorNetworksController__addNetwork_(self, _cmd, aSender)
{
    ...
    objj_msgSend(self.networkController, "openWindow:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForAddNework));
}
...
,["void","id"]), new objj_method(sel_getUid("editNetwork:"), function $TNHypervisorNetworksController__editNetwork_(self, _cmd, aSender)
{
    ...
    if (selectedIndex != -1)
    {
        ...
        objj_msgSend(self.popoverXMLString, "close");
        objj_msgSend(self.networkController, "openWindow:", objj_msgSend(aSender, "isKindOfClass:", CPMenuItem) ? self.tableViewNetworks : aSender);
    }
}
...
,["void","id"]), new objj_method(sel_getUid("openXMLEditor:"), function $TNHypervisorNetworksController__openXMLEditor_(self, _cmd, aSender)
{
    ...
    {
        var rect = objj_msgSend(self.tableViewNetworks, "rectOfRow:", objj_msgSend(self.tableViewNetworks, "selectedRow"));
        rect.origin.y += rect.size.height / 2;
        rect.origin.x += rect.size.width / 2;
        objj_msgSend(self.popoverXMLString, "showRelativeToRect:ofView:preferredEdge:", CGRectMake(rect.origin.x, rect.origin.y, 10, 10), self.tableViewNetworks, nil);
    }
    else
        objj_msgSend(self.popoverXMLString, "showRelativeToRect:ofView:preferredEdge:", nil, aSender, nil);
...
,["id","id"]), new objj_method(sel_getUid("getHypervisorNetworks"), function $TNHypervisorNetworksController__getHypervisorNetworks(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorNetworkGet});
...
,["void","id"]), new objj_method(sel_getUid("getHypervisorNICS"), function $TNHypervisorNetworksController__getHypervisorNICS(self, _cmd)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "get");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorNetwork});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorNetworkGetNics});
    objj_msgSend(self, "setModuleStatus:", TNArchipelModuleStatusWaiting);
...
,["void","TNStropheStanza"]), new objj_method(sel_getUid("defineNetwork:"), function $TNHypervisorNetworksController__defineNetwork_(self, _cmd, aNetwork)
{
    ...
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "get");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorNetwork});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorNetworkUndefine, "uuid": objj_msgSend(aNetwork, "UUID")});
...
,["void","TNLibvirtNetwork"]), new objj_method(sel_getUid("_didNetworkUndefinBeforeDefining:"), function $TNHypervisorNetworksController___didNetworkUndefinBeforeDefining_(self, _cmd, aStanza)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorNetwork});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorNetworkDefine, "autostart": objj_msgSend(self._networkHolder, "isAutostart") ? "1" : "0"});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("activateNetworks:"), function $TNHypervisorNetworksController__activateNetworks_(self, _cmd, someNetworks)
{
    for (var i = 0; i < objj_msgSend(someNetworks, "count"); i++)
    {
        ...
        {
            objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorNetwork});
            objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"xmlns": TNArchipelTypeHypervisorNetwork, "action": TNArchipelTypeHypervisorNetworkCreate, "uuid": objj_msgSend(networkObject, "UUID")});
...
,["void","CPArray"]), new objj_method(sel_getUid("deactivateNetworks:"), function $TNHypervisorNetworksController__deactivateNetworks_(self, _cmd, someNetworks)
{
    for (var i = 0; i < objj_msgSend(someNetworks, "count"); i++)
    {
        ...
        {
            objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorNetwork});
            objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"xmlns": TNArchipelTypeHypervisorNetwork, "action": TNArchipelTypeHypervisorNetworkDestroy, "uuid": objj_msgSend(networkObject, "UUID")});
            objj_msgSend(self, "sendStanza:andRegisterSelector:", stanza, sel_getUid("_didNetworkStatusChange:"));
            objj_msgSend(self.tableViewNetworks, "deselectAll");
        }
    }
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("deleteNetworks:"), function $TNHypervisorNetworksController__deleteNetworks_(self, _cmd, someNetworks)
{
    for (var i = 0; i < objj_msgSend(someNetworks, "count"); i++)
    {
        ...
        if (objj_msgSend(networkObject, "isActive"))
        {
            objj_msgSend(TNAlert, "showAlertWithMessage:informative:style:", CPBundleLocalizedString("Error", "Error"), CPBundleLocalizedString("You can't delete a running network", "You can't delete a running network"), CPCriticalAlertStyle);
            return;
        }
        var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "get");
        objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorNetwork});
        objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"xmlns": TNArchipelTypeHypervisorNetwork, "action": TNArchipelTypeHypervisorNetworkUndefine, "uuid": objj_msgSend(networkObject, "UUID")});
...
,["void","CPNotification"]), new objj_method(sel_getUid("tableView:menuForTableColumn:row:"), function $TNHypervisorNetworksController__tableView_menuForTableColumn_row_(self, _cmd, aTableView, aColumn, aRow)
{
    var itemRow = objj_msgSend(self.tableViewNetworks, "rowAtPoint:", aRow);
    if (objj_msgSend(self.tableViewNetworks, "selectedRow") != aRow)
        objj_msgSend(self.tableViewNetworks, "selectRowIndexes:byExtendingSelection:", objj_msgSend(CPIndexSet, "indexSetWithIndex:", aRow), NO);
    var selectedIndex = objj_msgSend(objj_msgSend(self.tableViewNetworks, "selectedRowIndexes"), "firstIndex"),
        conditionTableSelectedRow = objj_msgSend(self.tableViewNetworks, "numberOfSelectedRows") != 0,
        networkObject = conditionTableSelectedRow ? objj_msgSend(self._datasourceNetworks, "objectAtIndex:", selectedIndex) : nil,
        conditionNetworkActive = objj_msgSend(networkObject, "isActive");
    objj_msgSend(self._contextualMenu, "removeAllItems");
    if (objj_msgSend(aTableView, "numberOfSelectedRows") == 0 && aTableView == self.tableViewNetworks)
    {
        objj_msgSend(self._contextualMenu, "removeAllItems");
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForAddNework));
        return self._contextualMenu;
    }
    if (!conditionNetworkActive)
    {
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForEditNetwork));
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForActivateNetwork));
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForRemoveNetwork));
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForEditXML));
    }
    else
    {
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForDeactivateNetwork));
    }
    return self._contextualMenu;
}
,["CPMenu","CPTableView","CPTableColumn","int"]), new objj_method(sel_getUid("tableViewDeleteKeyPressed:"), function $TNHypervisorNetworksController__tableViewDeleteKeyPressed_(self, _cmd, aTableView)
{
    if (objj_msgSend(aTableView, "numberOfSelectedRows") == 0)
        return;
    objj_msgSend(self, "delNetwork:", aTableView);
}
,["void","CPTableView"])]);
...
,["void","TNLibvirtNetwork"]), new objj_method(sel_getUid("awakeFromCib"), function $TNNetworkEditionController__awakeFromCib(self, _cmd)
{
    ...
    objj_msgSend(objj_msgSend(menuRange, "addItemWithTitle:action:keyEquivalent:", CPBundleLocalizedString("Add new range", "Add new range"), sel_getUid("addDHCPRange:"), ""), "setTarget:", self);
    objj_msgSend(objj_msgSend(menuRange, "addItemWithTitle:action:keyEquivalent:", CPBundleLocalizedString("Remove", "Remove"), sel_getUid("removeDHCPRange:"), ""), "setTarget:", self);
    objj_msgSend(self.tableViewRanges, "setMenu:", menuRange);
    objj_msgSend(objj_msgSend(menuHost, "addItemWithTitle:action:keyEquivalent:", CPBundleLocalizedString("Add new host reservation", "Add new host reservation"), sel_getUid("addDHCPHost:"), ""), "setTarget:", self);
    objj_msgSend(objj_msgSend(menuHost, "addItemWithTitle:action:keyEquivalent:", CPBundleLocalizedString("Remove", "Remove"), sel_getUid("removeDHCPHost:"), ""), "setTarget:", self);
...
p;41;Model/TNLibvirtNetworkBandwidthOutbound.jt;3318;@STATIC;1.0;i;22;TNLibvirtNetworkBase.jt;3272;objj_executeFile("TNLibvirtNetworkBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtNetworkBase, "TNLibvirtNetworkBandwidthOutbound"),
...
}p;30;Model/TNLibvirtNetworkBridge.jt;3285;@STATIC;1.0;i;22;TNLibvirtNetworkBase.jt;3239;objj_executeFile("TNLibvirtNetworkBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtNetworkBase, "TNLibvirtNetworkBridge"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_stp"), new objj_ivar("_delay"), new objj_ivar("_name")]);objj_registerClassPair(the_class);
...
}p;33;Model/TNLibvirtNetworkBandwidth.jt;3110;@STATIC;1.0;i;22;TNLibvirtNetworkBase.ji;34;TNLibvirtNetworkBandwidthInbound.ji;35;TNLibvirtNetworkBandwidthOutbound.jt;2985;objj_executeFile("TNLibvirtNetworkBase.j", YES);objj_executeFile("TNLibvirtNetworkBandwidthInbound.j", YES);objj_executeFile("TNLibvirtNetworkBandwidthOutbound.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtNetworkBase, "TNLibvirtNetworkBandwidth"),
...
,["TNLibvirtNetworkBandwidth"])]);
}p;26;Model/TNLibvirtNetworkIP.jt;5011;@STATIC;1.0;i;22;TNLibvirtNetworkBase.ji;24;TNLibvirtNetworkIPDHCP.ji;24;TNLibvirtNetworkIPTFTP.jt;4907;objj_executeFile("TNLibvirtNetworkBase.j", YES);objj_executeFile("TNLibvirtNetworkIPDHCP.j", YES);objj_executeFile("TNLibvirtNetworkIPTFTP.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtNetworkBase, "TNLibvirtNetworkIP"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_address"), new objj_ivar("_family"), new objj_ivar("_netmask"), new objj_ivar("_prefix"), new objj_ivar("_DHCP"), new objj_ivar("_TFTP")]);objj_registerClassPair(the_class);
...
}p;20;Model/TNLibvirtNet.jt;1188;@STATIC;1.0;i;18;TNLibvirtNetwork.ji;27;TNLibvirtNetworkBandwidth.ji;34;TNLibvirtNetworkBandwidthInbound.ji;35;TNLibvirtNetworkBandwidthOutbound.ji;22;TNLibvirtNetworkBase.ji;24;TNLibvirtNetworkBridge.ji;24;TNLibvirtNetworkDomain.ji;25;TNLibvirtNetworkForward.ji;34;TNLibvirtNetworkForwardInterface.ji;20;TNLibvirtNetworkIP.ji;24;TNLibvirtNetworkIPDHCP.ji;28;TNLibvirtNetworkIPDHCPHost.ji;29;TNLibvirtNetworkIPDHCPRange.ji;24;TNLibvirtNetworkIPTFTP.jt;732;objj_executeFile("TNLibvirtNetwork.j", YES);objj_executeFile("TNLibvirtNetworkBandwidth.j", YES);objj_executeFile("TNLibvirtNetworkBandwidthInbound.j", YES);objj_executeFile("TNLibvirtNetworkBandwidthOutbound.j", YES);objj_executeFile("TNLibvirtNetworkBase.j", YES);objj_executeFile("TNLibvirtNetworkBridge.j", YES);objj_executeFile("TNLibvirtNetworkDomain.j", YES);objj_executeFile("TNLibvirtNetworkForward.j", YES);objj_executeFile("TNLibvirtNetworkForwardInterface.j", YES);objj_executeFile("TNLibvirtNetworkIP.j", YES);objj_executeFile("TNLibvirtNetworkIPDHCP.j", YES);objj_executeFile("TNLibvirtNetworkIPDHCPHost.j", YES);objj_executeFile("TNLibvirtNetworkIPDHCPRange.j", YES);objj_executeFile("TNLibvirtNetworkIPTFTP.j", YES);p;30;Model/TNLibvirtNetworkIPDHCP.jt;3815;@STATIC;1.0;i;22;TNLibvirtNetworkBase.ji;28;TNLibvirtNetworkIPDHCPHost.ji;29;TNLibvirtNetworkIPDHCPRange.jt;3702;objj_executeFile("TNLibvirtNetworkBase.j", YES);objj_executeFile("TNLibvirtNetworkIPDHCPHost.j", YES);objj_executeFile("TNLibvirtNetworkIPDHCPRange.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtNetworkBase, "TNLibvirtNetworkIPDHCP"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_hosts"), new objj_ivar("_ranges")]);objj_registerClassPair(the_class);
...
,["TNLibvirtNetworkIPDHCP"])]);
}p;40;Model/TNLibvirtNetworkForwardInterface.jt;2065;@STATIC;1.0;i;22;TNLibvirtNetworkBase.jt;2019;objj_executeFile("TNLibvirtNetworkBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtNetworkBase, "TNLibvirtNetworkForwardInterface"),
...
}p;28;Model/TNLibvirtNetworkBase.jt;1034;@STATIC;1.0;I;23;Foundation/Foundation.jI;29;StropheCappuccino/TNXMLNode.jt;954;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);{var the_class = objj_allocateClassPair(CPObject, "TNLibvirtNetworkBase"),
...
,["CPString"])]);
}p;30;Model/TNLibvirtNetworkDomain.jt;1954;@STATIC;1.0;i;22;TNLibvirtNetworkBase.jt;1908;objj_executeFile("TNLibvirtNetworkBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtNetworkBase, "TNLibvirtNetworkDomain"),
...
}p;24;Model/TNLibvirtNetwork.jt;7390;@STATIC;1.0;i;27;TNLibvirtNetworkBandwidth.ji;22;TNLibvirtNetworkBase.ji;24;TNLibvirtNetworkBridge.ji;24;TNLibvirtNetworkDomain.ji;25;TNLibvirtNetworkForward.ji;20;TNLibvirtNetworkIP.jt;7199;objj_executeFile("TNLibvirtNetworkBandwidth.j", YES);objj_executeFile("TNLibvirtNetworkBase.j", YES);objj_executeFile("TNLibvirtNetworkBridge.j", YES);objj_executeFile("TNLibvirtNetworkDomain.j", YES);objj_executeFile("TNLibvirtNetworkForward.j", YES);objj_executeFile("TNLibvirtNetworkIP.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtNetworkBase, "TNLibvirtNetwork"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_name"), new objj_ivar("_UUID"), new objj_ivar("_bandwidth"), new objj_ivar("_bridge"), new objj_ivar("_domain"), new objj_ivar("_forward"), new objj_ivar("_IP"), new objj_ivar("_active"), new objj_ivar("_autostart")]);objj_registerClassPair(the_class);
...
}p;35;Model/TNLibvirtNetworkIPDHCPRange.jt;2673;@STATIC;1.0;i;22;TNLibvirtNetworkBase.jt;2627;objj_executeFile("TNLibvirtNetworkBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtNetworkBase, "TNLibvirtNetworkIPDHCPRange"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_end"), new objj_ivar("_start")]);objj_registerClassPair(the_class);
...
}p;30;Model/TNLibvirtNetworkIPTFTP.jt;1954;@STATIC;1.0;i;22;TNLibvirtNetworkBase.jt;1908;objj_executeFile("TNLibvirtNetworkBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtNetworkBase, "TNLibvirtNetworkIPTFTP"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_root")]);objj_registerClassPair(the_class);
...
}p;31;Model/TNLibvirtNetworkForward.jt;4417;@STATIC;1.0;i;22;TNLibvirtNetworkBase.ji;34;TNLibvirtNetworkForwardInterface.jt;4332;objj_executeFile("TNLibvirtNetworkBase.j", YES);objj_executeFile("TNLibvirtNetworkForwardInterface.j", YES);TNLibvirtNetworkForwardModeNAT = "nat";
...
TNLibvirtNetworkForwardModes = [TNLibvirtNetworkForwardModeBridge, TNLibvirtNetworkForwardModePrivate, TNLibvirtNetworkForwardModeNAT, TNLibvirtNetworkForwardModeRoute, TNLibvirtNetworkForwardModeIsolated];
{var the_class = objj_allocateClassPair(TNLibvirtNetworkBase, "TNLibvirtNetworkForward"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_interfaces"), new objj_ivar("_dev"), new objj_ivar("_mode")]);objj_registerClassPair(the_class);
...
}p;40;Model/TNLibvirtNetworkBandwidthInbound.jt;3295;@STATIC;1.0;i;22;TNLibvirtNetworkBase.jt;3249;objj_executeFile("TNLibvirtNetworkBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtNetworkBase, "TNLibvirtNetworkBandwidthInbound"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_average"), new objj_ivar("_burst"), new objj_ivar("_peak")]);objj_registerClassPair(the_class);
...
}p;34;Model/TNLibvirtNetworkIPDHCPHost.jt;3258;@STATIC;1.0;i;22;TNLibvirtNetworkBase.jt;3212;objj_executeFile("TNLibvirtNetworkBase.j", YES);{var the_class = objj_allocateClassPair(TNLibvirtNetworkBase, "TNLibvirtNetworkIPDHCPHost"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_IP"), new objj_ivar("_mac"), new objj_ivar("_name")]);objj_registerClassPair(the_class);
