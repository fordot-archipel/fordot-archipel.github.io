@STATIC;1.0;p;32;TNGeneralWelcomeViewController.jt;3874;@STATIC;1.0;I;23;Foundation/Foundation.jI;20;AppKit/CPTextField.jI;18;AppKit/CPWebView.ji;22;../../Model/TNModule.jt;3752;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPWebView.j", NO);objj_executeFile("../../Model/TNModule.j", YES);{var the_class = objj_allocateClassPair(TNModule, "TNGeneralWelcomeViewController"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("mainWebView"), new objj_ivar("imageViewBrowser"), new objj_ivar("fieldLoading"), new objj_ivar("fieldPreferencesWelcomePageUrl")]);objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("awakeFromCib"), function $TNGeneralWelcomeViewController__awakeFromCib(self, _cmd)
{
    ...
    objj_msgSend(defaults, "registerDefaults:", objj_msgSend(objj_msgSend(CPDictionary, "alloc"), "initWithObjectsAndKeys:", objj_msgSend(bundle, "objectForInfoDictionaryKey:", "TNArchipelHelpWindowURL"), "TNArchipelHelpWindowURL"));
    objj_msgSend(self.imageViewBrowser, "setImage:", CPImageInBundle("browser.png", nil, bundle));
