@STATIC;1.0;p;26;TNVirtualMachineDataView.jt;9780;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/CPView.jI;20;AppKit/CPImageView.jI;20;AppKit/CPTextField.ji;29;../../Views/TNBasicDataView.jt;9629;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("../../Views/TNBasicDataView.j", YES);var TNVirtualMachineDataViewAvatarUnknown;
...
{
    TNVirtualMachineDataViewAvatarUnknown = CPImageInBundle("user-unknown.png", nil, objj_msgSend(CPBundle, "mainBundle"));
}
,["void"])]);
}p;34;TNVirtualMachineManageController.jt;4498;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/CPView.jI;17;AppKit/CPButton.jI;20;AppKit/CPTextField.jI;35;StropheCappuccino/TNStropheStanza.jt;4344;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("StropheCappuccino/TNStropheStanza.j", NO);var TNArchipelTypeHypervisorControl = "archipel:hypervisor:control",
...
,["id","id"]), new objj_method(sel_getUid("performManage:"), function $TNVirtualMachineManageController__performManage_(self, _cmd, someVirtualMachines)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorControlManage});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("performUnmanage:"), function $TNVirtualMachineManageController__performUnmanage_(self, _cmd, someVirtualMachines)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "set");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorControl});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorControlUnmanage});
    for (var i = 0; i < objj_msgSend(someVirtualMachines, "count"); i++)
    {
        var vm = objj_msgSend(someVirtualMachines, "objectAtIndex:", i);
        objj_msgSend(stanza, "addChildWithName:andAttributes:", "item", {"jid": objj_msgSend(vm, "JID")});
...
p;35;TNVirtualMachineParkingController.jt;15731;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/CPView.jI;17;AppKit/CPButton.jI;20;AppKit/CPTextField.jI;20;AppKit/CPTableView.jI;28;LPKit/LPMultiLineTextField.jI;29;StropheCappuccino/TNXMLNode.jI;35;StropheCappuccino/TNStropheStanza.jI;15;TNKit/TNAlert.jt;15464;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPTableView.j", NO);objj_executeFile("LPKit/LPMultiLineTextField.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("StropheCappuccino/TNStropheStanza.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);var TNArchipelTypeHypervisorParking = "archipel:hypervisor:vmparking",
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonDefine"), new objj_ivar("mainPopover"), new objj_ivar("fieldXMLString"), new objj_ivar("_currentItem"), new objj_ivar("_delegate")]);objj_registerClassPair(the_class);
...
,["void","CPArray"]), new objj_method(sel_getUid("listParkedVirtualMachines"), function $TNVirtualMachineParkingController__listParkedVirtualMachines(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorParkingList});
    objj_msgSend(self._delegate, "setModuleStatus:", TNArchipelModuleStatusWaiting);
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("parkVirtualMachines:"), function $TNVirtualMachineParkingController__parkVirtualMachines_(self, _cmd, someVirtualMachines)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "set");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorParking});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorParkingPark});
    for (var i = 0; i < objj_msgSend(someVirtualMachines, "count"); i++)
    {
        var vm = objj_msgSend(someVirtualMachines, "objectAtIndex:", i);
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("unparkVirtualMachines:start:"), function $TNVirtualMachineParkingController__unparkVirtualMachines_start_(self, _cmd, someVirtualMachines, shouldStart)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "set");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorParking});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorParkingUnpark});
    for (var i = 0; i < objj_msgSend(someVirtualMachines, "count"); i++)
    {
        var vm = objj_msgSend(someVirtualMachines, "objectAtIndex:", i);
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("updateCurrentItemXML:"), function $TNVirtualMachineParkingController__updateCurrentItemXML_(self, _cmd, aNewDefinition)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "set");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorParking});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorParkingUpdateXML, "identifier": objj_msgSend(self._currentItem, "UUID")});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("deleteParkedVirtualMachines:"), function $TNVirtualMachineParkingController__deleteParkedVirtualMachines_(self, _cmd, someVirtualMachines)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "set");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorParking});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorParkingDelete});
    for (var i = 0; i < objj_msgSend(someVirtualMachines, "count"); i++)
    {
        var vm = objj_msgSend(someVirtualMachines, "objectAtIndex:", i);
...
p;38;TNVirtualMachineAllocationController.jt;16131;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/CPView.jI;17;AppKit/CPButton.jI;20;AppKit/CPTextField.jI;20;AppKit/CPTableView.jI;19;AppKit/CPComboBox.jI;33;GrowlCappuccino/GrowlCappuccino.jI;35;StropheCappuccino/TNStropheStanza.jI;37;StropheCappuccino/TNStropheIMClient.jI;15;TNKit/TNAlert.jt;15827;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPTableView.j", NO);objj_executeFile("AppKit/CPComboBox.j", NO);objj_executeFile("GrowlCappuccino/GrowlCappuccino.j", NO);objj_executeFile("StropheCappuccino/TNStropheStanza.j", NO);objj_executeFile("StropheCappuccino/TNStropheIMClient.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);var TNArchipelTypeHypervisorControl = "archipel:hypervisor:control",
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonAlloc"), new objj_ivar("mainPopover"), new objj_ivar("fieldNewVMRequestedCategories"), new objj_ivar("fieldNewVMRequestedLocality"), new objj_ivar("fieldNewVMRequestedName"), new objj_ivar("fieldNewVMRequestedOrganization"), new objj_ivar("fieldNewVMRequestedOrganizationUnit"), new objj_ivar("fieldNewVMRequestedOwner"), new objj_ivar("_virtualMachine"), new objj_ivar("_delegate"), new objj_ivar("_fieldsNeedCompletion"), new objj_ivar("_fieldsDelegates")]);objj_registerClassPair(the_class);
...
,["void"]), new objj_method(sel_getUid("_didReceiveNewFieldDelegateRequest:"), function $TNVirtualMachineAllocationController___didReceiveNewFieldDelegateRequest_(self, _cmd, aNotification)
{
    ...
    if (!objj_msgSend(self._fieldsDelegates, "containsObject:", requester) && objj_msgSend(requester, "respondsToSelector:", sel_getUid("completionForField:value:")))
...
,["id","id"]), new objj_method(sel_getUid("alloc"), function $TNVirtualMachineAllocationController__alloc(self, _cmd)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "set");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorControl});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorControlAlloc, "name": objj_msgSend(self.fieldNewVMRequestedName, "stringValue"), "orgname": objj_msgSend(self.fieldNewVMRequestedOrganization, "stringValue"), "orgunit": objj_msgSend(self.fieldNewVMRequestedOrganizationUnit, "stringValue"), "locality": objj_msgSend(self.fieldNewVMRequestedLocality, "stringValue"), "userid": objj_msgSend(self.fieldNewVMRequestedOwner, "stringValue"), "categories": objj_msgSend(self.fieldNewVMRequestedCategories, "stringValue")});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("update"), function $TNVirtualMachineAllocationController__update(self, _cmd)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "set");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorControl});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorControlSetOrgInfo, "target": objj_msgSend(objj_msgSend(self._virtualMachine, "JID"), "node")});
...
,["void"]), new objj_method(sel_getUid("performDeleteVirtualMachine:"), function $TNVirtualMachineAllocationController__performDeleteVirtualMachine_(self, _cmd, someUserInfo)
{
    ...
    for (var i = 0; i < objj_msgSend(objects, "count"); i++)
    {
        ...
        objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorControl});
        objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"xmlns": TNArchipelTypeHypervisorControl, "action": TNArchipelTypeHypervisorControlFree, "jid": objj_msgSend(vm, "JID")});
...
p;33;TNVirtualMachineCloneController.jt;4947;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/CPView.jI;17;AppKit/CPButton.jI;20;AppKit/CPTableView.jI;20;AppKit/CPTextField.jI;33;GrowlCappuccino/GrowlCappuccino.jI;35;StropheCappuccino/TNStropheStanza.jt;4730;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPTableView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("GrowlCappuccino/GrowlCappuccino.j", NO);objj_executeFile("StropheCappuccino/TNStropheStanza.j", NO);var TNArchipelTypeHypervisorControl = "archipel:hypervisor:control",
    TNArchipelTypeHypervisorControlClone = "clone";
{var the_class = objj_allocateClassPair(CPObject, "TNVirtualMachineCloneController"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonClone"), new objj_ivar("mainPopover"), new objj_ivar("fieldCloneVirtualMachineName"), new objj_ivar("_delegate")]);objj_registerClassPair(the_class);
...
,["id","id"]), new objj_method(sel_getUid("cloneVirtualMachine"), function $TNVirtualMachineCloneController__cloneVirtualMachine(self, _cmd)
{
    ...
    {
        objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorControlClone, "jid": objj_msgSend(objj_msgSend(vm, "JID"), "bare"), "name": objj_msgSend(self.fieldCloneVirtualMachineName, "stringValue")});
    }
    else
    {
        objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorControlClone, "jid": objj_msgSend(objj_msgSend(vm, "JID"), "bare")});
    }
...
p;34;TNHypervisorVMCreationController.jt;53614;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;20;AppKit/CPButtonBar.jI;22;AppKit/CPPopUpButton.jI;22;AppKit/CPSearchField.jI;22;AppKit/CPTabViewItem.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.jI;17;AppKit/CPWindow.jI;15;TNKit/TNAlert.jI;29;TNKit/TNTableViewDataSource.ji;22;../../Model/TNModule.ji;38;TNVirtualMachineAllocationController.ji;33;TNVirtualMachineCloneController.ji;26;TNVirtualMachineDataView.ji;34;TNVirtualMachineManageController.ji;32;TNVirtualMachineParkedDataView.ji;35;TNVirtualMachineParkingController.ji;40;TNVirtualMachineSubscriptionController.jt;53017;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPButtonBar.j", NO);objj_executeFile("AppKit/CPPopUpButton.j", NO);objj_executeFile("AppKit/CPSearchField.j", NO);objj_executeFile("AppKit/CPTabViewItem.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPWindow.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);objj_executeFile("TNKit/TNTableViewDataSource.j", NO);objj_executeFile("../../Model/TNModule.j", YES);objj_executeFile("TNVirtualMachineAllocationController.j", YES);objj_executeFile("TNVirtualMachineCloneController.j", YES);objj_executeFile("TNVirtualMachineDataView.j", YES);objj_executeFile("TNVirtualMachineManageController.j", YES);objj_executeFile("TNVirtualMachineParkedDataView.j", YES);objj_executeFile("TNVirtualMachineParkingController.j", YES);objj_executeFile("TNVirtualMachineSubscriptionController.j", YES);var TNHypervisorVMCreationControllerLibvirtIcon = nil;
...
,["CPTableView"]), new objj_method(sel_getUid("awakeFromCib"), function $TNHypervisorVMCreationController__awakeFromCib(self, _cmd)
{
    ...
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForNewVM, CPBundleLocalizedString("Add a new Virtual Machine", "Add a new Virtual Machine"), self, sel_getUid("openNewVirtualMachineWindow:"), CPImageInBundle("IconsButtons/plus.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForRemove, CPBundleLocalizedString("Delete permanently", "Delete permanently"), self, sel_getUid("deleteVirtualMachine:"), CPImageInBundle("IconsButtons/minus.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForSubscribe, CPBundleLocalizedString("Add a subsription", "Add a subsription"), self, sel_getUid("openAddSubscriptionWindow:"), CPImageInBundle("IconsButtons/subscription-add.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForUnSubscribe, CPBundleLocalizedString("Remove a subsription", "Remove a subsription"), self, sel_getUid("openRemoveSubscriptionWindow:"), CPImageInBundle("IconsButtons/subscription-remove.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForClone, CPBundleLocalizedString("Clone", "Clone"), self, sel_getUid("openCloneVirtualMachineWindow:"), CPImageInBundle("IconsButtons/branch.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForUnmanage, CPBundleLocalizedString("Unmanage from Archipel", "Unmanage from Archipel"), self, sel_getUid("unmanageVirtualMachine:"), CPImageInBundle("IconsButtons/unmanage.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForPark, CPBundleLocalizedString("Add to the parking", "Add to the parking"), self, sel_getUid("parkVirtualMachines:"), CPImageInBundle("park.png", nil, objj_msgSend(CPBundle, "bundleForClass:", objj_msgSend(self, "class"))));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForJump, CPBundleLocalizedString("Jump to", "Jump to"), self, sel_getUid("addSelectedVMToRoster:"), CPImageInBundle("jump.png", nil, objj_msgSend(CPBundle, "bundleForClass:", objj_msgSend(self, "class"))));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForEditVcard, CPBundleLocalizedString("Edit Virtual Machine informations", "Edit Virtual Machine informations"), self, sel_getUid("openEditVirtualMachineWindow:"), CPImageInBundle("IconsButtons/edit.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemove), "setEnabled:", NO);
    objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForSubscribe), "setEnabled:", NO);
    objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForUnSubscribe), "setEnabled:", NO);
    objj_msgSend(self.buttonBarControl, "setButtons:", [objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForNewVM), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemove), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForClone), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForEditVcard), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForSubscribe), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForUnSubscribe), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForUnmanage), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForPark), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForJump)]);
    ...
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForManage, CPBundleLocalizedString("Manage with Archipel", "Manage with Archipel"), self, sel_getUid("manageVirtualMachine:"), CPImageInBundle("IconsButtons/manage.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self.buttonBarNotManagedVMControl, "setButtons:", [objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForManage)]);
    ...
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForUnpark, CPBundleLocalizedString("Unpark to current hypervisor", "Unpark to current hypervisor"), self, sel_getUid("unparkVirtualMachines:"), CPImageInBundle("unpark.png", nil, objj_msgSend(CPBundle, "bundleForClass:", objj_msgSend(self, "class"))));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForEditXML, CPBundleLocalizedString("Edit parked Virtual Machine XML definition", "Edit parked Virtual Machine XML definition"), self, sel_getUid("openParkedXMLEditor:"), CPImageInBundle("IconsButtons/editxml.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForRemoveparked, CPBundleLocalizedString("Delete permanently", "Delete permanently"), self, sel_getUid("deleteParkedVirtualMachines:"), CPImageInBundle("IconsButtons/minus.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self.buttonBarParkedVMControl, "setButtons:", [objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForUnpark), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForEditXML), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveparked)]);
    ...
    TNHypervisorVMCreationControllerLibvirtIcon = CPImageInBundle("libvirt-icon.png", nil, objj_msgSend(CPBundle, "bundleForClass:", objj_msgSend(self, "class")));
}
...
,["void"]), new objj_method(sel_getUid("setUIAccordingToPermissions"), function $TNHypervisorVMCreationController__setUIAccordingToPermissions(self, _cmd)
{
    ...
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForManage), "manage", tableNotManagedCondition);
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForUnmanage), "unmanage", tableManagedCondition);
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForPark), "vmparking_park", tableManagedCondition);
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForUnpark), "vmparking_unpark", tableParkedCondition);
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForEditXML), "vmparking_updatexml", tableParkedCondition);
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveparked), "vmparking_delete", tableParkedCondition);
    objj_msgSend(self, "setControl:enabledAccordingToPermission:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForNewVM), "alloc");
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForEditVcard), "alloc", tableManagedCondition);
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemove), "free", tableManagedCondition);
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForClone), "clone", tableManagedCondition);
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForSubscribe), "subscription_add", tableManagedCondition);
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForUnSubscribe), "subscription_remove", tableManagedCondition);
    objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForJump), "setEnabled:", objj_msgSend(self.tableVirtualMachines, "numberOfSelectedRows") == 1);
...
,["void","CPNotification"]), new objj_method(sel_getUid("tableViewSelectionDidChange:"), function $TNHypervisorVMCreationController__tableViewSelectionDidChange_(self, _cmd, aNotification)
{
    ...
    case self.tableVirtualMachines:
        var onlyOneItem = objj_msgSend(self.tableVirtualMachines, "numberOfSelectedRows") == 1,
            oneOrMoreItems = objj_msgSend(self.tableVirtualMachines, "numberOfSelectedRows") >= 1;
        objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForEditVcard), "alloc", onlyOneItem);
        objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemove), "free", oneOrMoreItems);
        objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForClone), "clone", onlyOneItem);
        objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForSubscribe), "subscription_add", onlyOneItem);
        objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForUnSubscribe), "subscription_remove", onlyOneItem);
        objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForUnmanage), "unmanage", oneOrMoreItems);
        objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForPark), "vmparking_park", oneOrMoreItems);
        objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForJump), "vmparking_park", onlyOneItem);
    case self.tableVirtualMachinesNotManaged:
        var notNull = objj_msgSend(self.tableVirtualMachinesNotManaged, "numberOfSelectedRows") > 0;
        objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForManage), "manage", notNull);
    case self.tableVirtualMachinesParked:
        var notNull = objj_msgSend(self.tableVirtualMachinesParked, "numberOfSelectedRows") > 0;
        objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForUnpark), "vmparking_unpark", notNull);
        objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForEditXML), "vmparking_updatexml", notNull);
        objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveparked), "vmparking_delete", notNull);
    }
}
,["void","CPNotification"]), new objj_method(sel_getUid("populateVirtualMachinesTable"), function $TNHypervisorVMCreationController__populateVirtualMachinesTable(self, _cmd)
{
    ...
    else
    {
        ...
        for (var i = 0; i < objj_msgSend(objj_msgSend(objj_msgSend(objj_msgSend(TNStropheIMClient, "defaultClient"), "roster"), "contacts"), "count"); i++)
        {
            ...
            if (objj_msgSend(objj_msgSend(objj_msgSend(TNStropheIMClient, "defaultClient"), "roster"), "analyseVCard:", objj_msgSend(contact, "vCard")) == TNArchipelEntityTypeVirtualMachine && objj_msgSend(objj_msgSend(contact, "resources"), "count") && objj_msgSend(objj_msgSend(contact, "resources"), "objectAtIndex:", 0) == objj_msgSend(objj_msgSend(self._entity, "JID"), "node"))
            {
...
,["id","id"]), new objj_method(sel_getUid("parkVirtualMachines:"), function $TNHypervisorVMCreationController__parkVirtualMachines_(self, _cmd, aSender)
{
    ...
    var vms = objj_msgSend(self._virtualMachinesDatasource, "objectsAtIndexes:", objj_msgSend(self.tableVirtualMachines, "selectedRowIndexes")),
        alert = objj_msgSend(TNAlert, "alertWithMessage:informative:target:actions:", titleMessage, informativeMessage, self.VMParkingController, [[CPLocalizedString("Park", "Park"), sel_getUid("parkVirtualMachines:")], [CPBundleLocalizedString("Cancel", "Cancel"), nil]]);
...
,["id","id"]), new objj_method(sel_getUid("unparkVirtualMachines:"), function $TNHypervisorVMCreationController__unparkVirtualMachines_(self, _cmd, aSender)
{
    ...
    var vms = objj_msgSend(self._virtualMachinesParkedDatasource, "objectsAtIndexes:", objj_msgSend(self.tableVirtualMachinesParked, "selectedRowIndexes")),
        alert = objj_msgSend(TNAlert, "alertWithMessage:informative:target:actions:", titleMessage, informativeMessage, self.VMParkingController, [[CPLocalizedString("Unpark", "Unpark"), sel_getUid("unparkVirtualMachines:")], [CPLocalizedString("Unpark and start", "Unpark and start"), sel_getUid("unparkAndStartVirtualMachines:")], [CPBundleLocalizedString("Cancel", "Cancel"), nil]]);
    objj_msgSend(alert, "setUserInfo:", vms);
    objj_msgSend(alert, "runModal");
}
,["id","id"]), new objj_method(sel_getUid("openParkedXMLEditor:"), function $TNHypervisorVMCreationController__openParkedXMLEditor_(self, _cmd, aSender)
{
    ...
    objj_msgSend(self.VMParkingController, "openWindow:", objj_msgSend(aSender, "isKindOfClass:", CPMenuItem) ? self.tableVirtualMachinesParked : aSender);
}
...
,["id","id"]), new objj_method(sel_getUid("openCloneVirtualMachineWindow:"), function $TNHypervisorVMCreationController__openCloneVirtualMachineWindow_(self, _cmd, aSender)
{
    ...
    if (!objj_msgSend(self, "isVisible"))
        return;
    objj_msgSend(self.VMCloneController, "openWindow:", objj_msgSend(aSender, "isKindOfClass:", CPMenuItem) ? self.tableVirtualMachines : aSender);
}
,["id","id"]), new objj_method(sel_getUid("openNewVirtualMachineWindow:"), function $TNHypervisorVMCreationController__openNewVirtualMachineWindow_(self, _cmd, aSender)
{
    ...
    if (objj_msgSend(self, "isVisible"))
    {
        ...
        objj_msgSend(self.VMAllocationController, "openWindow:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForNewVM));
    }
}
...
{
    if (!objj_msgSend(objj_msgSend(self._virtualMachinesDatasource, "objectAtIndex:", objj_msgSend(self.tableVirtualMachines, "selectedRow")), "vCard"))
    {
        objj_msgSend(self, "addSelectedVMToRoster:", aSender);
        return;
    }
    objj_msgSend(self, "requestVisible");
    if (objj_msgSend(self, "isVisible"))
    {
        ...
        objj_msgSend(self.VMAllocationController, "openWindow:", objj_msgSend(aSender, "isKindOfClass:", CPMenuItem) ? self.tableVirtualMachines : aSender);
    }
}
,["id","id"]), new objj_method(sel_getUid("openAddSubscriptionWindow:"), function $TNHypervisorVMCreationController__openAddSubscriptionWindow_(self, _cmd, aSender)
{
    ...
    if (!objj_msgSend(self, "isVisible"))
        return;
    objj_msgSend(self.VMSubscriptionController, "openAddSubsctiptionWindow:", objj_msgSend(aSender, "isKindOfClass:", CPMenuItem) ? self.tableVirtualMachines : aSender);
}
,["id","id"]), new objj_method(sel_getUid("openRemoveSubscriptionWindow:"), function $TNHypervisorVMCreationController__openRemoveSubscriptionWindow_(self, _cmd, aSender)
{
    ...
    if (!objj_msgSend(self, "isVisible"))
        return;
    objj_msgSend(self.VMSubscriptionController, "openRemoveSubscriptionWindow:", objj_msgSend(aSender, "isKindOfClass:", CPMenuItem) ? self.tableVirtualMachines : aSender);
}
...
,["void","id"]), new objj_method(sel_getUid("getHypervisorRoster"), function $TNHypervisorVMCreationController__getHypervisorRoster(self, _cmd)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "get");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorControl});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorControlRosterVM});
...
,["void","CPTabView","CPTabViewItem"]), new objj_method(sel_getUid("tableView:menuForTableColumn:row:"), function $TNHypervisorVMCreationController__tableView_menuForTableColumn_row_(self, _cmd, aTableView, aColumn, aRow)
{
    ...
    {
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForNewVM));
    ...
    case self.tableVirtualMachines:
        if (objj_msgSend(objj_msgSend(self._virtualMachinesDatasource, "objectAtIndex:", objj_msgSend(self.tableVirtualMachines, "selectedRow")), "vCard"))
        {
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForJump));
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForClone));
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForEditVcard));
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(CPMenuItem, "separatorItem"));
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForSubscribe));
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForUnSubscribe));
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(CPMenuItem, "separatorItem"));
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForUnmanage));
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForPark));
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForRemove));
        }
        else
        {
            objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForJump));
        ...
        break;
    case self.tableVirtualMachinesNotManaged:
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForManage));
        break;
    case self.tableVirtualMachinesParked:
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForUnpark));
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForEditXML));
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForRemoveparked));
        break;
default:
        return;
    }
...
,["CPMenu","CPTableView","CPTableColumn","int"]), new objj_method(sel_getUid("tableViewDeleteKeyPressed:"), function $TNHypervisorVMCreationController__tableViewDeleteKeyPressed_(self, _cmd, aTableView)
{
    if (objj_msgSend(aTableView, "numberOfSelectedRows") == 0)
        return;
    switch(aTableView) {
    case self.tableVirtualMachines:
        objj_msgSend(self, "deleteVirtualMachine:", aTableView);
        break;
    case self.tableVirtualMachinesParked:
        objj_msgSend(self, "deleteParkedVirtualMachines:", aTableView);
        break;
default:
        return;
    }
...
p;40;TNVirtualMachineSubscriptionController.jt;10007;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/CPView.jI;17;AppKit/CPButton.jI;20;AppKit/CPTableView.jI;20;AppKit/CPTextField.jI;18;AppKit/CPPopover.jI;28;LPKit/LPMultiLineTextField.jI;35;StropheCappuccino/TNStropheStanza.jI;33;GrowlCappuccino/GrowlCappuccino.jI;15;TNKit/TNAlert.jt;9714;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPTableView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPPopover.j", NO);objj_executeFile("LPKit/LPMultiLineTextField.j", NO);objj_executeFile("StropheCappuccino/TNStropheStanza.j", NO);objj_executeFile("GrowlCappuccino/GrowlCappuccino.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);var TNArchipelTypeSubscription = "archipel:subscription",
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonAddSubscription"), new objj_ivar("buttonRemoveSubscription"), new objj_ivar("popoverAddSubscription"), new objj_ivar("popoverRemoveSubscription"), new objj_ivar("fieldNewSubscriptionTarget"), new objj_ivar("fieldRemoveSubscriptionTarget"), new objj_ivar("_delegate")]);objj_registerClassPair(the_class);
...
,["void","id"]), new objj_method(sel_getUid("openAddSubsctiptionWindow:"), function $TNVirtualMachineSubscriptionController__openAddSubsctiptionWindow_(self, _cmd, aSender)
{
    ...
    if (objj_msgSend(aSender, "isKindOfClass:", CPTableView))
    {
        ...
        rect.origin.y += rect.size.height / 2;
        rect.origin.x += rect.size.width / 2;
        objj_msgSend(self.popoverAddSubscription, "showRelativeToRect:ofView:preferredEdge:", CGRectMake(rect.origin.x, rect.origin.y, 10, 10), aSender, nil);
    }
    else
...
,["id","id"]), new objj_method(sel_getUid("openRemoveSubscriptionWindow:"), function $TNVirtualMachineSubscriptionController__openRemoveSubscriptionWindow_(self, _cmd, aSender)
{
    ...
    if (objj_msgSend(aSender, "isKindOfClass:", CPTableView))
    {
        ...
        rect.origin.y += rect.size.height / 2;
        rect.origin.x += rect.size.width / 2;
        objj_msgSend(self.popoverRemoveSubscription, "showRelativeToRect:ofView:preferredEdge:", CGRectMake(rect.origin.x, rect.origin.y, 10, 10), aSender, nil);
    }
    else
...
,["id","id"]), new objj_method(sel_getUid("addSubscription"), function $TNVirtualMachineSubscriptionController__addSubscription(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeSubscriptionAdd, "jid": objj_msgSend(self.fieldNewSubscriptionTarget, "stringValue")});
...
,["id"]), new objj_method(sel_getUid("performRemoveSubscription:"), function $TNVirtualMachineSubscriptionController__performRemoveSubscription_(self, _cmd, aVirtualMachine)
{
    ...
    objj_msgSend(self.popoverRemoveSubscription, "close");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeSubscription});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeSubscriptionRemove, "jid": objj_msgSend(self.fieldRemoveSubscriptionTarget, "stringValue")});
...
p;32;TNVirtualMachineParkedDataView.jt;2895;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/CPView.jI;20;AppKit/CPImageView.jI;20;AppKit/CPTextField.ji;29;../../Views/TNBasicDataView.jt;2744;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("../../Views/TNBasicDataView.j", YES);{var the_class = objj_allocateClassPair(TNBasicDataView, "TNVirtualMachineParkedDataView"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("fieldUUID"), new objj_ivar("fieldName"), new objj_ivar("fieldDate"), new objj_ivar("fieldParker"), new objj_ivar("labelParker"), new objj_ivar("labelDate")]);objj_registerClassPair(the_class);
