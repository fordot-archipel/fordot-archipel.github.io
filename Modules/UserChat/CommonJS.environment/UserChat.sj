@STATIC;1.0;p;22;TNUserChatController.jt;16219;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;20;AppKit/CPImageView.jI;16;AppKit/CPSound.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.jI;22;TNKit/TNMessageBoard.ji;22;../../Model/TNModule.ji;26;TNDetachedChatController.jt;15973;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("AppKit/CPSound.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("TNKit/TNMessageBoard.j", NO);objj_executeFile("../../Model/TNModule.j", YES);objj_executeFile("TNDetachedChatController.j", YES);{var the_class = objj_allocateClassPair(TNModule, "TNUserChatController"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonClear"), new objj_ivar("buttonDetach"), new objj_ivar("imageSpinnerWriting"), new objj_ivar("fieldMessage"), new objj_ivar("fieldPreferencesMaxChatMessage"), new objj_ivar("viewControls"), new objj_ivar("messagesScrollView"), new objj_ivar("_messages"), new objj_ivar("_detachedChats"), new objj_ivar("_soundMessage"), new objj_ivar("_soundReceived"), new objj_ivar("_soundSent"), new objj_ivar("_composingMessageTimer"), new objj_ivar("_messageBoard")]);objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("awakeFromCib"), function $TNUserChatController__awakeFromCib(self, _cmd)
{
    ...
    objj_msgSend(defaults, "registerDefaults:", objj_msgSend(objj_msgSend(CPDictionary, "alloc"), "initWithObjectsAndKeys:", objj_msgSend(bundle, "objectForInfoDictionaryKey:", "TNUserChatMaxMessageStore"), "TNUserChatMaxMessageStore", objj_msgSend(CPDictionary, "dictionary"), "TNUserChatMessageStore"));
    ...
    objj_msgSend(self.imageSpinnerWriting, "setImage:", CPImageInBundle("spinner.gif", nil, mainBundle));
...
,["void","CPTimer"]), new objj_method(sel_getUid("appendMessageToBoard:from:"), function $TNUserChatController__appendMessageToBoard_from_(self, _cmd, aMessage, aSender)
{
    var color = aSender == "me" ? TNMessageViewBubbleColorNormal : TNMessageViewBubbleColorAlt,
        ...
        newMessageDict = objj_msgSend(objj_msgSend(CPDictionary, "alloc"), "initWithObjectsAndKeys:", aSender, "name", aMessage, "message", color, "color", date, "date"),
...
p;26;TNDetachedChatController.jt;13294;@STATIC;1.0;I;23;Foundation/Foundation.jI;20;AppKit/CPImageView.jI;25;AppKit/CPPlatformWindow.jI;21;AppKit/CPScrollView.jI;16;AppKit/CPSound.jI;20;AppKit/CPTextField.jI;17;AppKit/CPWindow.jI;37;StropheCappuccino/TNStropheIMClient.jI;22;TNKit/TNMessageBoard.jt;13028;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("AppKit/CPPlatformWindow.j", NO);objj_executeFile("AppKit/CPScrollView.j", NO);objj_executeFile("AppKit/CPSound.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPWindow.j", NO);objj_executeFile("StropheCappuccino/TNStropheIMClient.j", NO);objj_executeFile("TNKit/TNMessageBoard.j", NO);if (objj_msgSend(CPPlatform, "isBrowser"))
