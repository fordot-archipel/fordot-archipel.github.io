@STATIC;1.0;p;21;TNMapViewController.jt;17120;@STATIC;1.0;I;23;Foundation/Foundation.jI;22;AppKit/CPSearchField.jI;20;AppKit/CPSplitView.jI;20;AppKit/CPTableView.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.jI;15;TNKit/TNAlert.jI;37;StropheCappuccino/TNStropheIMClient.ji;22;../../Model/TNModule.ji;18;MapKit/MKMapView.ji;31;TNDragDropTableViewDataSource.jt;16802;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPSearchField.j", NO);objj_executeFile("AppKit/CPSplitView.j", NO);objj_executeFile("AppKit/CPTableView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);objj_executeFile("StropheCappuccino/TNStropheIMClient.j", NO);objj_executeFile("../../Model/TNModule.j", YES);objj_executeFile("MapKit/MKMapView.j", YES);objj_executeFile("TNDragDropTableViewDataSource.j", YES);var TNArchipelTypeHypervisorControl = "archipel:hypervisor:control",
...
class_addMethods(the_class, [new objj_method(sel_getUid("awakeFromCib"), function $TNMapViewController__awakeFromCib(self, _cmd)
{
    ...
    objj_msgSend(self.viewOrigin, "setBackgroundColor:", gradBGColor);
    objj_msgSend(self.viewDestination, "setBackgroundColor:", gradBGColor);
...
,["void","id"]), new objj_method(sel_getUid("locationOfHypervisor:"), function $TNMapViewController__locationOfHypervisor_(self, _cmd, anHypervisor)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorGeolocalizationGet});
...
,["void","TNStropheContact"]), new objj_method(sel_getUid("_didReceivedGeolocalization:"), function $TNMapViewController___didReceivedGeolocalization_(self, _cmd, aStanza)
{
    if (objj_msgSend(aStanza, "type") == "result")
    {
        try        {
            ...
            objj_msgSend(marker, "setUserInfo:", objj_msgSend(objj_msgSend(CPDictionary, "alloc"), "initWithObjectsAndKeys:", item, "rosterItem"));
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("migrate:toHypervisor:"), function $TNMapViewController__migrate_toHypervisor_(self, _cmd, aVirualMachine, aHypervisor)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineControlMigrate, "hypervisorjid": objj_msgSend(aHypervisor, "fullJID")});
...
p;31;TNDragDropTableViewDataSource.jt;2231;@STATIC;1.0;I;23;Foundation/Foundation.jI;20;AppKit/CPTableView.jI;29;TNKit/TNTableViewDataSource.jt;2125;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPTableView.j", NO);objj_executeFile("TNKit/TNTableViewDataSource.j", NO);var TNDragTypeMigration = "TNDragTypeMigration";
{var the_class = objj_allocateClassPair(TNTableViewDataSource, "TNDragDropTableViewDataSource"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_draggedItem")]);objj_registerClassPair(the_class);
...
}p;18;MapKit/MKMapItem.jt;409;@STATIC;1.0;I;23;Foundation/Foundation.jt;363;objj_executeFile("Foundation/Foundation.j", NO);{var the_class = objj_allocateClassPair(CPObject, "MKMapItem"),
...
,["String"])]);
}p;18;MapKit/MKPolygon.jt;4457;@STATIC;1.0;I;15;AppKit/CPView.ji;11;MKMapItem.ji;11;MKMapView.ji;12;MKLocation.jt;4369;objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("MKMapItem.j", YES);objj_executeFile("MKMapView.j", YES);objj_executeFile("MKLocation.j", YES);{var the_class = objj_allocateClassPair(MKMapItem, "MKPolygon"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_locations"), new objj_ivar("_lineColorCode"), new objj_ivar("_lineStroke"), new objj_ivar("_fillColorCode"), new objj_ivar("_fillOpacity"), new objj_ivar("_lineOpacity")]);objj_registerClassPair(the_class);
...
,["MKPolygon"])]);
}p;18;MapKit/MKMapView.jt;7378;@STATIC;1.0;I;18;AppKit/CPWebView.ji;12;MKLocation.ji;12;MKMapScene.ji;10;MKMarker.ji;12;MKPolyline.jt;7270;objj_executeFile("AppKit/CPWebView.j", NO);objj_executeFile("MKLocation.j", YES);objj_executeFile("MKMapScene.j", YES);objj_executeFile("MKMarker.j", YES);objj_executeFile("MKPolyline.j", YES);var gmNamespace = nil;
{var the_class = objj_allocateClassPair(CPWebView, "MKMapView"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_delegate"), new objj_ivar("_gMap"), new objj_ivar("_scene"), new objj_ivar("_googleAjaxLoaded"), new objj_ivar("_hasLoaded"), new objj_ivar("_mapReady"), new objj_ivar("_apiKey"), new objj_ivar("_DOMMapElement")]);objj_registerClassPair(the_class);
...
,["void","CPWebView","id"]), new objj_method(sel_getUid("loadGoogleMapsWhenReady"), function $MKMapView__loadGoogleMapsWhenReady(self, _cmd)
{
    ...
    {
        domWin.window.setTimeout(function()
        {
            objj_msgSend(self, "loadGoogleMapsWhenReady");
        }, 100);
    }
...
,["void"]), new objj_method(sel_getUid("createMap"), function $MKMapView__createMap(self, _cmd)
{
    ...
    localGmNamespace.Event.addDomListener(document.body, 'mouseup', function()
    {
        try        {
            localGmNamespace.Event.trigger(domWin, 'mouseup');
        }
        catch(e)         {
        }    });
    self._mapReady = YES;
...
,["JSObject"])]);
}p;19;MapKit/MKPolyline.jt;3227;@STATIC;1.0;I;15;AppKit/CPView.ji;11;MKMapItem.ji;12;MKLocation.jt;3155;objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("MKMapItem.j", YES);objj_executeFile("MKLocation.j", YES);{var the_class = objj_allocateClassPair(MKMapItem, "MKPolyline"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_locations"), new objj_ivar("_colorCode"), new objj_ivar("_lineStroke")]);objj_registerClassPair(the_class);
...
,["MKPolyline"])]);
}p;19;MapKit/MKMapScene.jt;4729;@STATIC;1.0;I;23;Foundation/Foundation.jt;4682;objj_executeFile("Foundation/Foundation.j", NO);{var the_class = objj_allocateClassPair(CPObject, "MKMapScene"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_mapView"), new objj_ivar("_mapItems"), new objj_ivar("_readConnection")]);objj_registerClassPair(the_class);
...
{
    return CPJSObjectCreateJSON({mapItems: objj_msgSend(self, "mapItemsAsJSObject")});
}
...
,["void","CPURLConnection"]), new objj_method(sel_getUid("mapItemsAsJSObject"), function $MKMapScene__mapItemsAsJSObject(self, _cmd)
{
    ...
    {
        items.push({'class': objj_msgSend(item, "typeName"), 'anchor': [objj_msgSend(item, "location").lng(), objj_msgSend(item, "location").lat()]});
    }
    return items;
}
...
,["void","MKMapItem"])]);
}p;17;MapKit/MKMarker.jt;9268;@STATIC;1.0;I;15;AppKit/CPView.ji;11;MKMapItem.ji;12;MKLocation.jt;9196;objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("MKMapItem.j", YES);objj_executeFile("MKLocation.j", YES);{var the_class = objj_allocateClassPair(MKMapItem, "MKMarker"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_clickable"), new objj_ivar("_draggable"), new objj_ivar("_withShadow"), new objj_ivar("_iconUrl"), new objj_ivar("_shadowUrl"), new objj_ivar("_delegate"), new objj_ivar("_userInfo"), new objj_ivar("_gMarker"), new objj_ivar("_location"), new objj_ivar("_infoWindowHTML"), new objj_ivar("_eventHandlers")]);objj_registerClassPair(the_class);
...
,["void","CPString"]), new objj_method(sel_getUid("setInfoWindowHTML:openOnClick:"), function $MKMarker__setInfoWindowHTML_openOnClick_(self, _cmd, someHTML, shouldOpenOnClick)
{
    ...
    if (shouldOpenOnClick)
    {
        objj_msgSend(self, "addEventForName:withFunction:", "click", function()
        {
            objj_msgSend(self, "openInfoWindow");
        });
    }
}
...
,["void","CPString","JSObject"]), new objj_method(sel_getUid("addToMapView:"), function $MKMarker__addToMapView_(self, _cmd, mapView)
{
    ...
    gm.Event.addListener(self._gMarker, 'dragend', function()
    {
        objj_msgSend(self, "updateLocation");
    });
...
,["MKMarker"])]);
}p;19;MapKit/MKLocation.jt;2451;@STATIC;1.0;I;21;Foundation/CPObject.jt;2406;objj_executeFile("Foundation/CPObject.j", NO);{var the_class = objj_allocateClassPair(CPObject, "MKLocation"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_latitude"), new objj_ivar("_longitude")]);objj_registerClassPair(the_class);
