@STATIC;1.0;p;12;TNSnapshot.jt;3390;@STATIC;1.0;I;23;Foundation/Foundation.jI;16;AppKit/CPImage.jt;3322;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPImage.j", NO);{var the_class = objj_allocateClassPair(CPObject, "TNSnapshot"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_isCurrent"), new objj_ivar("_creationTime"), new objj_ivar("_description"), new objj_ivar("_domain"), new objj_ivar("_name"), new objj_ivar("_parent"), new objj_ivar("_state"), new objj_ivar("_UUID"), new objj_ivar("_currentIcon")]);objj_registerClassPair(the_class);
...
,["void","CPString"]), new objj_method(sel_getUid("init"), function $TNSnapshot__init(self, _cmd)
{
    ...
    {
        self._currentIcon = CPImageInBundle("IconsButtons/check.png", CGSizeMake(16, 16), objj_msgSend(CPBundle, "mainBundle"));
    }
    return self;
}
...
,["CPImage"])]);
}p;37;TNVirtualMachineSnapshotsController.jt;29872;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;20;AppKit/CPButtonBar.jI;22;AppKit/CPSearchField.jI;20;AppKit/CPTextField.jI;22;AppKit/CPOutlineView.jI;17;AppKit/CPWindow.jI;28;LPKit/LPMultiLineTextField.jI;15;TNKit/TNAlert.ji;22;../../Model/TNModule.ji;12;TNSnapshot.ji;23;TNSnapshotsDatasource.jt;29551;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPButtonBar.j", NO);objj_executeFile("AppKit/CPSearchField.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPOutlineView.j", NO);objj_executeFile("AppKit/CPWindow.j", NO);objj_executeFile("LPKit/LPMultiLineTextField.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);objj_executeFile("../../Model/TNModule.j", YES);objj_executeFile("TNSnapshot.j", YES);objj_executeFile("TNSnapshotsDatasource.j", YES);var TNArchipelSnapshotsOpenedSnapshots = "TNArchipelSnapshotsOpenedSnapshots_",
...
class_addMethods(the_class, [new objj_method(sel_getUid("awakeFromCib"), function $TNVirtualMachineSnapshotsController__awakeFromCib(self, _cmd)
{
    ...
    objj_msgSend(self._outlineViewSnapshots, "setTarget:", self);
    objj_msgSend(self._outlineViewSnapshots, "setDoubleAction:", sel_getUid("revertSnapshot:"));
    ...
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForTakeSnapshot, CPBundleLocalizedString("Create a new snapshot", "Create a new snapshot"), self, sel_getUid("openWindowNewSnapshot:"), CPImageInBundle("IconsButtons/photo-add.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForRemoveSnapshot, CPBundleLocalizedString("Remove selected snapshot", "Remove selected snapshot"), self, sel_getUid("deleteSnapshot:"), CPImageInBundle("IconsButtons/photo-remove.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForRevertToSnapshot, CPBundleLocalizedString("Revert state to selected snapshot", "Revert state to selected snapshot"), self, sel_getUid("revertSnapshot:"), CPImageInBundle("IconsButtons/subscription-add.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self.buttonBarControl, "setButtons:", [objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForTakeSnapshot), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveSnapshot), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRevertToSnapshot)]);
}
...
,["BOOL"]), new objj_method(sel_getUid("willUnload"), function $TNVirtualMachineSnapshotsController__willUnload(self, _cmd)
{
    ...
    objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRevertToSnapshot), "setEnabled:", NO);
    objj_msgSend(objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveSnapshot), "setEnabled:", NO);
...
{
    objj_msgSend(self, "setControl:enabledAccordingToPermission:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForTakeSnapshot), "snapshot_take");
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveSnapshot), "snapshot_delete", objj_msgSend(self._outlineViewSnapshots, "numberOfSelectedRows") > 0);
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRevertToSnapshot), "snapshot_revert", objj_msgSend(self._outlineViewSnapshots, "numberOfSelectedRows") > 0);
...
,["BOOL","CPDictionary"]), new objj_method(sel_getUid("fieldFilterDidChange:"), function $TNVirtualMachineSnapshotsController__fieldFilterDidChange_(self, _cmd, aSender)
{
    objj_msgSend(self._datasourceSnapshots, "setFilter:", objj_msgSend(self.fieldFilter, "stringValue"));
    objj_msgSend(self._outlineViewSnapshots, "reloadData");
    objj_msgSend(self._outlineViewSnapshots, "recoverExpandedWithBaseKey:itemKeyPath:", TNArchipelSnapshotsOpenedSnapshots, "name");
}
,["id","id"]), new objj_method(sel_getUid("openWindowNewSnapshot:"), function $TNVirtualMachineSnapshotsController__openWindowNewSnapshot_(self, _cmd, aSender)
{
    ...
    objj_msgSend(self.popoverNewSnapshot, "close");
    objj_msgSend(self.popoverNewSnapshot, "showRelativeToRect:ofView:preferredEdge:", nil, objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForTakeSnapshot), nil);
...
,["id","id"]), new objj_method(sel_getUid("getSnapshots"), function $TNVirtualMachineSnapshotsController__getSnapshots(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorSnapshotGet});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("getCurrentSnapshot"), function $TNVirtualMachineSnapshotsController__getCurrentSnapshot(self, _cmd)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "get");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorSnapshot});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorSnapshotCurrent});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("takeSnapshot"), function $TNVirtualMachineSnapshotsController__takeSnapshot(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorSnapshot});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorSnapshotTake});
...
,["void"]), new objj_method(sel_getUid("performDeleteSnapshot:"), function $TNVirtualMachineSnapshotsController__performDeleteSnapshot_(self, _cmd, someUserInfo)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorSnapshot});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorSnapshotDelete, "name": name});
...
,["void"]), new objj_method(sel_getUid("performRevertSnapshot:"), function $TNVirtualMachineSnapshotsController__performRevertSnapshot_(self, _cmd, someUserInfo)
{
    ...
    var object = objj_msgSend(self._outlineViewSnapshots, "itemAtRow:", objj_msgSend(selectedIndexes, "firstIndex")),
        name = objj_msgSend(object, "name");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeHypervisorSnapshot});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeHypervisorSnapshotRevert, "name": name});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("outlineViewSelectionDidChange:"), function $TNVirtualMachineSnapshotsController__outlineViewSelectionDidChange_(self, _cmd, aNotification)
{
    ...
    if (objj_msgSend(self._outlineViewSnapshots, "numberOfSelectedRows") > 0)
    {
        objj_msgSend(self, "setControl:enabledAccordingToPermission:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveSnapshot), "snapshot_delete");
        objj_msgSend(self, "setControl:enabledAccordingToPermission:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRevertToSnapshot), "snapshot_revert");
    }
}
...
,["void","CPNotification"]), new objj_method(sel_getUid("outlineView:menuForTableColumn:item:"), function $TNVirtualMachineSnapshotsController__outlineView_menuForTableColumn_item_(self, _cmd, anOutlineView, aTableColumn, anItem)
{
    if (anOutlineView != self._outlineViewSnapshots && objj_msgSend(anOutlineView, "numberOfSelectedRows") > 1)
        return;
    objj_msgSend(self._contextualMenu, "removeAllItems");
    var itemRow = objj_msgSend(anOutlineView, "rowForItem:", anItem);
    if (objj_msgSend(anOutlineView, "selectedRow") != itemRow)
        objj_msgSend(anOutlineView, "selectRowIndexes:byExtendingSelection:", objj_msgSend(CPIndexSet, "indexSetWithIndex:", itemRow), NO);
    if (objj_msgSend(anOutlineView, "numberOfSelectedRows") == 0)
    {
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForTakeSnapshot));
    }
    else
    {
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForRemoveSnapshot));
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForRevertToSnapshot));
    }
    return self._contextualMenu;
}
,["CPMenu","CPOutlineView","CPTableColumn","int"]), new objj_method(sel_getUid("outlineViewDeleteKeyPressed:"), function $TNVirtualMachineSnapshotsController__outlineViewDeleteKeyPressed_(self, _cmd, anOutlineView)
{
    if (objj_msgSend(anOutlineView, "numberOfSelectedRows") == 0)
        return;
    objj_msgSend(self, "deleteSnapshot:", anOutlineView);
}
,["void","CPOutlineView"])]);
...
p;23;TNSnapshotsDatasource.jt;7092;@STATIC;1.0;I;23;Foundation/Foundation.jt;7045;objj_executeFile("Foundation/Foundation.j", NO);{var the_class = objj_allocateClassPair(CPObject, "TNSnapshotsDatasource"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_contents"), new objj_ivar("_childCompKeyPath"), new objj_ivar("_parentKeyPath"), new objj_ivar("_filter")]);objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("contents"), function $TNSnapshotsDatasource__contents(self, _cmd)
{
...
,["void","CPString"]), new objj_method(sel_getUid("filter"), function $TNSnapshotsDatasource__filter(self, _cmd)
{
    return self._filter;
}
,["CPString"]), new objj_method(sel_getUid("setFilter:"), function $TNSnapshotsDatasource__setFilter_(self, _cmd, newValue)
{
...
,["CPArray","id"]), new objj_method(sel_getUid("_getEntriesMatching"), function $TNSnapshotsDatasource___getEntriesMatching(self, _cmd)
{
    var filteredEntries = objj_msgSend(CPArray, "array");
    for (var i = 0; i < objj_msgSend(self._contents, "count"); i++)
    {
        var entry = objj_msgSend(self._contents, "objectAtIndex:", i);
        if (objj_msgSend(objj_msgSend(entry, "description"), "uppercaseString").indexOf(objj_msgSend(self._filter, "uppercaseString")) != -1 || objj_msgSend(objj_msgSend(entry, "creationTime"), "uppercaseString").indexOf(objj_msgSend(self._filter, "uppercaseString")) != -1)
        {
...
,["CPArray"]), new objj_method(sel_getUid("addObject:"), function $TNSnapshotsDatasource__addObject_(self, _cmd, anObject)
{
