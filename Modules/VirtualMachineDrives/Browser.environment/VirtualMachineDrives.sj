@STATIC;1.0;p;23;TNEditDriveController.jt;8288;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;22;AppKit/CPPopUpButton.jI;20;AppKit/CPTableView.jI;20;AppKit/CPTextField.jI;17;AppKit/CPWindow.jI;31;GrowlCappuccino/TNGrowlCenter.jI;35;StropheCappuccino/TNStropheStanza.jI;15;TNKit/TNAlert.ji;15;TNDriveObject.jt;8004;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPPopUpButton.j", NO);objj_executeFile("AppKit/CPTableView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPWindow.j", NO);objj_executeFile("GrowlCappuccino/TNGrowlCenter.j", NO);objj_executeFile("StropheCappuccino/TNStropheStanza.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);objj_executeFile("TNDriveObject.j", YES);var TNArchipelTypeVirtualMachineDisk = "archipel:vm:disk",
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonConvert"), new objj_ivar("buttonOK"), new objj_ivar("mainPopover"), new objj_ivar("buttonEditDiskFormat"), new objj_ivar("fieldEditDiskName"), new objj_ivar("_delegate"), new objj_ivar("_currentEditedDisk")]);objj_registerClassPair(the_class);
...
,["id","id"]), new objj_method(sel_getUid("convert"), function $TNEditDriveController__convert(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeVirtualMachineDiskConvert, "path": objj_msgSend(self._currentEditedDisk, "path"), "format": objj_msgSend(self.buttonEditDiskFormat, "title")});
...
,["BOOL","TNStropheStanza"]), new objj_method(sel_getUid("rename"), function $TNEditDriveController__rename(self, _cmd)
{
    ...
    if (objj_msgSend(self.fieldEditDiskName, "stringValue") != objj_msgSend(self._currentEditedDisk, "name"))
    {
        ...
        var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "set");
        objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeVirtualMachineDisk});
        objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"xmlns": TNArchipelTypeVirtualMachineDisk, "action": TNArchipelTypeVirtualMachineDiskRename, "path": objj_msgSend(self._currentEditedDisk, "path"), "newname": objj_msgSend(self._currentEditedDisk, "name")});
...
p;17;TNDriveDataView.jt;5440;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/CPView.jI;20;AppKit/CPImageView.jI;20;AppKit/CPTextField.ji;29;../../Views/TNBasicDataView.jt;5289;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("../../Views/TNBasicDataView.j", YES);var TNDriveDataViewIconQCOW2,
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("imageDriveIcon"), new objj_ivar("fieldDriveName"), new objj_ivar("fieldGoldenDrive"), new objj_ivar("fieldPath"), new objj_ivar("fieldRealSize"), new objj_ivar("fieldVirtualSize"), new objj_ivar("labelGoldenDrive"), new objj_ivar("labelRealSize"), new objj_ivar("labelVirtualSize")]);objj_registerClassPair(the_class);
...
,["void"])]);
}p;34;TNVirtualMachineDrivesController.jt;19210;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;20;AppKit/CPButtonBar.jI;22;AppKit/CPSearchField.jI;20;AppKit/CPTableView.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.jI;15;TNKit/TNAlert.jI;29;TNKit/TNTableViewDataSource.ji;22;../../Model/TNModule.ji;22;TNNewDriveController.ji;23;TNEditDriveController.ji;17;TNDriveDataView.ji;15;TNDriveObject.jt;18840;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPButtonBar.j", NO);objj_executeFile("AppKit/CPSearchField.j", NO);objj_executeFile("AppKit/CPTableView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);objj_executeFile("TNKit/TNTableViewDataSource.j", NO);objj_executeFile("../../Model/TNModule.j", YES);objj_executeFile("TNNewDriveController.j", YES);objj_executeFile("TNEditDriveController.j", YES);objj_executeFile("TNDriveDataView.j", YES);objj_executeFile("TNDriveObject.j", YES);var TNArchipelTypeVirtualMachineDisk = "archipel:vm:disk",
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonBarControl"), new objj_ivar("fieldFilter"), new objj_ivar("viewTableContainer"), new objj_ivar("editDriveController"), new objj_ivar("newDriveController"), new objj_ivar("dataViewDrivePrototype"), new objj_ivar("tableMedias"), new objj_ivar("_isEntityOnline"), new objj_ivar("_registredDiskListeningId"), new objj_ivar("_mediasDatasource")]);objj_registerClassPair(the_class);
...
,["void","BOOL"]), new objj_method(sel_getUid("awakeFromCib"), function $TNVirtualMachineDrivesController__awakeFromCib(self, _cmd)
{
    ...
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForAddDisk, CPBundleLocalizedString("Create a new disk", "Create a new disk"), self, sel_getUid("openNewDiskWindow:"), CPImageInBundle("IconsButtons/plus.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForRemoveDisk, CPBundleLocalizedString("Delete selected disk(s)", "Delete selected disk(s)"), self, sel_getUid("removeDisk:"), CPImageInBundle("IconsButtons/minus.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self, "addControlsWithIdentifier:title:target:action:image:", TNModuleControlForEditDisk, CPBundleLocalizedString("Edit selected disk", "Edit selected disk"), self, sel_getUid("openEditWindow:"), CPImageInBundle("IconsButtons/edit.png", nil, objj_msgSend(CPBundle, "mainBundle")));
    objj_msgSend(self.buttonBarControl, "setButtons:", [objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForAddDisk), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveDisk), objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForEditDisk)]);
...
,["void"]), new objj_method(sel_getUid("openNewDiskWindow:"), function $TNVirtualMachineDrivesController__openNewDiskWindow_(self, _cmd, aSender)
{
    ...
    if (!objj_msgSend(self, "isVisible"))
        return;
    objj_msgSend(self.newDriveController, "openWindow:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForAddDisk));
}
,["id","id"]), new objj_method(sel_getUid("openEditWindow:"), function $TNVirtualMachineDrivesController__openEditWindow_(self, _cmd, aSender)
{
    ...
    else
    {
        ...
        objj_msgSend(self.editDriveController, "openWindow:", objj_msgSend(aSender, "isKindOfClass:", CPMenuItem) ? self.tableMedias : aSender);
    }
}
...
,["void"]), new objj_method(sel_getUid("performRemoveDisk:"), function $TNVirtualMachineDrivesController__performRemoveDisk_(self, _cmd, someUserInfo)
{
    ...
    for (var i = 0; i < objj_msgSend(objects, "count"); i++)
    {
        ...
        objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeVirtualMachineDisk});
        objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"xmlns": TNArchipelTypeVirtualMachineDisk, "action": TNArchipelTypeVirtualMachineDiskDelete, "name": objj_msgSend(dName, "path"), "undefine": "yes"});
...
{
    objj_msgSend(self, "setControl:enabledAccordingToPermission:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForAddDisk), "drives_create");
    objj_msgSend(self, "setControl:enabledAccordingToPermission:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForRemoveDisk), "drives_delete", objj_msgSend(self.tableMedias, "numberOfSelectedRows") > 0);
    objj_msgSend(self, "setControl:enabledAccordingToPermissions:specialCondition:", objj_msgSend(self, "buttonWithIdentifier:", TNModuleControlForEditDisk), ["drives_convert", "drives_rename"], objj_msgSend(self.tableMedias, "numberOfSelectedRows") > 0);
}
,["void","CPTableView"]), new objj_method(sel_getUid("tableView:menuForTableColumn:row:"), function $TNVirtualMachineDrivesController__tableView_menuForTableColumn_row_(self, _cmd, aTableView, aColumn, aRow)
{
    ...
    {
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForRemoveDisk));
        return self._contextualMenu;
    }
    if (objj_msgSend(aTableView, "numberOfSelectedRows") == 0)
    {
        objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForAddDisk));
        return self._contextualMenu;
    }
    objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForRemoveDisk));
    objj_msgSend(self._contextualMenu, "addItem:", objj_msgSend(self, "menuItemWithIdentifier:", TNModuleControlForEditDisk));
    return self._contextualMenu;
}
,["CPMenu","CPTableView","CPTableColumn","int"]), new objj_method(sel_getUid("tableViewDeleteKeyPressed:"), function $TNVirtualMachineDrivesController__tableViewDeleteKeyPressed_(self, _cmd, aTableView)
{
    if (objj_msgSend(aTableView, "numberOfSelectedRows") == 0)
        return;
    objj_msgSend(self, "removeDisk:", aTableView);
}
,["void","CPTableView"])]);
}CPBundleLocalizedString = function(key, comment)
{
...
p;15;TNDriveObject.jt;2848;@STATIC;1.0;I;23;Foundation/Foundation.jt;2801;objj_executeFile("Foundation/Foundation.j", NO);{var the_class = objj_allocateClassPair(CPObject, "TNDrive"),
...
}p;22;TNNewDriveController.jt;9689;@STATIC;1.0;I;23;Foundation/Foundation.jI;19;AppKit/CPCheckBox.jI;22;AppKit/CPPopUpButton.jI;20;AppKit/CPTextField.jI;17;AppKit/CPWindow.jI;15;TNKit/TNAlert.jI;35;StropheCappuccino/TNStropheStanza.jt;9484;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPCheckBox.j", NO);objj_executeFile("AppKit/CPPopUpButton.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPWindow.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);objj_executeFile("StropheCappuccino/TNStropheStanza.j", NO);var TNArchipelTypeVirtualMachineDisk = "archipel:vm:disk",
    TNArchipelTypeVirtualMachineDiskCreate = "create",
    TNArchipelTypeVirtualMachineDiskGoldenList = "getgolden";
{var the_class = objj_allocateClassPair(CPObject, "TNNewDriveController"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonOK"), new objj_ivar("checkBoxUseMasterDrive"), new objj_ivar("checkBoxUseQCOW2Preallocation"), new objj_ivar("mainPopover"), new objj_ivar("buttonGoldenDrive"), new objj_ivar("buttonNewDiskFormat"), new objj_ivar("buttonNewDiskSizeUnit"), new objj_ivar("fieldNewDiskName"), new objj_ivar("fieldNewDiskSize"), new objj_ivar("_delegate")]);objj_registerClassPair(the_class);
...
,["id","id"]), new objj_method(sel_getUid("getGoldenList"), function $TNNewDriveController__getGoldenList(self, _cmd)
{
    var stanza = objj_msgSend(TNStropheStanza, "iqWithType:", "get");
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeVirtualMachineDisk});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"xmlns": TNArchipelTypeVirtualMachineDisk, "action": TNArchipelTypeVirtualMachineDiskGoldenList});
