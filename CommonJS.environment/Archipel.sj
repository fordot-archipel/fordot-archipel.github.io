@STATIC;1.0;p;6;main.jt;1528;@STATIC;1.0;I;23;Foundation/Foundation.jI;16;AppKit/CPSound.ji;33;Categories/CPBundle+Localizable.ji;15;AppController.jt;1402;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPSound.j", NO);objj_executeFile("Categories/CPBundle+Localizable.j", YES);objj_executeFile("AppController.j", YES);gameOver = function(code)
{
    ...
    container.innerHTML = "<h2>Game Over</h2><br/>You're browser seems uncompatible with feature code <code>" + code + "</code><br/>You should use Chromium or Safari or any decent browser actually";
...
p;15;AppController.jt;77128;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;16;AppKit/CPImage.jI;20;AppKit/CPImageView.jI;15;AppKit/CPMenu.jI;19;AppKit/CPMenuItem.jI;25;AppKit/CPPlatformWindow.jI;28;AppKit/CPProgressIndicator.jI;21;AppKit/CPScrollView.jI;21;AppKit/CPScrollView.jI;20;AppKit/CPSplitView.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.jI;17;AppKit/CPWindow.jI;18;AppKit/CPWebView.jI;19;AppKit/_CPToolTip.jI;33;GrowlCappuccino/GrowlCappuccino.jI;28;LPKit/LPMultiLineTextField.jI;23;LPKit/LPCrashReporter.jI;17;TNKit/TNToolbar.jI;18;TNKit/TNFlipView.jI;17;TNKit/TNTabView.ji;25;Categories/TNCategories.ji;32;Controllers/TNAvatarController.ji;36;Controllers/TNConnectionController.ji;34;Controllers/TNContactsController.ji;32;Controllers/TNGroupsController.ji;30;Controllers/TNHintController.ji;32;Controllers/TNModuleController.ji;45;Controllers/TNNotificationHistoryController.ji;33;Controllers/TNPermissionsCenter.ji;37;Controllers/TNPreferencesController.ji;36;Controllers/TNPropertiesController.ji;26;Controllers/TNPushCenter.ji;30;Controllers/TNTagsController.ji;32;Controllers/TNUpdateController.ji;36;Controllers/TNUserAvatarController.ji;37;Controllers/TNXMPPAccountController.ji;17;Model/TNVersion.ji;30;Views/TNButtonBarPopUpButton.ji;27;Views/TNOutlineViewRoster.ji;25;Views/TNRosterDataViews.ji;21;Views/TNSearchField.jt;75790;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPImage.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("AppKit/CPMenu.j", NO);objj_executeFile("AppKit/CPMenuItem.j", NO);objj_executeFile("AppKit/CPPlatformWindow.j", NO);objj_executeFile("AppKit/CPProgressIndicator.j", NO);objj_executeFile("AppKit/CPScrollView.j", NO);objj_executeFile("AppKit/CPScrollView.j", NO);objj_executeFile("AppKit/CPSplitView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPWindow.j", NO);objj_executeFile("AppKit/CPWebView.j", NO);objj_executeFile("AppKit/_CPToolTip.j", NO);objj_executeFile("GrowlCappuccino/GrowlCappuccino.j", NO);objj_executeFile("LPKit/LPMultiLineTextField.j", NO);objj_executeFile("LPKit/LPCrashReporter.j", NO);objj_executeFile("TNKit/TNToolbar.j", NO);objj_executeFile("TNKit/TNFlipView.j", NO);objj_executeFile("TNKit/TNTabView.j", NO);objj_executeFile("Categories/TNCategories.j", YES);objj_executeFile("Controllers/TNAvatarController.j", YES);objj_executeFile("Controllers/TNConnectionController.j", YES);objj_executeFile("Controllers/TNContactsController.j", YES);objj_executeFile("Controllers/TNGroupsController.j", YES);objj_executeFile("Controllers/TNHintController.j", YES);objj_executeFile("Controllers/TNModuleController.j", YES);objj_executeFile("Controllers/TNNotificationHistoryController.j", YES);objj_executeFile("Controllers/TNPermissionsCenter.j", YES);objj_executeFile("Controllers/TNPreferencesController.j", YES);objj_executeFile("Controllers/TNPropertiesController.j", YES);objj_executeFile("Controllers/TNPushCenter.j", YES);objj_executeFile("Controllers/TNTagsController.j", YES);objj_executeFile("Controllers/TNUpdateController.j", YES);objj_executeFile("Controllers/TNUserAvatarController.j", YES);objj_executeFile("Controllers/TNXMPPAccountController.j", YES);objj_executeFile("Model/TNVersion.j", YES);objj_executeFile("Views/TNButtonBarPopUpButton.j", YES);objj_executeFile("Views/TNOutlineViewRoster.j", YES);objj_executeFile("Views/TNRosterDataViews.j", YES);objj_executeFile("Views/TNSearchField.j", YES);CPFontDefaultSystemFontFace = "Courier";
...
class_addMethods(the_class, [new objj_method(sel_getUid("awakeFromCib"), function $AppController__awakeFromCib(self, _cmd)
{
    ...
    objj_msgSend(self.imageViewLogoAbout, "setImage:", CPImageInBundle("Backgrounds/background-icon.png", nil, bundle));
    ...
    objj_msgSend(self.leftView, "setBackgroundColor:", CPColorWithImages("Backgrounds/dark-bg.png", nil, nil, bundle));
    ...
    objj_msgSend(self.filterView, "setBackgroundColor:", CPColorWithImages("Backgrounds/background-filter.png", nil, nil, bundle));
    ...
    self._imageLedInData = CPImageInBundle("IconsStatus/green.png", CGSizeMake(8.0, 8.0), bundle);
    self._imageLedOutData = CPImageInBundle("IconsStatus/orange.png", CGSizeMake(8.0, 8.0), bundle);
    self._imageLedNoData = CPImageInBundle("IconsStatus/gray.png", CGSizeMake(8.0, 8.0), bundle);
    ...
    objj_msgSend(self.statusBar, "setBackgroundColor:", CPColorWithImages("Backgrounds/statusbar-bg.png", nil, nil, bundle));
...
,["void"]), new objj_method(sel_getUid("makeToolbar"), function $AppController__makeToolbar(self, _cmd)
{
    ...
    (TNArchipelStatusAvailableLabel = CPLocalizedString("Available", "Available"), TNArchipelStatusAwayLabel = CPLocalizedString("Away", "Away"), TNArchipelStatusBusyLabel = CPLocalizedString("Busy", "Busy"), TNArchipelStatusDNDLabel = CPLocalizedString("Do not disturb", "Do not disturb"), objj_msgSend(availableItem, "setTitle:", TNArchipelStatusAvailableLabel));
    objj_msgSend(availableItem, "setImage:", CPImageInBundle("IconsStatus/green-large.png", CGSizeMake(10.0, 8.0), bundle));
    objj_msgSend(statusSelector, "addItem:", availableItem);
    objj_msgSend(awayItem, "setTitle:", TNArchipelStatusAwayLabel);
    objj_msgSend(awayItem, "setImage:", CPImageInBundle("IconsStatus/orange-large.png", CGSizeMake(10.0, 8.0), bundle));
    objj_msgSend(statusSelector, "addItem:", awayItem);
    objj_msgSend(busyItem, "setTitle:", TNArchipelStatusBusyLabel);
    objj_msgSend(busyItem, "setImage:", CPImageInBundle("IconsStatus/red-large.png", CGSizeMake(10.0, 8.0), bundle));
    objj_msgSend(statusSelector, "addItem:", busyItem);
    objj_msgSend(DNDItem, "setTitle:", TNArchipelStatusDNDLabel);
    objj_msgSend(DNDItem, "setImage:", CPImageInBundle("IconsStatus/black-large.png", CGSizeMake(10.0, 8.0), bundle));
...
,["void"]), new objj_method(sel_getUid("makeAvatarChooser"), function $AppController__makeAvatarChooser(self, _cmd)
{
    ...
    (self._userAvatarButton = objj_msgSend(objj_msgSend(CPButton, "alloc"), "initWithFrame:", CGRectMake(5.0, 4.0, TNUserAvatarSize.width - 5, TNUserAvatarSize.height - 5)), objj_msgSend(self._userAvatarButton, "setBordered:", NO));
    ...
    objj_msgSend(self._userAvatarButton, "setImage:", CPImageInBundle("user-unknown.png", TNUserAvatarSize, bundle));
...
,["void"]), new objj_method(sel_getUid("makeButtonBar"), function $AppController__makeButtonBar(self, _cmd)
{
    ...
    self._hideButtonImageEnable = CPImageInBundle("IconsButtonBar/show.png", CGSizeMake(20, 20), bundle);
    self._hideButtonImageDisable = CPImageInBundle("IconsButtonBar/hide.png", CGSizeMake(20, 20), bundle);
    ...
    (self._plusButton = objj_msgSend(objj_msgSend(TNButtonBarPopUpButton, "alloc"), "initWithFrame:", CGRectMake(0, 0, 35, 25)), objj_msgSend(self._plusButton, "setTarget:", self));
    objj_msgSend(self._plusButton, "setImage:", CPImageInBundle("IconsButtonBar/plus.png", CGSizeMake(20, 20), bundle));
    ...
    objj_msgSend(minusButton, "setImage:", CPImageInBundle("IconsButtonBar/minus.png", CGSizeMake(20, 20), bundle));
...
,["BOOL","CPOutlineView","id"]), new objj_method(sel_getUid("outlineViewSelectionDidChange:"), function $AppController__outlineViewSelectionDidChange_(self, _cmd, notification)
{
    ...
    objj_msgSend(self.propertiesController, "reload");
    if (loadDelay == 0)
        objj_msgSend(self, "performModuleChange:", objj_msgSend(objj_msgSend(CPDictionary, "alloc"), "initWithObjectsAndKeys:", item, "userInfo"));
    else
...
,["void","CPTimer"]), new objj_method(sel_getUid("outlineView:menuForTableColumn:item:"), function $AppController__outlineView_menuForTableColumn_item_(self, _cmd, anOutlineView, aTableColumn, anItem)
{
    if (anOutlineView != self._rosterOutlineView)
        return;
    if (objj_msgSend(anOutlineView, "numberOfSelectedRows") == 0)
        return;
...
,["CPMenu","CPOutlineView","CPTableColumn","int"]), new objj_method(sel_getUid("outlineViewDeleteKeyPressed:"), function $AppController__outlineViewDeleteKeyPressed_(self, _cmd, anOutlineView)
{
    if (anOutlineView != self._rosterOutlineView)
        return;
    if (objj_msgSend(anOutlineView, "numberOfSelectedRows") == 0)
        return;
    objj_msgSend(self, "deleteEntities:", anOutlineView);
}
,["void","CPOutlineView"]), new objj_method(sel_getUid("splitView:constrainMaxCoordinate:ofSubviewAt:"), function $AppController__splitView_constrainMaxCoordinate_ofSubviewAt_(self, _cmd, aSplitView, position, index)
{
...
}p;36;Controllers/TNUserAvatarController.jt;5744;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;16;AppKit/CPImage.jI;15;AppKit/CPMenu.jI;19;AppKit/CPMenuItem.jI;35;StropheCappuccino/TNStropheStanza.jI;29;StropheCappuccino/TNXMLNode.jI;37;StropheCappuccino/TNStropheIMClient.jI;33;GrowlCappuccino/GrowlCappuccino.jt;5456;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPImage.j", NO);objj_executeFile("AppKit/CPMenu.j", NO);objj_executeFile("AppKit/CPMenuItem.j", NO);objj_executeFile("StropheCappuccino/TNStropheStanza.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);objj_executeFile("StropheCappuccino/TNStropheIMClient.j", NO);objj_executeFile("GrowlCappuccino/GrowlCappuccino.j", NO);{var the_class = objj_allocateClassPair(CPObject, "TNUserAvatarController"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_buttonAvatar"), new objj_ivar("_currentAvatar"), new objj_ivar("_menuAvatarSelection"), new objj_ivar("_avatars"), new objj_ivar("_pListObject")]);objj_registerClassPair(the_class);
...
,["void"]), new objj_method(sel_getUid("loadAvatars"), function $TNUserAvatarController__loadAvatars(self, _cmd)
{
    ...
    for (var i = 0; i < objj_msgSend(avatarsArray, "count"); i++)
    {
        var avatarInfo = objj_msgSend(avatarsArray, "objectAtIndex:", i),
            image = CPImageInBundle(objj_msgSend(avatarInfo, "objectForKey:", "path"), TNUserAvatarSize, bundle);
...
}p;32;Controllers/TNModuleController.jt;39863;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/CPMenu.jI;20;AppKit/CPTextField.jI;22;AppKit/CPToolbarItem.jI;15;AppKit/CPView.jI;37;StropheCappuccino/StropheCappuccino.jI;19;TNKit/TNAnimation.jI;17;TNKit/TNTabView.jI;17;TNKit/TNToolbar.ji;21;TNPermissionsCenter.jt;39587;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPMenu.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPToolbarItem.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("StropheCappuccino/StropheCappuccino.j", NO);objj_executeFile("TNKit/TNAnimation.j", NO);objj_executeFile("TNKit/TNTabView.j", NO);objj_executeFile("TNKit/TNToolbar.j", NO);objj_executeFile("TNPermissionsCenter.j", YES);TNArchipelModuleTypeTab = "tab";
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("viewPermissionDenied"), new objj_ivar("_moduleLoadingStarted"), new objj_ivar("_toolbarModuleBackgroundColor"), new objj_ivar("_rosterContactsMenu"), new objj_ivar("_rosterGroupsMenu"), new objj_ivar("_modulesPath"), new objj_ivar("_moduleType"), new objj_ivar("_infoTextField"), new objj_ivar("_mainModuleView"), new objj_ivar("_delegate"), new objj_ivar("_entity"), new objj_ivar("_numberOfActiveModules"), new objj_ivar("_mainTabView"), new objj_ivar("_mainToolbar"), new objj_ivar("_allowToolbarSwitching"), new objj_ivar("_deactivateModuleTabItemPositionStorage"), new objj_ivar("_openedTabsRegistry"), new objj_ivar("_tabModules"), new objj_ivar("_toolbarModules"), new objj_ivar("_modulesPList"), new objj_ivar("_numberOfModulesLoaded"), new objj_ivar("_numberOfModulesToLoad"), new objj_ivar("_animationToolBarModuleHide"), new objj_ivar("_animationToolBarModuleShow"), new objj_ivar("_currentToolbarModule")]);objj_registerClassPair(the_class);
...
,["void","CPColor"]), new objj_method(sel_getUid("rosterContactsMenu"), function $TNModuleController__rosterContactsMenu(self, _cmd)
{
...
,["void","CPBundle"]), new objj_method(sel_getUid("_manageToolbarItemLoad:"), function $TNModuleController___manageToolbarItemLoad_(self, _cmd, aBundle)
{
    ...
    objj_msgSend(moduleToolbarItem, "setImage:", CPImageInBundle("icon.png", CGSizeMake(32, 32), aBundle));
    objj_msgSend(moduleToolbarItem, "setAlternateImage:", CPImageInBundle("icon-alt.png", CGSizeMake(32, 32), aBundle));
...
,["void","CPBundle"]), new objj_method(sel_getUid("_loadLocalizedModuleController:forBundle:"), function $TNModuleController___loadLocalizedModuleController_forBundle_(self, _cmd, bundleLocale, aBundle)
{
    var defaults = objj_msgSend(CPUserDefaults, "standardUserDefaults"),
        moduleIdentifier = objj_msgSend(aBundle, "objectForInfoDictionaryKey:", "CPBundleIdentifier"),
...
}p;33;Controllers/TNPermissionsCenter.jt;24790;@STATIC;1.0;I;23;Foundation/Foundation.jI;20;AppKit/CPImageView.jI;31;GrowlCappuccino/TNGrowlCenter.jI;28;StropheCappuccino/TNPubSub.jI;36;StropheCappuccino/TNStropheContact.jI;37;StropheCappuccino/TNStropheIMClient.jI;32;StropheCappuccino/TNStropheJID.jI;35;StropheCappuccino/TNStropheStanza.ji;30;../Resources/admin-accounts.jst;24453;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("GrowlCappuccino/TNGrowlCenter.j", NO);objj_executeFile("StropheCappuccino/TNPubSub.j", NO);objj_executeFile("StropheCappuccino/TNStropheContact.j", NO);objj_executeFile("StropheCappuccino/TNStropheIMClient.j", NO);objj_executeFile("StropheCappuccino/TNStropheJID.j", NO);objj_executeFile("StropheCappuccino/TNStropheStanza.j", NO);objj_executeFile("../Resources/admin-accounts.js", YES);TNPermissionsValidationModeBare = 0;
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_adminAccounts"), new objj_ivar("_cachedPermissions"), new objj_ivar("_adminAccountValidationMode"), new objj_ivar("_delegates"), new objj_ivar("_disableBadgesRegistry"), new objj_ivar("_imageViewControlDisabledPrototype"), new objj_ivar("_pubsubAdminAccounts")]);objj_registerClassPair(the_class);
...
,["void","int"]), new objj_method(sel_getUid("init"), function $TNPermissionsCenter__init(self, _cmd)
{
    if (self = objj_msgSendSuper({ receiver:self, super_class:objj_getClass("TNPermissionsCenter").super_class }, "init"))
    {
        ...
        objj_msgSend(self._imageViewControlDisabledPrototype, "setImage:", CPImageInBundle("denied.png", CGSizeMake(16.0, 16.0), objj_msgSend(CPBundle, "mainBundle")));
    }
    return self;
}
...
,["void","TNStropheContact"]), new objj_method(sel_getUid("hasPermissions:forEntity:"), function $TNPermissionsCenter__hasPermissions_forEntity_(self, _cmd, somePermissions, anEntity)
{
    for (var i = 0; i < objj_msgSend(somePermissions, "count"); i++)
    {
        if (!objj_msgSend(anEntity, "isKindOfClass:", TNStropheContact))
            return NO;
        if (self._adminAccountValidationMode === TNPermissionsValidationModeNode && objj_msgSend(objj_msgSend(self._adminAccounts, "allValues"), "containsObject:", objj_msgSend(objj_msgSend(objj_msgSend(TNStropheIMClient, "defaultClient"), "JID"), "node")) || self._adminAccountValidationMode === TNPermissionsValidationModeBare && objj_msgSend(objj_msgSend(self._adminAccounts, "allValues"), "containsObject:", objj_msgSend(objj_msgSend(objj_msgSend(TNStropheIMClient, "defaultClient"), "JID"), "bare")))
            return YES;
...
,["void","CPControl","int","CPArray","TNStropheContact","BOOL"]), new objj_method(sel_getUid("getPermissionForEntity:"), function $TNPermissionsCenter__getPermissionForEntity_(self, _cmd, anEntity)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypePermissionsGetOwn, "permission_type": "user", "permission_target": objj_msgSend(objj_msgSend(objj_msgSend(TNStropheIMClient, "defaultClient"), "JID"), "bare")});
...
,["TNPermissionsCenter"])]);
}p;30;Controllers/TNHintController.jt;2270;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPWindow.jI;15;AppKit/CPView.jI;20;AppKit/CPImageView.jI;16;AppKit/CPImage.jI;20;AppKit/CPTextField.jt;2110;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPWindow.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("AppKit/CPImage.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);{var the_class = objj_allocateClassPair(CPObject, "TNHintController"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonOpenWiki"), new objj_ivar("imageViewHint1"), new objj_ivar("imageViewHint2"), new objj_ivar("imageViewHint3"), new objj_ivar("imageViewLogo"), new objj_ivar("hintView"), new objj_ivar("_mainWindow")]);objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("awakeFromCib"), function $TNHintController__awakeFromCib(self, _cmd)
{
    var bundle = objj_msgSend(CPBundle, "mainBundle");
    objj_msgSend(self.imageViewLogo, "setImage:", CPImageInBundle("Backgrounds/background-icon.png", nil, bundle));
    objj_msgSend(self.imageViewHint1, "setImage:", CPImageInBundle("hints/hint1.png", nil, bundle));
    objj_msgSend(self.imageViewHint2, "setImage:", CPImageInBundle("hints/hint2.png", nil, bundle));
    objj_msgSend(self.imageViewHint3, "setImage:", CPImageInBundle("hints/hint3.png", nil, bundle));
...
,["id","id"])]);
}p;45;Controllers/TNNotificationHistoryController.jt;2816;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;25;AppKit/CPCollectionView.jI;20;AppKit/CPImageView.jI;15;AppKit/CPView.jI;17;AppKit/CPWindow.jI;29;TNKit/TNTableViewDataSource.jI;33;GrowlCappuccino/GrowlCappuccino.jt;2578;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPCollectionView.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPWindow.j", NO);objj_executeFile("TNKit/TNTableViewDataSource.j", NO);objj_executeFile("GrowlCappuccino/GrowlCappuccino.j", NO);{var the_class = objj_allocateClassPair(CPObject, "TNNotificationHistoryController"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonClear"), new objj_ivar("tableHistory"), new objj_ivar("mainWindow"), new objj_ivar("_datasourceNotification")]);objj_registerClassPair(the_class);
...
,["id","id"])]);
}p;30;Controllers/TNTagsController.jt;11073;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;16;AppKit/CPImage.jI;21;AppKit/CPTokenField.jI;15;AppKit/CPView.jI;45;StropheCappuccino/PubSub/TNPubSubController.jI;39;StropheCappuccino/PubSub/TNPubSubNode.jI;36;StropheCappuccino/TNStropheContact.jI;32;StropheCappuccino/TNStropheJID.ji;21;TNPermissionsCenter.jt;10738;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPImage.j", NO);objj_executeFile("AppKit/CPTokenField.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("StropheCappuccino/PubSub/TNPubSubController.j", NO);objj_executeFile("StropheCappuccino/PubSub/TNPubSubNode.j", NO);objj_executeFile("StropheCappuccino/TNStropheContact.j", NO);objj_executeFile("StropheCappuccino/TNStropheJID.j", NO);objj_executeFile("TNPermissionsCenter.j", YES);var TNArchipelTypeTags = "archipel:tags",
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("mainView"), new objj_ivar("tokenFieldTags"), new objj_ivar("buttonSave"), new objj_ivar("_pubsubController"), new objj_ivar("_pubsubTagsNode"), new objj_ivar("_alreadyReady"), new objj_ivar("_currentRosterItem")]);objj_registerClassPair(the_class);
...
,["void","TNPubSubController"]), new objj_method(sel_getUid("awakeFromCib"), function $TNTagsController__awakeFromCib(self, _cmd)
{
    var frame = objj_msgSend(self.mainView, "frame"),
        ...
        tokenFrame;
    objj_msgSend(self.mainView, "setBackgroundColor:", CPColorWithImages("Backgrounds/background-filter.png", nil, nil, bundle));
...
,["void","CPNotification"]), new objj_method(sel_getUid("performSetTags:"), function $TNTagsController__performSetTags_(self, _cmd, sender)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeTagsSetTags, "tags": tagsString});
...
}p;37;Controllers/TNPreferencesController.jt;23325;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;19;AppKit/CPCheckBox.jI;22;AppKit/CPPopUpButton.jI;18;AppKit/CPTabView.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.jI;17;AppKit/CPWindow.jI;21;AppKit/CPScrollView.jI;15;TNKit/TNAlert.jI;31;GrowlCappuccino/TNGrowlCenter.jI;37;StropheCappuccino/TNStropheIMClient.jI;43;StropheCappuccino/TNStrophePrivateStorage.jI;35;StropheCappuccino/TNStropheStanza.ji;19;../Views/TNSwitch.jt;22878;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPCheckBox.j", NO);objj_executeFile("AppKit/CPPopUpButton.j", NO);objj_executeFile("AppKit/CPTabView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPWindow.j", NO);objj_executeFile("AppKit/CPScrollView.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);objj_executeFile("GrowlCappuccino/TNGrowlCenter.j", NO);objj_executeFile("StropheCappuccino/TNStropheIMClient.j", NO);objj_executeFile("StropheCappuccino/TNStrophePrivateStorage.j", NO);objj_executeFile("StropheCappuccino/TNStropheStanza.j", NO);objj_executeFile("../Views/TNSwitch.j", YES);TNPreferencesControllerSavePreferencesRequestNotification = "TNPreferencesControllerSavePreferencesRequestNotification";
...
,["void","id"]), new objj_method(sel_getUid("awakeFromCib"), function $TNPreferencesController__awakeFromCib(self, _cmd)
{
    ...
    self._excludedTokensNames = ["TNArchipelPropertyControllerEnabled", "TNArchipelXMPPJID", "TNArchipelXMPPPassword", "TNArchipelXMPPService", "TNArchipelRememberCredentials", "TNArchipelTagsVisible", "TNArchipelModuleControllerOpenedTabRegistry", "TNArchipelForceJIDDomain", "TNArchipelForcedJIDDomain", "TNUserChatMessageStore", "TNOutlineViewsExpandedGroups", "TNArchipelTypeVirtualMachineControlDoNotShowDestroyAlert"];
}
...
,["void","CPWindow"])]);
}p;36;Controllers/TNConnectionController.jt;16703;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;20;AppKit/CPImageView.jI;20;AppKit/CPTextField.jI;37;StropheCappuccino/TNStropheIMClient.jI;35;StropheCappuccino/TNStropheStanza.jI;34;StropheCappuccino/TNStropheVCard.ji;27;../Utils/EKShakeAnimation.ji;24;../Views/TNModalWindow.ji;19;../Views/TNSwitch.jt;16377;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("StropheCappuccino/TNStropheIMClient.j", NO);objj_executeFile("StropheCappuccino/TNStropheStanza.j", NO);objj_executeFile("StropheCappuccino/TNStropheVCard.j", NO);objj_executeFile("../Utils/EKShakeAnimation.j", YES);objj_executeFile("../Views/TNModalWindow.j", YES);objj_executeFile("../Views/TNSwitch.j", YES);TNConnectionControllerCurrentUserVCardRetreived = "TNConnectionControllerCurrentUserVCardRetreived";
...
,["void","CPNotification"]), new objj_method(sel_getUid("_didJIDChange:"), function $TNConnectionController___didJIDChange_(self, _cmd, aNotification)
{
    var currentJID;
    try    {
        currentJID = objj_msgSend(TNStropheJID, "stropheJIDWithString:", objj_msgSend(self.fieldJID, "stringValue"));
    }
    catch(e)     {
...
,["void"]), new objj_method(sel_getUid("_prepareJID"), function $TNConnectionController___prepareJID(self, _cmd)
{
    ...
    try    {
        objj_msgSend(self.fieldJID, "setStringValue:", objj_msgSend(objj_msgSend(TNStropheJID, "stropheJIDWithString:", lastJID), "bare"));
    }
    catch(e)     {
    }}
...
,["void"])]);
}p;32;Controllers/TNAvatarController.jt;9871;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;25;AppKit/CPCollectionView.jI;20;AppKit/CPImageView.jI;15;AppKit/CPView.ji;24;../Views/TNAvatarImage.ji;23;../Views/TNAvatarView.ji;21;TNPermissionsCenter.jt;9644;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPCollectionView.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("../Views/TNAvatarImage.j", YES);objj_executeFile("../Views/TNAvatarView.j", YES);objj_executeFile("TNPermissionsCenter.j", YES);var TNArchipelTypeAvatar = "archipel:avatar",
...
,["id","id"]), new objj_method(sel_getUid("getAvailableAvatars"), function $TNAvatarController__getAvailableAvatars(self, _cmd)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeAvatarGetAvatars});
...
,["void","TNStropheStanza"]), new objj_method(sel_getUid("setAvatar:"), function $TNAvatarController__setAvatar_(self, _cmd, sender)
{
    ...
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "query", {"xmlns": TNArchipelTypeAvatar});
    objj_msgSend(stanza, "addChildWithName:andAttributes:", "archipel", {"action": TNArchipelTypeAvatarSetAvatar, "avatar": filename});
...
,["id","id"]), new objj_method(sel_getUid("didSetAvatar:"), function $TNAvatarController__didSetAvatar_(self, _cmd, aStanza)
{
    if (objj_msgSend(aStanza, "type") == "result")
    {
        ...
        objj_msgSend(self.collectionViewAvatars, "setSelectionIndexes:", nil);
        objj_msgSend(self.mainPopover, "close");
    }
}
...
,["void","TNStropheContact"]), new objj_method(sel_getUid("awakeFromCib"), function $TNPropertiesController__awakeFromCib(self, _cmd)
{
    ...
    self._unknownUserImage = CPImageInBundle("user-unknown.png", nil, bundle);
    self._groupUserImage = CPImageInBundle("groups.png", CGSizeMake(16, 16), bundle);
    self._pubsubImage = CPImageInBundle("pubsub.png", nil, bundle);
    ...
    objj_msgSend(self.imageVCardIcon, "setImage:", CPImageInBundle("vcard-icon.png", nil, bundle));
...
,["id","id"])]);
}p;32;Controllers/TNUpdateController.jt;6880;@STATIC;1.0;I;23;Foundation/Foundation.jI;20;AppKit/CPTextField.jI;17;AppKit/CPWindow.jI;28;LPKit/LPMultiLineTextField.jI;15;TNKit/TNAlert.ji;20;../Model/TNVersion.jt;6708;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPWindow.j", NO);objj_executeFile("LPKit/LPMultiLineTextField.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);objj_executeFile("../Model/TNVersion.j", YES);{var the_class = objj_allocateClassPair(CPObject, "TNUpdateController"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("fieldCurrentVersion"), new objj_ivar("fieldDate"), new objj_ivar("fieldServerVersion"), new objj_ivar("labelCurrentVersion"), new objj_ivar("labelDate"), new objj_ivar("labelServerVersion"), new objj_ivar("mainWindow"), new objj_ivar("fieldChanges"), new objj_ivar("_URL"), new objj_ivar("_currentVersion"), new objj_ivar("_forceCheck"), new objj_ivar("_changes"), new objj_ivar("_date"), new objj_ivar("_URLDownload"), new objj_ivar("_plist"), new objj_ivar("_version")]);objj_registerClassPair(the_class);
...
,["void","CPURLConnection","CPString"])]);
}p;37;Controllers/TNXMPPAccountController.jt;3773;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;20;AppKit/CPTextField.jI;17;AppKit/CPWindow.jI;33;GrowlCappuccino/GrowlCappuccino.jI;37;StropheCappuccino/TNStropheIMClient.jI;15;TNKit/TNAlert.jt;3557;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPWindow.j", NO);objj_executeFile("GrowlCappuccino/GrowlCappuccino.j", NO);objj_executeFile("StropheCappuccino/TNStropheIMClient.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);{var the_class = objj_allocateClassPair(CPObject, "TNXMPPAccountController"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("defaultButton"), new objj_ivar("fieldNewPassword"), new objj_ivar("fieldNewPasswordConfirm"), new objj_ivar("mainWindow")]);objj_registerClassPair(the_class);
...
,["id","id"])]);
}p;32;Controllers/TNGroupsController.jt;3727;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;20;AppKit/CPTextField.jI;17;AppKit/CPWindow.jI;31;GrowlCappuccino/TNGrowlCenter.jI;37;StropheCappuccino/TNStropheIMClient.jI;15;TNKit/TNAlert.jt;3513;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPWindow.j", NO);objj_executeFile("GrowlCappuccino/TNGrowlCenter.j", NO);objj_executeFile("StropheCappuccino/TNStropheIMClient.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);{var the_class = objj_allocateClassPair(CPObject, "TNGroupsController"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonAdd"), new objj_ivar("buttonCancel"), new objj_ivar("mainPopover"), new objj_ivar("newGroupName")]);objj_registerClassPair(the_class);
...
,["id","id"])]);
}p;34;Controllers/TNContactsController.jt;12839;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;17;AppKit/CPButton.jI;20;AppKit/CPTextField.jI;17;AppKit/CPWindow.jI;15;TNKit/TNAlert.jI;33;GrowlCappuccino/GrowlCappuccino.jI;45;StropheCappuccino/PubSub/TNPubSubController.jI;37;StropheCappuccino/TNStropheIMClient.ji;21;TNPermissionsCenter.jt;12524;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("AppKit/CPWindow.j", NO);objj_executeFile("TNKit/TNAlert.j", NO);objj_executeFile("GrowlCappuccino/GrowlCappuccino.j", NO);objj_executeFile("StropheCappuccino/PubSub/TNPubSubController.j", NO);objj_executeFile("StropheCappuccino/TNStropheIMClient.j", NO);objj_executeFile("TNPermissionsCenter.j", YES);{var the_class = objj_allocateClassPair(CPObject, "TNContactsController"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("buttonAdd"), new objj_ivar("buttonCancel"), new objj_ivar("mainPopover"), new objj_ivar("newContactJID"), new objj_ivar("newContactName"), new objj_ivar("_pubsubController"), new objj_ivar("_localAvatars")]);objj_registerClassPair(the_class);
...
,["void","TNPubSubController"]), new objj_method(sel_getUid("awakeFromCib"), function $TNContactsController__awakeFromCib(self, _cmd)
{
    ...
    var bundle = objj_msgSend(CPBundle, "mainBundle");
    objj_msgSend(self._localAvatars, "setObject:forKey:", CPImageInBundle("Avatars/RemoteAvatars/defaultvm.png", nil, bundle), "vm");
    objj_msgSend(self._localAvatars, "setObject:forKey:", CPImageInBundle("Avatars/RemoteAvatars/defaulthypervisor.png", nil, bundle), "hypervisor");
...
}p;26;Controllers/TNPushCenter.jt;6734;@STATIC;1.0;I;23;Foundation/Foundation.jI;39;StropheCappuccino/TNStropheConnection.jI;28;StropheCappuccino/TNPubSub.jt;6610;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("StropheCappuccino/TNStropheConnection.j", NO);objj_executeFile("StropheCappuccino/TNPubSub.j", NO);var __defaultPushCenter;
{var the_class = objj_allocateClassPair(CPObject, "TNPushCenter"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_pubSubNode"), new objj_ivar("_connection"), new objj_ivar("_pubsubRegistrar"), new objj_ivar("_pubSubHandlerId")]);objj_registerClassPair(the_class);
...
,["void","TNStropheConnection"]), new objj_method(sel_getUid("_onPubSubEvents:"), function $TNPushCenter___onPubSubEvents_(self, _cmd, aStanza)
{
    ...
    var nodeOwner = (objj_msgSend(objj_msgSend(aStanza, "firstChildWithName:", "items"), "valueForAttribute:", "node").split("/"))[2],
        ...
        infoDict = objj_msgSend(objj_msgSend(CPDictionary, "alloc"), "initWithObjectsAndKeys:", nodeOwner, "owner", pushType, "type", pushDate, "date", pushChange, "change", aStanza, "rawStanza");
...
,["void","id","SEL","CPString"]), new objj_method(sel_getUid("removeObserver:forPushNotificationType:"), function $TNPushCenter__removeObserver_forPushNotificationType_(self, _cmd, anObject, aType)
{
    ...
    for (var i = 0; i < objj_msgSend(pubsubRegistrarCopy, "count"); i++)
    {
        ...
        CPLog.trace("PUSH CENTER: Removing object " + objj_msgSend(item, "objectForKey:", "object") + ":" + objj_msgSend(item, "objectForKey:", "selector") + " from TNPushCenter");
...
,["TNPushCenter"])]);
}p;22;Views/TNCalendarView.jt;4939;@STATIC;1.0;I;22;LPKit/LPCalendarView.jt;4893;objj_executeFile("LPKit/LPCalendarView.j", NO);{var the_class = objj_allocateClassPair(LPCalendarView, "TNCalendarView"),
...
,["void","CPEvent"])]);
}p;21;Views/TNSearchField.jt;2131;@STATIC;1.0;I;23;Foundation/Foundation.jI;22;AppKit/CPOutlineView.jI;22;AppKit/CPSearchField.jt;2030;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPOutlineView.j", NO);objj_executeFile("AppKit/CPSearchField.j", NO);{var the_class = objj_allocateClassPair(CPSearchField, "TNSearchField"),
...
,["void","CPEvent"])]);
}p;21;Views/TNAvatarImage.jt;710;@STATIC;1.0;I;23;Foundation/Foundation.jI;16;AppKit/CPImage.jt;643;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPImage.j", NO);{var the_class = objj_allocateClassPair(CPImage, "TNAvatarImage"),
...
,["void","CPString"])]);
}p;25;Views/TNRosterDataViews.jt;13308;@STATIC;1.0;I;23;Foundation/Foundation.jI;16;AppKit/CPImage.jI;20;AppKit/CPImageView.jI;20;AppKit/CPTextField.jI;36;StropheCappuccino/TNStropheContact.jt;13148;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPImage.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("StropheCappuccino/TNStropheContact.j", NO);var TNRosterDataViewContactImageUnknownUser,
...
{
    TNRosterDataViewContactImageUnknownUser = CPImageInBundle("user-unknown.png", nil, objj_msgSend(CPBundle, "mainBundle"));
}
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("avatar"), new objj_ivar("statusIcon"), new objj_ivar("events"), new objj_ivar("name"), new objj_ivar("status"), new objj_ivar("_contact")]);objj_registerClassPair(the_class);
...
,["void"]), new objj_method(sel_getUid("setObjectValue:"), function $TNRosterDataViewContact__setObjectValue_(self, _cmd, aContact)
{
    ...
    var opts = objj_msgSend(objj_msgSend(CPDictionary, "alloc"), "initWithObjectsAndKeys:", "TNNoAvatarValueTransformer", CPValueTransformerNameBindingOption);
...
{
    var bundle = objj_msgSend(CPBundle, "mainBundle");
    TNRosterDataViewContactImageNormalCartoucheColor = CPColorWithImages([["pills/pill-left.png", 6, 14, bundle], ["pills/pill-center.png", 1, 14, bundle], ["pills/pill-right.png", 6, 14, bundle]]);
    TNRosterDataViewContactImageSelectedCartoucheColor = CPColorWithImages([["pills/pill-highlighted-left.png", 6, 14, bundle], ["pills/pill-highlighted-center.png", 1, 14, bundle], ["pills/pill-highlighted-right.png", 6, 14, bundle]]);
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("name")]);objj_registerClassPair(the_class);
...
,["void","CPCoder"])]);
}p;27;Views/TNOutlineViewRoster.jt;10431;@STATIC;1.0;I;23;Foundation/Foundation.jI;22;AppKit/CPOutlineView.jI;18;AppKit/CPTabView.jI;20;AppKit/CPTextField.jI;36;StropheCappuccino/TNStropheContact.ji;29;../Model/TNDatasourceRoster.jt;10233;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPOutlineView.j", NO);objj_executeFile("AppKit/CPTabView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);objj_executeFile("StropheCappuccino/TNStropheContact.j", NO);objj_executeFile("../Model/TNDatasourceRoster.j", YES);TNArchipelRosterOutlineViewReload = "TNArchipelRosterOutlineViewReload";
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_searchField"), new objj_ivar("_tabViewModules")]);objj_registerClassPair(the_class);
...
,["void","CPScrollView"])]);
}p;20;Views/TNAvatarView.jt;1764;@STATIC;1.0;I;23;Foundation/Foundation.jI;20;AppKit/CPImageView.jI;15;AppKit/CPView.jt;1672;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("AppKit/CPView.j", NO);{var the_class = objj_allocateClassPair(CPView, "TNAvatarView"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_imageView"), new objj_ivar("_representedObject")]);objj_registerClassPair(the_class);
...
,["void","BOOL"])]);
}p;16;Views/TNSwitch.jt;4367;@STATIC;1.0;I;16;LPKit/LPSwitch.jt;4327;objj_executeFile("LPKit/LPSwitch.j", NO);{var the_class = objj_allocateClassPair(LPSwitch, "TNSwitch"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
class_addMethods(meta_class, [new objj_method(sel_getUid("themeAttributes"), function $TNSwitch__themeAttributes(self, _cmd)
{
    ...
    return objj_msgSend(objj_msgSend(CPDictionary, "alloc"), "initWithObjectsAndKeys:", offBackgroundImage, "off-background-color", onBackgroundImage, "on-background-color", knobBackgroundImage, "knob-background-color", CGSizeMake(30, 25), "knob-size", CGSizeMake(12, 6), "label-offset", objj_msgSend(CPFont, "boldSystemFontOfSize:", 11), "off-label-font", objj_msgSend(CPColor, "colorWithWhite:alpha:", 0, 0.7), "off-label-text-color", objj_msgSend(CPColor, "colorWithWhite:alpha:", 1, 0.8), "off-label-text-shadow-color", CGSizeMake(0, 1), "off-label-text-shadow-offset", objj_msgSend(CPFont, "boldSystemFontOfSize:", 11), "on-label-font", objj_msgSend(CPColor, "colorWithWhite:alpha:", 1, 1.0), "on-label-text-color", objj_msgSend(CPColor, "colorWithWhite:alpha:", 0.3, 0.8), "on-label-text-shadow-color", CGSizeMake(0, 1), "on-label-text-shadow-offset");
}
...
,["TNSwitch","CGRect"])]);
}p;23;Views/TNBasicDataView.jt;3405;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/CPView.jI;19;AppKit/CGGradient.jt;3314;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CGGradient.j", NO);{var the_class = objj_allocateClassPair(CPView, "TNBasicDataView"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_colorRegistry")]);objj_registerClassPair(the_class);
...
,["id","CPCoder"])]);
}p;21;Views/TNModalWindow.jt;1644;@STATIC;1.0;I;23;Foundation/Foundation.jI;16;AppKit/CPPanel.jt;1576;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPPanel.j", NO);{var the_class = objj_allocateClassPair(CPPanel, "TNModalWindow"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
,["id","CGRect","id"])]);
}p;16;Model/TNModule.jt;31441;@STATIC;1.0;I;23;Foundation/Foundation.jI;20;AppKit/CPButtonBar.jI;16;AppKit/CPImage.jI;20;AppKit/CPImageView.jI;15;AppKit/CPMenu.jI;19;AppKit/CPMenuItem.jI;18;AppKit/CPToolbar.jI;22;AppKit/CPToolbarItem.jI;15;AppKit/CPView.jI;25;AppKit/CPViewController.jI;39;StropheCappuccino/TNStropheConnection.jI;36;StropheCappuccino/TNStropheContact.jI;34;StropheCappuccino/TNStropheGroup.jI;37;StropheCappuccino/TNStropheIMClient.jI;35;StropheCappuccino/TNStropheStanza.ji;36;../Controllers/TNPermissionsCenter.ji;29;../Controllers/TNPushCenter.jt;30897;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButtonBar.j", NO);objj_executeFile("AppKit/CPImage.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("AppKit/CPMenu.j", NO);objj_executeFile("AppKit/CPMenuItem.j", NO);objj_executeFile("AppKit/CPToolbar.j", NO);objj_executeFile("AppKit/CPToolbarItem.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPViewController.j", NO);objj_executeFile("StropheCappuccino/TNStropheConnection.j", NO);objj_executeFile("StropheCappuccino/TNStropheContact.j", NO);objj_executeFile("StropheCappuccino/TNStropheGroup.j", NO);objj_executeFile("StropheCappuccino/TNStropheIMClient.j", NO);objj_executeFile("StropheCappuccino/TNStropheStanza.j", NO);objj_executeFile("../Controllers/TNPermissionsCenter.j", YES);objj_executeFile("../Controllers/TNPushCenter.j", YES);var TNArchipelErrorPermission = 0,
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("imageViewModuleReady"), new objj_ivar("viewPreferences"), new objj_ivar("viewMask"), new objj_ivar("_fullscreen"), new objj_ivar("_hasCIB"), new objj_ivar("_isActive"), new objj_ivar("_isCurrentSelectedIndex"), new objj_ivar("_isVisible"), new objj_ivar("_mandatoryPermissions"), new objj_ivar("_supportedEntityTypes"), new objj_ivar("_bundle"), new objj_ivar("_contextualMenu"), new objj_ivar("_rosterContactsMenu"), new objj_ivar("_rosterGroupsMenu"), new objj_ivar("_identifier"), new objj_ivar("_label"), new objj_ivar("_name"), new objj_ivar("_viewPermissionsDenied"), new objj_ivar("_entity"), new objj_ivar("_moduleType"), new objj_ivar("_UIObject"), new objj_ivar("_UIItem"), new objj_ivar("_animationDuration"), new objj_ivar("_index"), new objj_ivar("_moduleStatus"), new objj_ivar("_group"), new objj_ivar("_initialPermissionsReceived"), new objj_ivar("_registredSelectors"), new objj_ivar("_buttonsBarButtonsRegistry"), new objj_ivar("_contextualMenuItemRegistry")]);objj_registerClassPair(the_class);
...
,["void","CPBundle"]), new objj_method(sel_getUid("contextualMenu"), function $TNModule__contextualMenu(self, _cmd)
{
    return self._contextualMenu;
}
,["CPMenu"]), new objj_method(sel_getUid("setContextualMenu:"), function $TNModule__setContextualMenu_(self, _cmd, newValue)
{
...
,["void","CPMenu"]), new objj_method(sel_getUid("identifier"), function $TNModule__identifier(self, _cmd)
{
...
,["void","TNStropheGroup"]), new objj_method(sel_getUid("initializeModule"), function $TNModule__initializeModule(self, _cmd)
{
    ...
    self._buttonsBarButtonsRegistry = objj_msgSend(CPDictionary, "dictionary");
    self._contextualMenuItemRegistry = objj_msgSend(CPDictionary, "dictionary");
    self._contextualMenu = objj_msgSend(objj_msgSend(CPMenu, "alloc"), "init");
    objj_msgSend(objj_msgSend(self, "view"), "applyShadow");
    objj_msgSend(objj_msgSend(TNPermissionsCenter, "defaultCenter"), "addDelegate:", self);
}
,["BOOL"]), new objj_method(sel_getUid("addControlsWithIdentifier:title:target:action:image:"), function $TNModule__addControlsWithIdentifier_title_target_action_image_(self, _cmd, anIdentifier, aTitle, aTarget, aSelector, anImage)
{
    objj_msgSend(anImage, "setSize:", CPSizeMake(16.0, 16.0));
    var _button = objj_msgSend(CPButtonBar, "plusButton");
    objj_msgSend(_button, "setTarget:", aTarget);
    objj_msgSend(_button, "setAction:", aSelector);
    objj_msgSend(_button, "setToolTip:", aTitle);
    objj_msgSend(_button, "setImage:", anImage);
    objj_msgSend(self._buttonsBarButtonsRegistry, "setObject:forKey:", _button, anIdentifier);
    var _item = objj_msgSend(objj_msgSend(CPMenuItem, "alloc"), "initWithTitle:action:keyEquivalent:", "  " + aTitle, aSelector, nil);
    objj_msgSend(_item, "setImage:", anImage);
    objj_msgSend(_item, "setTarget:", aTarget);
    objj_msgSend(_item, "bind:toObject:withKeyPath:options:", "enabled", _button, "enabled", nil);
    objj_msgSend(self._contextualMenuItemRegistry, "setObject:forKey:", _item, anIdentifier);
}
,["void","CPString","CPString","id","SEL","CPImage"]), new objj_method(sel_getUid("buttonWithIdentifier:"), function $TNModule__buttonWithIdentifier_(self, _cmd, anIdentifier)
{
    return objj_msgSend(self._buttonsBarButtonsRegistry, "objectForKey:", anIdentifier);
}
,["CPButtonBar","CPString"]), new objj_method(sel_getUid("allButtonsBarButtons"), function $TNModule__allButtonsBarButtons(self, _cmd)
{
    return objj_msgSend(self._buttonsBarButtonsRegistry, "allValues");
}
,["CPArray"]), new objj_method(sel_getUid("menuItemWithIdentifier:"), function $TNModule__menuItemWithIdentifier_(self, _cmd, anIdentifier)
{
    return objj_msgSend(self._contextualMenuItemRegistry, "objectForKey:", anIdentifier);
}
,["CPMenuItem","CPString"]), new objj_method(sel_getUid("allMenuItems"), function $TNModule__allMenuItems(self, _cmd)
{
    return objj_msgSend(self._contextualMenuItemRegistry, "allValues");
}
,["CPArray"]), new objj_method(sel_getUid("setViewPermissionDenied:"), function $TNModule__setViewPermissionDenied_(self, _cmd, aView)
{
...
,["void"]), new objj_method(sel_getUid("isEntityGranted:"), function $TNModule__isEntityGranted_(self, _cmd, anEntity)
{
    ...
    if (!self._mandatoryPermissions || objj_msgSend(self._mandatoryPermissions, "count") == 0)
        return YES;
    if (!objj_msgSend(objj_msgSend(TNPermissionsCenter, "defaultCenter"), "hasPermission:forEntity:", "all", anEntity) && objj_msgSend(objj_msgSend(objj_msgSend(TNStropheIMClient, "defaultClient"), "JID"), "bare") != defaultAdminAccount)
    {
...
,["BOOL","anItem","id"]), new objj_method(sel_getUid("savePreferences"), function $TNModule__savePreferences(self, _cmd)
{
}
...
,["void"])]);
}p;17;Model/TNVersion.jt;5499;@STATIC;1.0;I;23;Foundation/Foundation.ji;31;../Resources/archipel-commit.jst;5416;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("../Resources/archipel-commit.js", YES);{var the_class = objj_allocateClassPair(CPObject, "TNVersion"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_codeName"), new objj_ivar("_commit"), new objj_ivar("_major"), new objj_ivar("_minor"), new objj_ivar("_revision")]);objj_registerClassPair(the_class);
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("initWithCoder:"), function $TNVersion__initWithCoder_(self, _cmd, aCoder)
{
...
,["void","CPCoder"])]);
}p;26;Model/TNDatasourceRoster.jt;14044;@STATIC;1.0;I;23;Foundation/Foundation.jI;22;AppKit/CPOutlineView.jI;22;AppKit/CPSearchField.jI;22;AppKit/CPTableColumn.jI;39;StropheCappuccino/PubSub/TNPubSubNode.jI;35;StropheCappuccino/TNStropheRoster.jI;29;StropheCappuccino/TNXMLNode.jt;13797;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPOutlineView.j", NO);objj_executeFile("AppKit/CPSearchField.j", NO);objj_executeFile("AppKit/CPTableColumn.j", NO);objj_executeFile("StropheCappuccino/PubSub/TNPubSubNode.j", NO);objj_executeFile("StropheCappuccino/TNStropheRoster.j", NO);objj_executeFile("StropheCappuccino/TNXMLNode.j", NO);TNDragTypeContact = "TNDragTypeContact";
{var the_class = objj_allocateClassPair(TNStropheRoster, "TNDatasourceRoster"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_hideOfflineContacts"), new objj_ivar("_filterField"), new objj_ivar("_filter"), new objj_ivar("_tagsRegistry"), new objj_ivar("_draggedItems"), new objj_ivar("_pubsubTagsNode"), new objj_ivar("_reloadGraceTimer")]);objj_registerClassPair(the_class);
...
,["void","CPSearchField"]), new objj_method(sel_getUid("_getEntriesMatching"), function $TNDatasourceRoster___getEntriesMatching(self, _cmd)
{
    ...
    for (var i = 0; i < objj_msgSend(theEntries, "count"); i++)
    {
        ...
        if (objj_msgSend(objj_msgSend(entry, "name"), "uppercaseString").indexOf(objj_msgSend(self._filter, "uppercaseString")) != -1 || objj_msgSend(objj_msgSend(objj_msgSend(entry, "JID"), "bare"), "uppercaseString").indexOf(objj_msgSend(self._filter, "uppercaseString")) != -1 || objj_msgSend(objj_msgSend(self._tagsRegistry, "objectForKey:", objj_msgSend(objj_msgSend(entry, "JID"), "bare")), "containsObject:", objj_msgSend(self._filter, "lowercaseString")))
        {
...
}p;33;Categories/CPObject+Duplication.jt;553;@STATIC;1.0;I;23;Foundation/Foundation.jt;507;objj_executeFile("Foundation/Foundation.j", NO);{
...
,["id"])]);
}p;36;Categories/CPString+FormatByteSize.jt;1307;@STATIC;1.0;I;21;Foundation/CPString.jt;1262;objj_executeFile("Foundation/CPString.j", NO);{
...
,["CPString","float"])]);
}p;33;Categories/CPOutlineView+Extend.jt;1995;@STATIC;1.0;I;23;Foundation/Foundation.jI;22;AppKit/CPOutlineView.jt;1921;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPOutlineView.j", NO);{
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("expandAll"), function $CPOutlineView__expandAll(self, _cmd)
{
...
,["void"]), new objj_method(sel_getUid("recoverExpandedWithBaseKey:itemKeyPath:"), function $CPOutlineView__recoverExpandedWithBaseKey_itemKeyPath_(self, _cmd, aBaseKey, aKeyPath)
{
    ...
    for (var count = 0; objj_msgSend(self, "itemAtRow:", count); count++)
    {
        ...
        if (objj_msgSend(self, "isExpandable:", item))
        {
            ...
            if (objj_msgSend(objj_msgSend(defaults, "objectForKey:", "TNOutlineViewsExpandedGroups"), "objectForKey:", key) == "expanded" || objj_msgSend(objj_msgSend(defaults, "objectForKey:", "TNOutlineViewsExpandedGroups"), "objectForKey:", key) == nil)
                objj_msgSend(self, "expandItem:", item);
        }
    }
}
,["void","CPString","CPString"])]);
}p;33;Categories/CPBundle+Localizable.jt;3551;@STATIC;1.0;I;23;Foundation/Foundation.jI;22;AppKit/CPApplication.jt;3477;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPApplication.j", NO);var StringTables;
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("bundleLocale"), function $CPBundle__bundleLocale(self, _cmd)
{
...
p;33;Categories/CPString+UUIDRFC4122.jt;585;@STATIC;1.0;I;21;Foundation/CPString.jt;541;objj_executeFile("Foundation/CPString.j", NO);{
var the_class = objj_getClass("CPString")
if(!the_class) throw new SyntaxError("*** Could not find definition for class \"CPString\"");
...
,["CPString"])]);
}p;45;Categories/CPTableView+removeUnfocusedStyle.jt;770;@STATIC;1.0;I;20;AppKit/CPTableView.jt;727;objj_executeFile("AppKit/CPTableView.j", NO);{
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("unfocusedSelectionGradientColors"), function $CPTableView__unfocusedSelectionGradientColors(self, _cmd)
{
...
,["void"])]);
}p;39;Categories/TNStropheGroup+Capitalized.jt;498;@STATIC;1.0;I;34;StropheCappuccino/TNStropheGroup.jt;441;objj_executeFile("StropheCappuccino/TNStropheGroup.j", NO);{
...
,["CPString"])]);
}p;29;Categories/CPTabView+Border.jt;473;@STATIC;1.0;I;18;AppKit/CPTabView.jt;432;objj_executeFile("AppKit/CPTabView.j", NO);{
...
,["void","CPColor"])]);
}p;42;Categories/CPPopover+TNAttachedWindowAPI.jt;878;@STATIC;1.0;I;18;AppKit/CPPopover.jt;837;objj_executeFile("AppKit/CPPopover.j", NO);{
var the_class = objj_getClass("CPPopover")
if(!the_class) throw new SyntaxError("*** Could not find definition for class \"CPPopover\"");
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("setDefaultButton:"), function $CPPopover__setDefaultButton_(self, _cmd, aButton)
{
...
,["void","id"])]);
}p;26;Categories/CPView+Border.jt;826;@STATIC;1.0;I;15;AppKit/CPView.jt;788;objj_executeFile("AppKit/CPView.j", NO);{
var the_class = objj_getClass("CPView")
if(!the_class) throw new SyntaxError("*** Could not find definition for class \"CPView\"");
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("setBordered"), function $CPView__setBordered(self, _cmd)
{
...
,["void","int"])]);
}p;25;Categories/TNCategories.jt;1122;@STATIC;1.0;i;15;CPDate+Format.ji;22;CPObject+Duplication.ji;22;CPOutlineView+Extend.ji;24;CPPlatformWindow+Title.ji;31;CPPopover+TNAttachedWindowAPI.ji;32;CPSegmentedControl+SegmentView.ji;25;CPString+FormatByteSize.ji;22;CPString+UUIDRFC4122.ji;34;CPTableView+removeUnfocusedStyle.ji;18;CPTabView+Border.ji;20;CPView+ApplyShadow.ji;15;CPView+Border.ji;27;TNStropheClient+Singleton.ji;28;TNStropheGroup+Capitalized.jt;699;objj_executeFile("CPDate+Format.j", YES);objj_executeFile("CPObject+Duplication.j", YES);objj_executeFile("CPOutlineView+Extend.j", YES);objj_executeFile("CPPlatformWindow+Title.j", YES);objj_executeFile("CPPopover+TNAttachedWindowAPI.j", YES);objj_executeFile("CPSegmentedControl+SegmentView.j", YES);objj_executeFile("CPString+FormatByteSize.j", YES);objj_executeFile("CPString+UUIDRFC4122.j", YES);objj_executeFile("CPTableView+removeUnfocusedStyle.j", YES);objj_executeFile("CPTabView+Border.j", YES);objj_executeFile("CPView+ApplyShadow.j", YES);objj_executeFile("CPView+Border.j", YES);objj_executeFile("TNStropheClient+Singleton.j", YES);objj_executeFile("TNStropheGroup+Capitalized.j", YES);p;35;Categories/CPPlatformWindow+Title.jt;448;@STATIC;1.0;I;25;AppKit/CPPlatformWindow.jt;400;objj_executeFile("AppKit/CPPlatformWindow.j", NO);{
...
,["id"])]);
}p;43;Categories/CPSegmentedControl+SegmentView.jt;486;@STATIC;1.0;I;27;AppKit/CPSegmentedControl.jt;436;objj_executeFile("AppKit/CPSegmentedControl.j", NO);{
...
,["id","CPString"])]);
}p;38;Categories/TNStropheClient+Singleton.jt;734;@STATIC;1.0;I;37;StropheCappuccino/TNStropheIMClient.jt;674;objj_executeFile("StropheCappuccino/TNStropheIMClient.j", NO);var DefaultTNStropheIMClient = nil;
{
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("setDefaultClient"), function $TNStropheIMClient__setDefaultClient(self, _cmd)
{
...
,["TNStropheIMClient"])]);
}p;26;Categories/CPDate+Format.jt;903;@STATIC;1.0;I;19;Foundation/CPDate.ji;26;../Resources/dateFormat.jst;830;objj_executeFile("Foundation/CPDate.j", NO);objj_executeFile("../Resources/dateFormat.js", YES);{
var the_class = objj_getClass("CPDate")
if(!the_class) throw new SyntaxError("*** Could not find definition for class \"CPDate\"");
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("format:"), function $CPDate__format_(self, _cmd, aFormat)
{
...
,["CPString","CPString"])]);
}p;31;Categories/CPView+ApplyShadow.jt;2217;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/CPView.jI;20;AppKit/CPTextField.jt;2125;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPTextField.j", NO);{
var the_class = objj_getClass("CPView")
if(!the_class) throw new SyntaxError("*** Could not find definition for class \"CPView\"");
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("applyShadow:offset:"), function $CPView__applyShadow_offset_(self, _cmd, aShadowColor, anOffset)
{
...
,["void","BOOL"])]);
}p;24;Utils/EKShakeAnimation.jt;2535;@STATIC;1.0;I;23;Foundation/Foundation.jI;24;AppKit/CPViewAnimation.jt;2459;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPViewAnimation.j", NO);{var the_class = objj_allocateClassPair(CPObject, "EKShakeAnimation"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("target"), new objj_ivar("currentStep"), new objj_ivar("delta"), new objj_ivar("targetFrame"), new objj_ivar("steps"), new objj_ivar("stepDuration"), new objj_ivar("timer")]);objj_registerClassPair(the_class);
...
,["id","id"]), new objj_method(sel_getUid("timerDidFire"), function $EKShakeAnimation__timerDidFire(self, _cmd)
{
    ...
    else
    {
        ...
        objj_msgSend(self, "animateToFrame:", CGRectMake(self.targetFrame.origin.x + self.delta * prefix, self.targetFrame.origin.y, self.targetFrame.size.width, self.targetFrame.size.height));
        self.currentStep++;
    }
}
,["void"]), new objj_method(sel_getUid("animateToFrame:"), function $EKShakeAnimation__animateToFrame_(self, _cmd, aFrame)
{
    var animation = objj_msgSend(objj_msgSend(CPViewAnimation, "alloc"), "initWithViewAnimations:", [objj_msgSend(CPDictionary, "dictionaryWithJSObject:", {CPViewAnimationTargetKey: self.target, CPViewAnimationStartFrameKey: self.targetFrame, CPViewAnimationEndFrameKey: aFrame})]);
