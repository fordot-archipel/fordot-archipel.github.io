@STATIC;1.0;p;15;TNMessageView.jt;25307;@STATIC;1.0;I;23;Foundation/Foundation.jI;16;AppKit/CPColor.jI;16;AppKit/CPImage.jI;20;AppKit/CPImageView.jI;15;AppKit/CPView.jI;20;AppKit/CPTextField.jt;25147;objj_executeFile("Foundation/Foundation.j", NO);
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_imageDefaultAvatar"), new objj_ivar("_imageViewAvatar"), new objj_ivar("_author"), new objj_ivar("_message"), new objj_ivar("_subject"), new objj_ivar("_timestamp"), new objj_ivar("_fieldAuthor"), new objj_ivar("_fieldTimestamp"), new objj_ivar("_viewContainer"), new objj_ivar("_bgColor"), new objj_ivar("_position"), new objj_ivar("_fieldMessage")]);//#pragma mark -
...
,["void","CPCoder"])]);
}p;12;TNFlipView.jt;16760;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/CPView.jt;16692;objj_executeFile("Foundation/Foundation.j", NO);
objj_executeFile("AppKit/CPView.j", NO);
var CSSProperties = {
        "webkit":
        {
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_flipped"), new objj_ivar("_backView"), new objj_ivar("_frontView"), new objj_ivar("_animationDuration"), new objj_ivar("_animationDirection"), new objj_ivar("_animationStyle"), new objj_ivar("_currentBackViewContent"), new objj_ivar("_currentFrontViewContent")]);//#pragma mark -
//#pragma mark Initialization
...
,["void","CPCoder"])]);
}p;11;TNTabView.jt;28799;@STATIC;1.0;I;23;Foundation/Foundation.jI;17;AppKit/CPButton.jI;18;AppKit/CPControl.jI;22;AppKit/CPTabViewItem.jI;16;AppKit/CPTheme.jI;15;AppKit/CPView.jI;21;AppKit/CPScrollView.ji;13;TNSwipeView.jt;28594;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPButton.j", NO);objj_executeFile("AppKit/CPControl.j", NO);objj_executeFile("AppKit/CPTabViewItem.j", NO);objj_executeFile("AppKit/CPTheme.j", NO);objj_executeFile("AppKit/CPView.j", NO);objj_executeFile("AppKit/CPScrollView.j", NO);objj_executeFile("TNSwipeView.j", YES);var TNTabViewTabMargin = 2.0,
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_label"), new objj_ivar("_index")]);objj_registerClassPair(the_class);
...
,["void","int"]), new objj_method(sel_getUid("initWithFrame:"), function $TNTabItemPrototype__initWithFrame_(self, _cmd, aFrame)
{
    if (self = objj_msgSendSuper({ receiver:self, super_class:objj_getClass("TNTabItemPrototype").super_class }, "initWithFrame:", aFrame))
    {
        ...
        objj_msgSend(self, "prepareTheme");
...
,["TNTabItemPrototype","CGRect"]), new objj_method(sel_getUid("prepareTheme"), function $TNTabItemPrototype__prepareTheme(self, _cmd)
{
...
,["void"]), new objj_method(sel_getUid("_didClick:"), function $TNTabItemPrototype___didClick_(self, _cmd, aSender)
{
...
{
    objj_msgSend(self._label, "unbind:", "title");
    objj_msgSend(self._label, "bind:toObject:withKeyPath:options:", "title", anItem, "label", nil);
}
...
{
    TNTabViewTabButtonColorNormal = objj_msgSend(CPColor, "colorWithPatternImage:", objj_msgSend(objj_msgSend(CPThreePartImage, "alloc"), "initWithImageSlices:isVertical:", [objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(objj_msgSend(CPBundle, "bundleForClass:", TNTabView), "pathForResource:", "TNTabView/tabitem-normal-left.png"), CGSizeMake(9, 22)), objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(objj_msgSend(CPBundle, "bundleForClass:", TNTabView), "pathForResource:", "TNTabView/tabitem-normal-center.png"), CGSizeMake(1, 22)), objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(objj_msgSend(CPBundle, "bundleForClass:", TNTabView), "pathForResource:", "TNTabView/tabitem-normal-right.png"), CGSizeMake(9, 22))], NO));
    TNTabViewTabButtonColorPressed = objj_msgSend(CPColor, "colorWithPatternImage:", objj_msgSend(objj_msgSend(CPThreePartImage, "alloc"), "initWithImageSlices:isVertical:", [objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(objj_msgSend(CPBundle, "bundleForClass:", TNTabView), "pathForResource:", "TNTabView/tabitem-pressed-left.png"), CGSizeMake(9, 22)), objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(objj_msgSend(CPBundle, "bundleForClass:", TNTabView), "pathForResource:", "TNTabView/tabitem-pressed-center.png"), CGSizeMake(1, 22)), objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(objj_msgSend(CPBundle, "bundleForClass:", TNTabView), "pathForResource:", "TNTabView/tabitem-pressed-right.png"), CGSizeMake(9, 22))], NO));
    TNTabViewTabButtonColorActive = objj_msgSend(CPColor, "colorWithPatternImage:", objj_msgSend(objj_msgSend(CPThreePartImage, "alloc"), "initWithImageSlices:isVertical:", [objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(objj_msgSend(CPBundle, "bundleForClass:", TNTabView), "pathForResource:", "TNTabView/tabitem-active-left.png"), CGSizeMake(9, 22)), objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(objj_msgSend(CPBundle, "bundleForClass:", TNTabView), "pathForResource:", "TNTabView/tabitem-active-center.png"), CGSizeMake(1, 22)), objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(objj_msgSend(CPBundle, "bundleForClass:", TNTabView), "pathForResource:", "TNTabView/tabitem-active-right.png"), CGSizeMake(9, 22))], NO));
}
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_delegate"), new objj_ivar("_enableManualScrolling"), new objj_ivar("_itemObjects"), new objj_ivar("_buttonScrollLeft"), new objj_ivar("_buttonScrollRight"), new objj_ivar("_currentSelectedItemView"), new objj_ivar("_viewTabsDocument"), new objj_ivar("_currentSelectedIndex"), new objj_ivar("_contentView"), new objj_ivar("_tabItemViewPrototype"), new objj_ivar("_scrollViewTabs"), new objj_ivar("_needsScroll")]);objj_registerClassPair(the_class);
...
,["void","id"]), new objj_method(sel_getUid("enableManualScrolling"), function $TNTabView__enableManualScrolling(self, _cmd)
{
    return self._enableManualScrolling;
}
,["BOOL"]), new objj_method(sel_getUid("setEnableManualScrolling:"), function $TNTabView__setEnableManualScrolling_(self, _cmd, newValue)
{
    self._enableManualScrolling = newValue;
}
,["void","BOOL"]), new objj_method(sel_getUid("initWithFrame:"), function $TNTabView__initWithFrame_(self, _cmd, aFrame)
{
    if (self = objj_msgSendSuper({ receiver:self, super_class:objj_getClass("TNTabView").super_class }, "initWithFrame:", aFrame))
    {
        ...
        self._enableManualScrolling = YES;
...
,["void","CPTabViewItem"]), new objj_method(sel_getUid("insertTabViewItem:atIndex:"), function $TNTabView__insertTabViewItem_atIndex_(self, _cmd, anItem, anIndex)
{
    ...
    var previousSelectedItem = objj_msgSend(self, "selectedTabViewItem"),
        itemView = objj_msgSend(self, "_newTabItemPrototype");
    ...
    if (previousSelectedItem)
        objj_msgSend(self, "selectTabViewItem:", previousSelectedItem);
...
,["CPArray"]), new objj_method(sel_getUid("layoutSubviews"), function $TNTabView__layoutSubviews(self, _cmd)
{
    ...
    if (objj_msgSend(objj_msgSend(self._scrollViewTabs, "horizontalScroller"), "isEnabled"))
    {
        ...
        if (self._enableManualScrolling)
        {
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("initWithCoder:"), function $TNTabView__initWithCoder_(self, _cmd, aCoder)
{
...
,["void","CPCoder"])]);
}p;21;TNRangeSelectorView.jt;19781;@STATIC;1.0;I;23;Foundation/Foundation.jI;20;AppKit/CPSplitView.jI;20;AppKit/CPTextField.jI;15;AppKit/CPView.jI;18;AppKit/CPControl.jt;19640;objj_executeFile("Foundation/Foundation.j", NO);
...
,["void","CPCoder"])]);
}p;16;TNMessageBoard.jt;5333;@STATIC;1.0;I;23;Foundation/Foundation.jI;22;AppKit/CPTableColumn.jI;20;AppKit/CPTableView.ji;15;TNMessageView.jt;5214;objj_executeFile("Foundation/Foundation.j", NO);
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_messages"), new objj_ivar("_dataView")]);//#pragma mark -
//#pragma mark Initialization
...
,["void","CPTableView","CPTableColumn","int"]), new objj_method(sel_getUid("tableView:viewForTableColumn:row:"), function $TNMessageBoard__tableView_viewForTableColumn_row_(self, _cmd, aTableView, aColumn, aRow)
{
...
}p;13;TNStackView.jt;5378;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/CPView.jt;5311;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPView.j", NO);{var the_class = objj_allocateClassPair(CPView, "TNStackView"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_dataSource"), new objj_ivar("_padding"), new objj_ivar("_reversed"), new objj_ivar("_stackedViews")]);objj_registerClassPair(the_class);
...
,["id","CGRect"]), new objj_method(sel_getUid("_init"), function $TNStackView___init(self, _cmd)
{
...
,["void"]), new objj_method(sel_getUid("_nextPosition"), function $TNStackView___nextPosition(self, _cmd)
{
...
,["id","id"]), new objj_method(sel_getUid("initWithCoder:"), function $TNStackView__initWithCoder_(self, _cmd, aCoder)
{
    self = objj_msgSendSuper({ receiver:self, super_class:objj_getClass("TNStackView").super_class }, "initWithCoder:", aCoder);
    if (self)
    {
        objj_msgSend(self, "_init");
    }
...
,["id","CPCoder"]), new objj_method(sel_getUid("encodeWithCoder:"), function $TNStackView__encodeWithCoder_(self, _cmd, aCoder)
{
    objj_msgSendSuper({ receiver:self, super_class:objj_getClass("TNStackView").super_class }, "encodeWithCoder:", aCoder);
}
,["void","CPCoder"])]);
}p;27;TNTableViewLazyDataSource.jt;9979;@STATIC;1.0;I;23;Foundation/Foundation.jI;22;AppKit/CPSearchField.jI;20;AppKit/CPTableView.jt;9880;objj_executeFile("Foundation/Foundation.j", NO);
objj_executeFile("AppKit/CPSearchField.j", NO);
objj_executeFile("AppKit/CPTableView.j", NO);
{var the_class = objj_allocateClassPair(CPObject, "TNTableViewLazyDataSource"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_currentlyLoading"), new objj_ivar("_content"), new objj_ivar("_searchableKeyPaths"), new objj_ivar("_table"), new objj_ivar("_delegate"), new objj_ivar("_lazyLoadingTrigger"), new objj_ivar("_totalCount"), new objj_ivar("_searchField"), new objj_ivar("_filter")]);//#pragma mark -
//#pragma mark Initialization
...
}p;25;TNOutlineViewDataSource.jt;6880;@STATIC;1.0;I;23;Foundation/Foundation.jt;6833;objj_executeFile("Foundation/Foundation.j", NO);
{var the_class = objj_allocateClassPair(CPObject, "TNOutlineViewDataSource"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("filterInstalled"), new objj_ivar("_contents"), new objj_ivar("_searchableKeyPaths"), new objj_ivar("_childCompKeyPath"), new objj_ivar("_parentKeyPath")]);//#pragma mark -
//#pragma mark Initialization
...
,["void","CGRect"])]);
}p;11;TNToolbar.jt;13255;@STATIC;1.0;I;23;Foundation/Foundation.jI;16;AppKit/CPImage.jI;20;AppKit/CPImageView.jI;18;AppKit/CPToolbar.jI;22;AppKit/CPToolbarItem.jI;15;AppKit/CPView.jt;13091;objj_executeFile("Foundation/Foundation.j", NO);objj_executeFile("AppKit/CPImage.j", NO);objj_executeFile("AppKit/CPImageView.j", NO);objj_executeFile("AppKit/CPToolbar.j", NO);objj_executeFile("AppKit/CPToolbarItem.j", NO);objj_executeFile("AppKit/CPView.j", NO);var TNToolbarSelectedBgImage,
    TNToolbarSelectedBgImageHUD;
{var the_class = objj_allocateClassPair(CPToolbar, "TNToolbar"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_customSubViews"), new objj_ivar("_selectedToolbarItem"), new objj_ivar("_iconSelected"), new objj_ivar("_sortedToolbarItems"), new objj_ivar("_toolbarItems"), new objj_ivar("_toolbarItemsOrder"), new objj_ivar("_imageViewSelection"), new objj_ivar("_isHUD")]);objj_registerClassPair(the_class);
...
{
    return objj_msgSend(self._toolbarItems, "objectForKey:", anIdentifier);
}
...
class_addMethods(meta_class, [new objj_method(sel_getUid("initialize"), function $TNToolbar__initialize(self, _cmd)
{
    ...
    TNToolbarSelectedBgImage = objj_msgSend(objj_msgSend(CPThreePartImage, "alloc"), "initWithImageSlices:isVertical:", [objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "TNToolbar/toolbar-item-selected-left.png"), CGSizeMake(3.0, 60.0)), objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "TNToolbar/toolbar-item-selected-center.png"), CGSizeMake(1.0, 60.0)), objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "TNToolbar/toolbar-item-selected-right.png"), CGSizeMake(3.0, 60.0))], NO);
    TNToolbarSelectedBgImageHUD = objj_msgSend(objj_msgSend(CPThreePartImage, "alloc"), "initWithImageSlices:isVertical:", [objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "TNToolbar/toolbar-hud-item-selected-left.png"), CGSizeMake(1.0, 60.0)), objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "TNToolbar/toolbar-hud-item-selected-center.png"), CGSizeMake(1.0, 60.0)), objj_msgSend(objj_msgSend(CPImage, "alloc"), "initWithContentsOfFile:size:", objj_msgSend(bundle, "pathForResource:", "TNToolbar/toolbar-hud-item-selected-right.png"), CGSizeMake(1.0, 60.0))], NO);
}
,["void"])]);
}p;20;TNTextFieldStepper.jt;5220;@STATIC;1.0;I;23;Foundation/Foundation.jI;20;AppKit/CPTextField.jI;18;AppKit/CPStepper.jt;5125;objj_executeFile("Foundation/Foundation.j", NO);
objj_executeFile("AppKit/CPTextField.j", NO);
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_textField"), new objj_ivar("_stepper")]);//#pragma mark -
//#pragma mark Initialization
...
,["void","float"])]);
}p;23;TNTableViewDataSource.jt;15275;@STATIC;1.0;I;23;Foundation/Foundation.jI;22;AppKit/CPSearchField.jI;20;AppKit/CPTableView.jt;15175;objj_executeFile("Foundation/Foundation.j", NO);
objj_executeFile("AppKit/CPSearchField.j", NO);
objj_executeFile("AppKit/CPTableView.j", NO);
{var the_class = objj_allocateClassPair(CPObject, "TNTableViewDataSource"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_content"), new objj_ivar("_searchableKeyPaths"), new objj_ivar("_table"), new objj_ivar("_displayFilter"), new objj_ivar("_delegate"), new objj_ivar("_filteredContent"), new objj_ivar("_searchField"), new objj_ivar("_filter"), new objj_ivar("_needsFilter")]);//#pragma mark -
//#pragma mark Initialization
...
}p;13;TNSwipeView.jt;18773;@STATIC;1.0;I;23;Foundation/Foundation.jI;18;AppKit/CPControl.jI;15;AppKit/CPView.jt;18682;objj_executeFile("Foundation/Foundation.j", NO);
objj_executeFile("AppKit/CPControl.j", NO);
objj_executeFile("AppKit/CPView.j", NO);
var CSSProperties = {
        "webkit" : {
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_views"), new objj_ivar("_translationFunction"), new objj_ivar("_animationDuration"), new objj_ivar("_minimalRatio"), new objj_ivar("_isAnimating"), new objj_ivar("_generalInitialTrackingPoint"), new objj_ivar("_initialTrackingPoint"), new objj_ivar("_mainView"), new objj_ivar("_validateFunction"), new objj_ivar("_animationGuardTimer"), new objj_ivar("_currentViewIndex")]);//#pragma mark -
//#pragma mark Initialization
...
,["void","CPCoder"])]);
}p;9;TNAlert.jt;5548;@STATIC;1.0;I;23;Foundation/Foundation.jI;16;AppKit/CPAlert.jt;5480;objj_executeFile("Foundation/Foundation.j", NO);
objj_executeFile("AppKit/CPAlert.j", NO);
{var the_class = objj_allocateClassPair(CPAlert, "TNAlert"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_actions"), new objj_ivar("_helpTarget"), new objj_ivar("_target"), new objj_ivar("_userInfo"), new objj_ivar("_helpAction")]);//#pragma mark -
//#pragma mark Initialization
...
objj_executeFile("TNWorker.j", YES);e;