@STATIC;1.0;p;15;VNCCappuccino.jt;128;@STATIC;1.0;i;11;TNVNCView.ji;13;TNSpiceView.jt;77;objj_executeFile("TNVNCView.j", YES);
objj_executeFile("TNSpiceView.j", YES);p;20;TNRemoteScreenView.jt;10511;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/CPView.jt;10443;objj_executeFile("Foundation/Foundation.j", NO);
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_encrypted"), new objj_ivar("_autoResizeViewPort"), new objj_ivar("_isFullScreen"), new objj_ivar("_host"), new objj_ivar("_password"), new objj_ivar("_port"), new objj_ivar("_state"), new objj_ivar("_oldState"), new objj_ivar("_delegate"), new objj_ivar("_focusContainer"), new objj_ivar("_isFocused"), new objj_ivar("_displayID"), new objj_ivar("_zoom"), new objj_ivar("_screenContainer")]);//#pragma mark -
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_trueColor"), new objj_ivar("_message"), new objj_ivar("_oldState"), new objj_ivar("_checkRate"), new objj_ivar("_frameBufferRequestRate"), new objj_ivar("_display"), new objj_ivar("_DOMClipboard"), new objj_ivar("_RFB")]);//#pragma mark -
//#pragma mark Initialization
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_spice"), new objj_ivar("_currentDisplaySize"), new objj_ivar("_remoteURL")]);//#pragma mark -
//#pragma mark Initialization
